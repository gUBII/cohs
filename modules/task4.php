<?php
    ...
    $timenow=time();
    if(isset($namex)){
        $sql = "update tasks set cdate='$timenow',activity='3' where id = $itemid";
        $conn->query($sql);
        ...
        VALUES ('".$_COOKIE["userid"]."','0','0','TASK','0','$sysdate','$ip','1','$employeename placed his task to <b>ONHOLD</b> list at $sysdate2','$itemid','".$_COOKIE["userid"]."')";
