...
echo"<div class='row'>
    <div class='col-8 col-md-5' style='padding-bottom:10px'>
        ...
        <h1 class='mb-0 pb-0 display-4' id='title'>Complaints Reporting</h1>
    ...
    <div class='col-4 col-md-7 d-flex align-items-start justify-content-end'>
        <a href='index.php?url=complaint-reports.php'>
...
// if($_GET["cm"]==1){
    ...
    echo"<form id='form' method='post' name='incidentform' class='wizard-big' action='report_processor.php' target='dataprocessor' enctype='multipart/form-data'>
        <input type='hidden' name='url' value='complaints.php'><input type='hidden' name='id' value='5204'>
    
        <fieldset>
            <div class='row' style='padding:20px'>
                <div class='col-lg-4'>
                    <div class='form-group' style='margin-bottom:25px'>
                        <label>Complaint Status *</label><select class='form-control m-b required' name='complainttype' required>
                ...
                <div class='col-6 col-lg-4'>
                    <div class='form-group' style='margin-bottom:25px'><label>Assesment Date *</label><input name='date1' type='date' value='$current_date' class='form-control required'></div>
                </div>
                <div class='col-6 col-lg-4'>
                    <div class='form-group' style='margin-bottom:25px'><label>Expected Resolved Date</label><input name='date2' type='date' value='$current_date' class='form-control'></div>
                </div>
                <div class='col-lg-4'>
                    <div class='form-group' style='margin-bottom:25px'>
                ...
                <div class='col-lg-4'>";
                    echo"<div class='form-group' style='margin-bottom:25px'><label>Complaints Manager *</label><select class='form-control m-b required' name='employeeid' required>
                ...
                <div class='col-lg-12'>
                    <div class='form-group' style='margin-bottom:25px'><label>Complain Detail Note *</label>
