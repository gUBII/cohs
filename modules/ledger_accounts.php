<?php
    $sheba="accounts_ledger";
    $cid=3;
    $title="Add New Accounts Ledger";
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Accounts Ledger</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' onmouseover=\"shiftdataV2('ledger_accounts_process.php?cid=$cid&sheba=$sheba&ctitle=$title', 'offcanvasRight')\">
                ...
                <div class='d-inline-block'>
                    ...
                    <div class='dropdown-as-select d-inline-block datatable-length' data-datatable='#datatableStripe'>
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='SortForm'>
                            ...
                            <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=10000000; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">All Data</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=5; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">5 Items</a>
                                <a class='dropdown-item active' href='#' onmouseover=\"document.SortForm.sortvalue.value=10; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">10 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=25; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">25 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=50; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">50 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=100; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">100 Items</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class='data-table-rows slim' id='sample'>
        <body onload=\"shiftdataV2('ledger_accounts_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">
        <div class='data-table-responsive-wrapper'>
            <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                <tr>";
                    ...
                    echo"<th onclick='sortTable(1)'>Group <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    echo"<th onclick='sortTable(2)'>Name <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    echo"<th onclick='sortTable(3)'>Opening Balance <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    // echo"<th onclick='sortTable(4)'>Balance Type <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    // echo"<th onclick='sortTable(5)'>Balance Date <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    echo"<th onclick='sortTable(6)'>Debit <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    echo"<th onclick='sortTable(7)'>Credit <i data-acorn-icon='sort' style='height:12px'></i></th>";
                    echo"<th >Action</th>";
                echo"</tr>
