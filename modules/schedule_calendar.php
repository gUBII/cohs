    ...
    if(isset($_COOKIE["userid"])){
        ...
        <body>
            ...
            <div class='sidebar' id='sidebar' style='background-color:#111111;z-index:9999'>
                <header><h2 id='form-title'>New Appointment</h2><button class='close-btn' id='close-sidebar'>&times;</button></header>
                <form id='add-event-form'>
                    ...
                    echo"<fieldset><div class='row'>
                        <div class='col-lg-12' style='margin-bottom:25px'><div class='form-group'>
                            <label>Task Title*</label><input type='text' class=form-control id='event-title' placeholder='Task Title' name='title' value='' required>
                        </div></div>
                        <div class='col-lg-12' style='margin-bottom:25px'><div class='form-group'>
                            <label>Task Detail*</label><textarea id='event-detail' name='detail' class='form-control'></textarea>
                        </div></div>
                        <div class='col-lg-6' style='margin-bottom:25px'><div class='form-group'>
                            <label>Start Date & Time *</label><input type='datetime-local' id='event-start' class='form-control' name='start' value='' placeholder='Start Date & Time' required>
                        </div></div>
                        <div class='col-lg-6' style='margin-bottom:25px'><div class='form-group'>
                            <label>Start Date & Time *</label><input type='datetime-local' id='event-end' class='form-control' name='end' value='' placeholder='End Date & Time' required>
                        </div></div>
                        <div class='col-lg-12' style='margin-bottom:25px'><div class='form-group'>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    addEventForm.addEventListener('submit', async function (e) {
                        ...
                        try {
                            ...
                            alert('Failed to New Appointment.');
                        }
                    });
