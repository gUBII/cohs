<?php
    $sheba="uerp_user";
    $cid=9;
    $title="Add New Emoloyee";
    $utype="EMPLOYEE";
    
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            
            <h1 class='mb-0 pb-0 display-4' id='title'>Appointed Support Workers</h1>
                ...
                <div class='d-inline-block'>
                    ...
                    <table><tr><td nowrap>
                        ...
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='ViewModeForm'>
                            ...
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='LIST'; document.ViewModeForm.submit()\" onmouseup=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype&lim=1', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='list'></i></a>
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='CARD'; document.ViewModeForm.submit()\" onmouseup=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype&lim=1', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='grid-3'></i></a>                        
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('chart_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'chartmodeX'); shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype&lim=1', 'datatableX')\">
