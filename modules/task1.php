<?php
    ...
    if(isset($namex)){
        $sql = "update tasks set cdate='0',pdate='0',activity='0' where id = $itemid";
        $conn->query($sql);
        ...
        VALUES ('".$_COOKIE["userid"]."','0','0','TASK','0','$sysdate','$ip','1','$employeename placed his task back to <b>TO-DO/WAITING</b> list at $sysdate2','$itemid','".$_COOKIE["userid"]."')";
