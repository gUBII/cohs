<?php
    ...
    $tcount=0;
    $c1 = "SELECT * FROM tasks where activity='2' order by activity asc";
    $d1 = $conn->query($c1);
    if ($d1->num_rows > 0) { while($cs1 = $d1->fetch_assoc()) {
        $stime=time();
        $ddx=date("d-m-y",$cs1["cdate"]);
        $etime = strtotime("+10 days", $cs1["cdate"]);
        if($etime<=$stime){
            // $tcount=($tcount+1);
            $sql="update tasks set activity='10' where id='".$cs1["id"]."'";
    ...
    if($mtype!="ADMIN"){
        ...
        $sqlIncomplete = "SELECT * FROM tasks where employeeid='$userid' and activity='0' ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncomplete);
        $incomleteItems = mysqli_fetch_all($result,MYSQLI_ASSOC);
                        
        $sqlProcessing = "SELECT * FROM tasks where employeeid='$userid' and activity='1' ORDER BY id desc";
        $processingResult = mysqli_query($conn, $sqlProcessing);
        $processingItems = mysqli_fetch_all($processingResult, MYSQLI_ASSOC);
                        
        $sqlCompleted = "SELECT * FROM tasks where employeeid='$userid' and activity='2' ORDER BY id desc";
        $completeResult = mysqli_query($conn, $sqlCompleted);
        $completeItems = mysqli_fetch_all($completeResult, MYSQLI_ASSOC);
        
        $sqlOnhost = "SELECT * FROM tasks where employeeid='$userid' and activity='3' ORDER BY id desc";
        $onholdResult = mysqli_query($conn, $sqlOnhost);
        $onholdItems = mysqli_fetch_all($onholdResult, MYSQLI_ASSOC);
        
    }else{
        $sqlIncomplete = "SELECT * FROM tasks where activity='0' ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncomplete);
        $incomleteItems = mysqli_fetch_all($result,MYSQLI_ASSOC);
                        
        $sqlProcessing = "SELECT * FROM tasks where activity='1' ORDER BY id desc";
        $processingResult = mysqli_query($conn, $sqlProcessing);
        $processingItems = mysqli_fetch_all($processingResult, MYSQLI_ASSOC);
                        
        $sqlCompleted = "SELECT * FROM tasks where activity='2' ORDER BY id desc";
        $completeResult = mysqli_query($conn, $sqlCompleted);
        $completeItems = mysqli_fetch_all($completeResult, MYSQLI_ASSOC);
        
        $sqlOnhost = "SELECT * FROM tasks where activity='3' ORDER BY id desc";
        $onholdResult = mysqli_query($conn, $sqlOnhost);
        $onholdItems = mysqli_fetch_all($onholdResult, MYSQLI_ASSOC);
    }
    ...
    echo"<div class='scroll-section' id='wrapper'>
        <div class='wrapper wrapper-content  animated fadeInTop' style='width:100%;'>
            <div class='row' id='sortable-view'>
                ...
                <div class='col-md-3' id='droppable1'><br><h4>Pending</h4>";
                                        ...
                                        <td>
                                            <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                ...
                                                <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                    <a id='notifyButtonBottomLeft' href='../task2.php?itemid=".$item['id']."' target='dataprocessor' class='dropdown-item' >Processing</a>    
                                                    <a id='notifyButtonBottomLeft' href='../task3.php?itemid=".$item['id']."' target='dataprocessor' class='dropdown-item' >Completed</a>
                                                    <a id='notifyButtonBottomLeft' href='../task4.php?itemid=".$item['id']."' target='dataprocessor' class='dropdown-item' >Onhold</a>";
                                                    if($mtype=="ADMIN") echo"<hr><a href='deletetask.php?delid=".$item['id']."&tbl=tasks&redirect=todo-list' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                echo"</div>
                                            </div>
                                        </td>
                                    </tr></table>
                                    ...
                                    <div class='collapse' id='task-".$item['id']."'>
                                        <div class='card card-body no-shadow border mt-3' style='padding:2px'>                                            
                                            <table style='width:100%;padding:2px'>
                                                ...
                                                <tr><td><b>Task Date</b></td><td>:</td><td>$taskdate</td></tr>
                                                <tr><td><b>Project/Lead</b></td><td>:</td><td>$projectname</td></tr>
                                                <tr><td><b>Assigned For</b></td><td>:</td><td>$clientname</td></tr>
                                                <tr><td><b>Assigned To</b></td><td>:</td><td>$employeename</td></tr>
                                                <tr><td><b>Task Detail</b></td><td>:</td><td></td></tr>
                                                <tr><td colspan=3>".$item['detail']."Attachments: ";
                                                    $t=0;
                ...
                <div class='col-lg-3' id='droppable2'><br><h4>Processing</h4>";
                                    ...
                                    <table><tr>
                                        ...
                                        <td>
                                            <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                <button class='btn btn-icon btn-icon-only btn-outline-secondary btn-sm dropdown' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'><i data-acorn-icon='more-vertical'></i></button>
                                                <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                    <a id='notifyButtonBottomLeft' href='../task1.php?itemid=".$pitem['id']."' target='dataprocessor' class='dropdown-item' >Pending</a>    
                                                    <a id='notifyButtonBottomLeft' href='../task3.php?itemid=".$pitem['id']."' target='dataprocessor' class='dropdown-item' >Completed</a>
                                                    <a id='notifyButtonBottomLeft' href='../task4.php?itemid=".$pitem['id']."' target='dataprocessor' class='dropdown-item' >Onhold</a>";
                                                    if($mtype=="ADMIN") echo"<hr><a href='deletetask.php?delid=".$pitem['id']."&tbl=tasks&redirect=todo-list' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                echo"</div>
                                            </div>
                                        </td>
                                    </tr></table>
                                    ...
                                    <div class='collapse' id='task-".$pitem['id']."'>
                                        <div class='card card-body no-shadow border mt-3' style='padding:2px'>                                            
                                            <table style='width:100%;padding:2px'>
                                                ...
                                                <tr><td><b>Assigned To</b></td><td>:</td><td>$employeename</td></tr>
                                                <tr><td><b>Task Detail</b></td><td>:</td><td></td></tr>
                                                <tr><td colspan=3>".$pitem['detail']."Attachments: ";
                                                    $t=0;
                ...
                <div class='col-lg-3' id='droppable3'><br><h4>Completed</h4>";
                                    ...
                                    <table><tr>
                                        ...
                                        <td>
                                            <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                <button class='btn btn-icon btn-icon-only btn-outline-secondary btn-sm dropdown' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'><i data-acorn-icon='more-vertical'></i></button>
                                                <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                    <a id='notifyButtonBottomLeft' href='../task1.php?itemid=".$citem['id']."' target='dataprocessor' class='dropdown-item' >Pending</a>    
                                                    <a id='notifyButtonBottomLeft' href='../task2.php?itemid=".$citem['id']."' target='dataprocessor' class='dropdown-item' >Processing</a>
                                                    <a id='notifyButtonBottomLeft' href='../task4.php?itemid=".$citem['id']."' target='dataprocessor' class='dropdown-item' >Onhold</a>";
                                                    if($mtype=="ADMIN") echo"<hr><a href='deletetask.php?delid=".$citem['id']."&tbl=tasks&redirect=todo-list' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                echo"</div>
                                            </div>
                                        </td>
                                    </tr></table>
                                    ...
                                    <div class='collapse' id='task-".$citem['id']."'>
                                        <div class='card card-body no-shadow border mt-3' style='padding:2px'>                                            
                                            <table style='width:100%;padding:2px'>
                                                ...
                                                <tr><td><b>Assigned To</b></td><td>:</td><td>$employeename</td></tr>
                                                <tr><td><b>Task Detail</b></td><td>:</td><td></td></tr>
                                                <tr><td colspan=3>".$citem['detail']."Attachments: ";
                                                    $t=0;
                ...
                <div class='col-lg-3' id='droppable4'><br><h4>Onhold</h4>";
                                    ...
                                    <table><tr>
                                        ...
                                        <td>
                                            <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                <button class='btn btn-icon btn-icon-only btn-outline-secondary btn-sm dropdown' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'><i data-acorn-icon='more-vertical'></i></button>
                                                <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                    <a id='notifyButtonBottomLeft' href='../task1.php?itemid=".$oitem['id']."' target='dataprocessor' class='dropdown-item' >Pending</a>    
                                                    <a id='notifyButtonBottomLeft' href='../task2.php?itemid=".$oitem['id']."' target='dataprocessor' class='dropdown-item' >Processing</a>
                                                    <a id='notifyButtonBottomLeft' href='../task3.php?itemid=".$oitem['id']."' target='dataprocessor' class='dropdown-item' >Completed</a>";
                                                    if($mtype=="ADMIN") echo"<hr><a href='deletetask.php?delid=".$oitem['id']."&tbl=tasks&redirect=todo-list' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                echo"</div>
                                            </div>
                                        </td>
                                    </tr></table>
                                    ...
                                    <div class='collapse' id='task-".$oitem['id']."'>
                                        <div class='card card-body no-shadow border mt-3' style='padding:2px'>                                            
                                            <table style='width:100%;padding:2px'>
                                                ...
                                                <tr><td><b>Assigned To</b></td><td>:</td><td>$employeename</td></tr>
                                                <tr><td><b>Task Detail</b></td><td>:</td><td></td></tr>
                                                <tr><td colspan=3>".$oitem['detail']."Attachments: ";
                                                    $t=0;
