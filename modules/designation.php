<?php
    ...
    $utype="DESIGNATION";
        ...
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            ...
            <h1 class='mb-0 pb-0 display-4' id='title'>Designation Manager</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('designation_process.php?cid=$cid&sheba=$sheba&ctitle=$title&utype=$utype', 'offcanvasTop2')\">
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('chart_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'chartmodeX'); shiftdataV2('designation_data.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">";
