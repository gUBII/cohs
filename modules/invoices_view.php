                        ...
                        <tr><td colspan=10>
                            <table class='table stripe table-hover' style='width:100%;padding:10px;background-color:white'>
                                <thead><tr style='background-color:#cccccc;color:black'>
                                    ...
                                    <th nowrap style='text-align:right;color:black'>Amount ".$rs["id"]." ".$rs["received_from"]." ".$rs["invoice_no2"]." ".$rs["ledger_id"]."</th>
                                </tr></thead>
                                <tbody>";
                                    $ttx1=0;
                                    ...
                                    if ($r1x->num_rows > 0) { while($r1y = $r1x -> fetch_assoc()) {
                                        echo"<tr class='gradeX'>";
                                            ...
                                            echo"<td nowrap align=left style='font-size:10pt;color:black'>$rdate</td>
                    ...
                    <center><table>
                        ...
                        <tr>
                            <td align=center style='width:33%'>
                                ...
                                <button type='button' class='btn btn-outline-primary' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('invoice_table.php?cid=1001&sheba=ndis_invoices&utype=CREATE INVOICE&&ctitle=$title&utype=$utype&invdate1=".$_GET["invdate1"]."&invdate2=".$_GET["invdate2"]."&clientid=".$_GET["clientid"]."', 'datatableX')\">Close</button></center>
                            </td>";
                            /*
                            <td align=center style='width:33%'>
