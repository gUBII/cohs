<?php
    ...
    if(isset($_COOKIE["userid"])){
        echo"<table class='table table-striped table-bordered table-hover dataTables-example1' >
            ...
            <tbody>";
                $ra1 = "select * from project_sc_forms where projectid='".$_COOKIE["projectidsc"]."' and categoryid='".$_GET["cid"]."' and status='1' order by id desc";
                $rb1 = $conn->query($ra1);
                if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                    ...
                    echo"<tr class='gradeX'>
                        ...
                        <td style='width:20px'><div class='btn-group' onmouseout=\"shiftdataV2('project-sc-category-list.php?cid=".$cat3["id"]."', '$datatargetY')\">
                            <a href='deleterecords.php?delid=".$rab1["id"]."&tbl=project_sc_forms&sourceid=id' target='dataprocessor' style='margin-top:0px;color:$topbar_color' onblur=\"shiftdataV2('project-sc-category-list.php?cid=".$cat3["id"]."', '$datatargetY')\">
