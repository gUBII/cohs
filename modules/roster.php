<?php    
    ...
    if(isset($_COOKIE["projectid"])){
        ...
        if($_COOKIE["projectid"]=="0"){
                ...
                <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
                    ...
                    <div class='btn-group ms-1 check-all-container'>
                        <div class='d-inline-block'>
                            <table><tr><td nowrap></td><td nowrap></td><td nowrap></td></tr></table>
                        </div>
                    </div>
                </div>                  
            </div>";
                ...
                <div class='data-table-rows slim' id='sample'>
                            ...
                            <td align=left width='50' nowrap>";
                                ...
                                echo"<table><tr>
                                    <td style='align:right;width:30px'><form method='post' name='shift_today' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                                        <input type='hidden' name='shiftingidtoday1' value='$prevweek'><input type='hidden' name='src_employeeid' value='$src_employeeid'>
                                    ...
                                    <td style='align:left;width:30px'><form method='post' name='shift_today' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                                        <input type='hidden' name='shiftingidtoday1' value='$weekcopy'><input type='hidden' name='src_employeeid' value='$src_employeeid'>
                                    ...
                                    <td valign=top style='width:150px'><form method='GET' name='shift_date' action='index.php' target='_self' enctype='multipart/form-data'>
                                        ...
                                        <select class='form-control form-control-sm' name='src_employeeid' onchange='this.form.submit()' style='width:150px'>
                                            <option value=''>Select User</option><option value='ALL'><strong>Show All User</strong></option>";
                                ...
                                <table ><tr>
                                    ...
                                    <td align=left width=50 nowrap style='padding-right:10px'>
                                        <div class='d-inline-block datatable-export' data-datatable='#datatableStripe' style='margin-right:5px'>
                                            ...
                                            <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                <a href='#' class='dropdown-item' data-toggle='modal' data-target='#schedulecopyday'>Copy Day</a>
                                                <a href='#' class='dropdown-item' data-toggle='modal' data-target='#schedulecopyweek'>Copy Week</a>
                                                <a href='#' class='dropdown-item' data-toggle='modal' data-target='#scheduledeleteweek'>Wipe A Week</a>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    echo"<div class='tab-content'>
                        <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                            <tr>
                                <th class='text-primary text-large text-uppercase'>Users View</th>";
                                ...
                                if($tdate=="$d11") $bgcolor1="#333333"; else $bgcolor1="";
                                if($tdate=="$d22") $bgcolor2="#333333"; else $bgcolor2="";
                                if($tdate=="$d33") $bgcolor3="#333333"; else $bgcolor3="";
                                if($tdate=="$d44") $bgcolor4="#333333"; else $bgcolor4="";
                                if($tdate=="$d55") $bgcolor5="#333333"; else $bgcolor5="";
                                if($tdate=="$d66") $bgcolor6="#333333"; else $bgcolor6="";
                                if($tdate=="$d77") $bgcolor7="#333333"; else $bgcolor7="";
                                
                                if($d1<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d11 $d1<br>$m1, $y</th>";
                                if($d2<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d22 $d222<br>$m2, $y</th>";
                                if($d3<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d33 $d333<br>$m3, $y</th>";
                                if($d4<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d44 $d444<br>$m4, $y</th>";
                                if($d5<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d55 $d555<br>$m5, $y</th>";
                                if($d6<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d66 $d666<br>$m6, $y</th>";
                                if($d7<=$lastdate) echo"<th class='text-muted text-small text-uppercase' style='background-color:'>$d77 $d777<br>$m7, $y</th>";
                                
                            echo"</tr>
                            <tbody id='datatableX'>";
                                
                                if($src_employeeid=="ALL") $ra7 = "select * from uerp_user where status='1' and mtype='USER' or status='1' and mtype='ADMIN' or status='1' and mtype='EMPLOYEE' order by username asc";
                                else if($src_employeeid=="") $ra7 = "select * from uerp_user where status='1' and mtype='USER' or status='1' and mtype='ADMIN' or status='1' and mtype='EMPLOYEE' order by username asc";
                                else $ra7 = "select * from uerp_user where id='$src_employeeid' and status='1' and mtype='USER' or id='$src_employeeid' and status='1' and mtype='ADMIN' or id='$src_employeeid' and status='1' and mtype='EMPLOYEE' order by username asc";
                                $rb7 = $conn->query($ra7);
                                if ($rb7->num_rows > 0) { while($rab7 = $rb7->fetch_assoc()) {
                                    echo"<tr>
                                        <td nowrap><center>
                                            <img src='".$rab7["images"]."' style='border:1px solid #ccc;border-radius:5px;width:50px;' title='".$rab7["username"]."'><br>
                                            ".$rab7["username"]." ".$rab7["username2"]."<br><a href='tel:".$rab7["phone"]."'>".$rab7["phone"]."</a>
                                        </td>";
                                        ...
                                        if($d1<=$lastdate){
                                            ...
                                            if($lts==1){
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:#F7C6C5;font-size:7pt'><br>Not Available
                                                    <hr><a href='scheduling-set.php?dd=$d1&mm=$mm1&yy=$y&empid3=".$rab7["id"]."' class='btn-active btn btn-xs'>Set Available</a>
                                                </td>";
                                            }else{
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor1;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d1&months=$mm1&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d1&months=$mm1&rdt=$datatarget&years=$y&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                    ...
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        ...
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            ...
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d1&months=$mm1&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                        } }
                                                    echo"</div>
                                                ...
                                                <script type="text/javascript">
                                                    function <?php echo"$getData"; ?>(employeeid1,<?php echo"$datatarget11"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d1&months=$mm1&years=$y&" ?>empid='+employeeid1, 
                                        ...
                                        if($d2<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor2;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d222' and months='$mm2' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid2,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d222&months=$mm2&years=$y&" ?>empid='+employeeid2, 
                                                            success: function(html) {
                                        ...
                                        if($d3<=$lastdate){
                                            ...
                                            if ($lt2->num_rows > 0) { while($lt12 = $lt2 -> fetch_assoc()) { $lts=1; } }
                                            if($lts==1){
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:#F7C6C5;font-size:7pt'><br>Not Available 1
                                                    <hr><a href='scheduling-set.php?dd=$d333&mm=$mm3&yy=$y&empid3=".$rab7["id"]."' class='btn-active btn btn-xs'>Set Available</a>
                                                </td>";
                                            }else{
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor3;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d333' and months='$mm3' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid3,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d333&months=$mm3&years=$y&" ?>empid='+employeeid3, 
                                                            success: function(html) {
                                                                var ajaxDisplay = document.getElementById(<?php echo"$datatarget2"; ?>);
                                                                ajaxDisplay.innerHTML = html;
                                                            }
                                        ...
                                        if($d4<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor4;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d444&months=$mm4&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d444&months=$mm4&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d444' and months='$mm4' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d444&months=$mm4&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid4,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d444&months=$mm4&years=$y&" ?>empid='+employeeid4, 
                                                            success: function(html) {
                                                                var ajaxDisplay = document.getElementById(<?php echo"$datatarget2"; ?>);
                                                                ajaxDisplay.innerHTML = html;
                                                            }
                                        ...
                                        if($d5<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor5;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d555&months=$mm5&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d555&months=$mm5&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d555' and months='$mm5' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d555&months=$mm5&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid5,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d555&months=$mm5&years=$y&" ?>empid='+employeeid5, 
                                                            success: function(html) {
                                                                var ajaxDisplay = document.getElementById(<?php echo"$datatarget2"; ?>);
                                                                ajaxDisplay.innerHTML = html;
                                                            }
                                        ...
                                        if($d6<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor6;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d666&months=$mm6&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d666&months=$mm6&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d666' and months='$mm6' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d666&months=$mm6&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid6,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d666&months=$mm6&years=$y&" ?>empid='+employeeid6, 
                                                            success: function(html) {
                                                                var ajaxDisplay = document.getElementById(<?php echo"$datatarget2"; ?>);
                                                                ajaxDisplay.innerHTML = html;
                                                            }
                                        ...
                                        if($d7<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor7;border-left: 1px solid #333333'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onmouseover=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                                shiftdataV2('schedule-track.php?days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:16px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                            </form>
                                                    </div><div id='$datatarget' style='padding:0px'>";
                                                        $r5a = "select * from shifting_allocation where employeeid='".$rab7["id"]."' and days='$d777' and months='$mm7' and years='$y' and status='1' order by sdate asc";
                                                        $r5b = $conn->query($r5a);
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            $clientname="";
                                                            $r1x = "select * from uerp_user where id='".$r5c['clientid']."' order by id asc limit 1";
                                                            ...
                                                            if($r5c["accepted"]=="3") $statuscolor="yellow";
                                                            if($pstatus!=0){
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-25px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <i class='fa fa-clock-o'></i> <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname @ $projectname</span>
                                                                </a></div>";
                                                            }
                                                ...
                                                <script type="text/javascript">
                                                    function  <?php echo"$getData"; ?>(employeeid7,<?php echo"$datatarget2"; ?>){
                                                        $.ajax({
                                                            url: 'schedule-track.php?<?php echo"days=$d777&months=$mm7&years=$y&" ?>empid='+employeeid7, 
                                                            success: function(html) {
                                                                var ajaxDisplay = document.getElementById(<?php echo"$datatarget2"; ?>);
                                                                ajaxDisplay.innerHTML = html;
                                                            }
            ...
            echo"<div class='modal inmodal cardt' id='schedulecopyday' tabindex='-1' role='dialog' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content animated bounceInUp '>
                        <form class='m-t' role='form' method='post' action='dataprocessor.php' id='schedule-form' target='dataprocessor' enctype='multipart/form-data'>
                            ...
                            <div class='modal-footer'>
                                ...
                                <input type='submit' class='btn btn-primary recordupdated' value='Clone Day'>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            echo"<div class='modal inmodal cardt' id='schedulecopyweek' tabindex='-1' role='dialog' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content animated bounceInUp '>
                        <form class='m-t' role='form' method='POST' name='wcopy' action='dataprocessor.php' id='schedule-form' target='dataprocessor' enctype='multipart/form-data'>
                            ...
                            <div class='modal-footer'>
                                <button type='button' class='btn btn-white' data-dismiss='modal'>Close</button>
                                <input type='submit' class='btn btn-primary recordupdated' value='Clone Week'>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            echo"<div class='modal inmodal cardt' id='scheduledeleteweek' tabindex='-1' role='dialog' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content animated bounceInUp '>
                        <form class='m-t' role='form' method='POST' name='wcopy' action='dataprocessor.php' id='schedule-form' target='dataprocessor' enctype='multipart/form-data'>
                            ...
                            <div class='modal-footer'>
                                <button type='button' class='btn btn-white' data-dismiss='modal'>Close</button>
                                <input type='submit' class='btn btn-primary' value='Wipe This Week'>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        echo"<form method='get' action='scheduling-set.php' name='main' target='_top'>
            <input type=text name='projectid' value='0'>
            <input type=text name='smsbd' value='schedule-board'>
            <input type=text name='url' value='schedule.php'>
            <input type=text name='id' value='48'>
            <input type=text name='backlink' value='chedule-board'>
        </form>";
