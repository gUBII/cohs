<?php
    $sheba="ndis_line_numbers";
    $cid=1;
    $title="Add New Item Number";
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>NDIS Line Item Numbers</h1>
            <nav class='breadcrumb-container d-inline-block' aria-label='breadcrumb'>
                <ul class='breadcrumb pt-0'>
                    <li class='breadcrumb-item'><a href='index.php'>Home</a></li>";
                    if(isset($_GET["url"])) echo"<li class='breadcrumb-item'><a href='index.php?url=".$_GET["url"]."'>Item Number</a></li>";
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' onclick=\"shiftdataV2('ndis_line_item_number_process.php?cid=$cid&sheba=$sheba&ctitle=$title', 'offcanvasRight')\">
                ...
                <div class='d-inline-block'>
                    ...
                    <div class='dropdown-as-select d-inline-block datatable-length' data-datatable='#datatableStripe'>
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='SortForm'>
                            ...
                            <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=10000000; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">All Data</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=5; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">5 Items</a>
                                <a class='dropdown-item active' href='#' onmouseover=\"document.SortForm.sortvalue.value=10; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">10 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=25; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">25 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=50; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">50 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=100; document.SortForm.submit()\" onmouseup=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">100 Items</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class='data-table-rows slim' id='sample'>
        <body onload=\"shiftdataV2('ndis_line_item_number_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">
        <div class='data-table-responsive-wrapper'>
            <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                <tr>
                    ...
                    <th onclick='sortTable(1)'>Item Number <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(2)'>Item Name <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(3)'>Unit <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(4)'>National Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(5)'>Remote Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(6)'>Very Remote Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(7)'>Status <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th >Action</th>                     
                </tr>
