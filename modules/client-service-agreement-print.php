                            ...
                            <div class='panel-body'>
                                <div class='row'>
                                    <div class='col-lg-12' style='text-align:left'>
                                        <img src='$logo_light' style='width:150px'><Br><br><br>
                                        <center><h1 style='color:black'><b>Service Agreement</b></h1></center><br><br>
                                        <span style='font-size:12pt;color:black;line-height:1.8'>
                                            This Service Agreement is for <b>$cname</b><br>
                                            NDIS Number: <b>$cndis</b><br>
                                            DOB: <b>$cdob2</b><br>
                                            Is made between:<br><br>
                                            Participant/Participant’s Representative: <b>$representative_name</b> and
                                            <br>The Registered Provider: <b>$companynamex</b> ABN: <b>$abn_number</b><br>
                                        ...
                                        <span style='font-size:12pt;color:black;line-height:1.8'>
                                            ...
                                            context of the NDIS, which is a scheme that aims to:<br><br>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class='fa fa-circle' aria-hidden='true' style='font-size:6pt'></i>&nbsp;&nbsp; Support the independence and social and economic participation of people with disability, and<br><br>
                                            ...
                                            <img src='$logo_light' style='width:150px'><br><br>
                                            ...
                                            <table class='table stripe table-hover' border=1 colpadding=0 style='width:100%;padding:10px'>
                                                <thead style='background-color:lightblue;color:black'><tr style=''>
                                                    <th style='color:black;font-size:10pt'>Description</th>
                                                    <th style='color:black;font-size:10pt'>NDIS item #</th>
                                                    <th style='color:black;font-size:10pt'>Unit</th>
                                                    <th style='color:black;font-size:10pt'>Price</th>
                                                    <th style='color:black;font-size:10pt'>Frequency</th>
                                                    <th style='color:black;font-size:10pt'>Comments</th>
                                                </tr></thead>
                                                <tbody>";
                                                    $ttx==0;
                                                    ...
                                                    if ($r1x->num_rows > 0) { while($r1y = $r1x -> fetch_assoc()) {
                                                        echo"<tr class='gradeX'>
                                                            <td style='max-width:400px;color:black;font-size:10pt'>".$r1y["description"]."</td>
                                                            <td nowrap style='color:black;font-size:10pt'>".$r1y["ndis_item"]."</td>
                                                            <td nowrap style='color:black;font-size:10pt'>".$r1y["unit"]."</td>
                                                            <td nowrap style='color:black;font-size:10pt'>".$r1y["price"]."</td>
                                                            <td style='color:black;font-size:10pt'>".$r1y["qty"]."</td>
                                                            <td style='color:black;font-size:10pt'>".$r1y["comments"]."</td>
                                                        </tr>";
                                                    } }
                                                echo"</tbody>
                                            </table>
                                            ...
                                            if($transport_cost=="1") echo"<i class='fa fa-check' aria-hidden='true' style='font-size:10pt'></i> &nbsp;&nbsp; Yes. &nbsp;&nbsp;&nbsp;<i class='fa fa-square' aria-hidden='true' style='font-size:10pt'></i> &nbsp;&nbsp; No.";
                                            else echo"<i class='fa fa-square' aria-hidden='true' style='font-size:10pt'></i> &nbsp;&nbsp; Yes. &nbsp;&nbsp;&nbsp;<i class='fa fa-check' aria-hidden='true' style='font-size:10pt'></i> &nbsp;&nbsp; No.";
                                            ...
                                            echo"<h3 style='color:black'>SIL Prover’s Responsibilities</h3>The SIL Provider will ensure that:<br>
                                            <table width=100%>
                                            ...
                                            echo"<h3  style='color:black'>Participant’s Rights/Responsibilities:</h3>The Participant will ensure that:<br>
                                            <table width=100%>
                                            ...
                                            echo"<h3  style='color:black'>Changes to this Agreement</h3>
                                            ...
                                            If either the Participant or the Service Provider wants to end this agreement, each of them agrees to give 4 weeks’ notice to the other party. If the Participant or the Service Provider seriously breaches this agreement, that notice period will not be required.
                                            <br><br>";
                                            // <table style='width:100%'><tr><td align=right><img src='assets/ndis-logo.png' style='width:50px'></td></tr></table>
                                            echo"<div class='html2pdf__page-break'></div>
                                            <img src='$logo_light' style='width:150px'><br><br>";
                                            
                                            echo"<h3  style='color:black'>Participant information</h3>
                                            <table width=100%>
                                                ...
                                                <tr><td width='150px' nowrap align='left' valign=top><b>Phone Number (DAY)</b></td><td>:</td><td valign=top align=left> $cphone</td></tr>
                                                <tr><td width='150px' nowrap align='left' valign=top><b>Phone Number (NIGHT)</b></td><td>:</td><td valign=top align=left> $cphone2</td></tr>
                                            ...
                                            */
                                            ...
                                            echo"Signature of <b>Participant</b>:____________________________________<br>
                                            Date: <b>$project_signed1</b><br><br><br>
                                            ...
                                            */
                                            ...
                                            $image22=strlen("$image2");
                                            if($image22>=5){
                                                echo"<img src='$image2' style='height:100px;margin-top:-85px;margin-left:200px;max-width:400px;position:absolute'>";
                                            }else{
                                                $signature22=strlen("$signature2");
                                            ...
                                            echo"Signature of <b>Nominee</b>:_________________________________________<br>
                                            Date: <b>$project_signed1</b><br><br><br><br><br><br><br>";
                                            ...
                                            */
                                            ...
                                            $image33=strlen("$image3");
                                            if($image33>=5){
                                                echo"<img src='$image3' style='height:100px;margin-top:-85px;margin-left:300px;max-width:400px;position:absolute'>";
                                            ...
                                            echo"Signature on behalf of <b>$companynamex</b>:____________________________________<br>
                                            Date: <b>$project_signed1</b><br>
