        ...
        // echo"- $tt";
                ...
                <tr>
                    <td>"; ?>
                        ...
                        echo"<div class='hide-area'><form method='post' name='shift_date' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                            ...
                            <table><tr>
                                <td valign=top style='padding-right:25px'>&nbsp;&nbsp;&nbsp;&nbsp;Date From:<input type='date' id='datepicker' name='shiftingiduser2' class='form-control' value='$todaydate1'></td>
                                <td valign=top style='padding-right:25px'>&nbsp;&nbsp;&nbsp;&nbsp;Date To:<input type='date' id='datepicker' name='shiftingiduser3' class='form-control' value='$todaydate2'></td>
                                <td valign=top style='padding-right:25px'>&nbsp;&nbsp;&nbsp;&nbsp;A/c Name: <select class='form-control m-b' name='src_employeeid'>";
                                    if($designationy==13){
                                        if(isset($_GET["src_employeeid"])){
                                            $s77 = "select * from uerp_user where mtype='USER' and status='1' or mtype='EMPLOYEE' and status='1' or mtype='ADMIN' and status='1' order by username asc";
                                            $r77 = $conn->query($s77);
                                            if ($r77->num_rows > 0) { while($rs77 = $r77->fetch_assoc()) { echo"<option value='".$rs77["id"]."'>".$rs77["username"]." ".$rs77["username2"]."</option>"; } }
                                        }else{
                                            echo"<option value=''>Select Employee</option>";
                                        }
                                        //echo"<option value='ALL'>View All/Single User</option><option value='ALL'>View All</option>";
                                ...
                                <td style='' valign=top>";
                                    ...
                                    if(isset($_GET["src_employeeid"])){
                                        ...
                                        if($designationy==13) echo"<input type=button value='Approve Expenses' data-bs-toggle='modal' data-bs-target='#approveexpense' style='margin-top:25px;margin-left:20px' class='btn btn-outline-tertiary btn-icon btn-icon-start w-md-auto btn-sm'>";
                                    }
                                    
                                echo"</td>
                            </tr></table>
                        </form></div>
                        <div class='hide-area1'><form method='post' name='shift_date' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                            <table width=100%><tr>
                                <td valign=top width=50%>&nbsp;&nbsp;&nbsp;&nbsp;Date From:<input type='date' id='datepicker' name='shiftingiduser2' class='form-control' style='font-size:8pt;border-radius:20px;width:100%' value='$todaydate1'></td>
                                <td valign=top width=50%>&nbsp;&nbsp;&nbsp;&nbsp;Date To:<input type='date' id='datepicker' name='shiftingiduser3' class='form-control' style='font-size:8pt;border-radius:20px;width:100%' value='$todaydate2'></td>
                            </tr><tr>
                                <td valign=top width=50% >&nbsp;&nbsp;&nbsp;&nbsp;A/c Name: <select class='form-control m-b' name='src_employeeid' style='font-size:8pt;border-radius:20px;width:100%'>";
                                    if($designationy==13){
                                        echo"<option value='ALL'>View All/Single User</option><option value='ALL'>View All</option>";
                                ...
                                <td valign=top width=50%>&nbsp;<br>
                                    <input type=submit style='padding:3px;border-radius:50px;background-color:$topbar_color;color:$tbtc;margin-top:2px' value='&nbsp;&nbsp; Go &nbsp;&nbsp;'>&nbsp;";
            ...
            echo"<div class='data-table-responsive-wrapper'>
                <table class=' stripe hover' id='myTable' style='width:100%'>
                    <thead class='bg-info color-white' style='border-radius:10px'><tr>
                    ...
                    <tbody><div id='$datatarget' style='padding:0px'>";
                        ...
                        $shift1 = "select * from shifting_allocation where employeeid='".$_GET["src_employeeid"]."' and sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";
                        
                        $shift2 = $conn->query($shift1);
                        if ($shift2->num_rows > 0) { while($shift3 = $shift2 -> fetch_assoc()) { $ts=($ts+1); } }
                             
                        echo"<hr><h5>Showing report From $d1-$m1-$y1 to $d2-$m2-$y2, Total Shift Allocated: $ts and EOD Submitted: $totaleods</span><br><br>";
                        ...
                        */
                        ...
                        else $src_employeeid="ALL";

                        // echo"$src_employeeid, $todayx, $todayy2";
                        
                        if($src_employeeid=="ALL"){
                            // if($mtype=="ADMIN") $r5a = "select * from shifting_allocation where sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";
                            // else $r5a = "select * from shifting_allocation where sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";
                            $r5a = "select * from shifting_allocation where sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";                            
                        }else{
                            // if($mtype=="ADMIN") $r5a = "select * from shifting_allocation where employeeid='".$_GET["src_employeeid"]."' and sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";
                            ...
                            $r5a = "select * from shifting_allocation where employeeid='".$_GET["src_employeeid"]."' and sdate>='$todayx' and sdate<='$todayy2' and status='1' order by sdate asc";                            
                        }
                        ...
                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                            ...
                            if(strlen($r5c["clockin"])>=5) $clockin=date("h:i a", $r5c["clockin"]); else $clockin="-"; 
                            if(strlen($r5c["clockout"])>=5) $clockout=date("h:i a", $r5c["clockout"]); else $clockout="-";
                            ...
                            if($r5c["clockout_request"]==0) echo"<tr class='$bgcolor' >";
                                ...
                                echo"<td nowrap style='padding-left:20px;'>
                                    ...
                                    // if($mtype=="ADMIN") {
                                       if($designationy==13) echo"<a data-bs-toggle='modal' data-bs-target='#editlog$t' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm'>Edit</a>";
                                                    ...
                                                    <div class='modal-body' id='PopupModalX'>
                                                        <form method='post' name='shiftediting' action='scheduling-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <div class='row'>
                                                                ...
                                                                <div class='col-lg-4' style='padding-bottom:20px'><div class='form-group'><label>Wage/Hour *</label><input name='wage_amount' type='text' value='$wageamt' class='form-control' required></div></div>
                                                                <div class='col-lg-4' style='padding-bottom:20px'><div class='form-group'><label>Total Overtime *</label><input name='total_overtime' type='text' value='".$r5c["total_overtime"]."' class='form-control' required></div></div>
                                                                <div class='col-lg-4' style='padding-bottom:20px'><div class='form-group'><label>Overtime/Hour *</label><input name='overtime_amount' type='text' value='".$r5c["overtime_amt"]."' class='form-control' required></div></div>
                                ...
                                */
                                ...
                                echo"<td align=left style='min-width:200px;'>";
                                ...
                                <td nowrap valign=top align=center style='font-size:12pt;'><br><b>$clockin</b><br>
                                    <a href='#' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' data-bs-toggle='modal' data-bs-target='#userlog$t')\">User Log</a>
                                    ...
                                    <div class='modal inmodal' id='userlog$t' tabindex='-1' role='dialog' aria-hidden='true'>
                                        <div class='modal-dialog'>
                                            <div class='modal-content animated bounceInUp'>
                                                <div class='modal-header'>
                                                    <h5 class='modal-title' id='exampleModalLabelCloseOut'>User`s Note/Log</h5>
                                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                                </div>
                                ...
                                <td nowrap valign=top align=right style='font-size:10pt;'><br><b>$total_hour_worked H</b><br>";
                                    ...
                                    // echo"<a href='#' style='font-size:8pt;border-radius:50px;padding-top:5px;padding-bottom:5px;padding-left:10px;padding-right:10px;background-color:$topbar_color;color:$tbtc;margin-top:3px'>EOD</a>";
                                ...
                                if($mtype=="ADMIN") {
                                    echo"<td align=center><a href='dataprocessor.php?processor=shiftapprove&shiftid=".$r5c["id"]."&status=4' target='dataprocessor' style='margin-top:0px;color:$topbar_color'>
                        ...
                        if($netpayablex!=0){
                            if($_GET["src_employeeid"]!="ALL"){
                                ...
                                echo"<tr>
                                    ...
                                    <td align=right>&nbsp;</td>
                                    <td align=right style='font-size:8pt'><b>Total OT</b></td>
                                    <td align=right>&nbsp;</td>
                                    <td align=right>&nbsp;</td>
                                ...
                                echo"<tr>
                                    ...
                                    <td align=right><b>$totalovertime Hr.</b></td>
                                    <td align=center colspan=2><b>=</b></td>
                                    <td align=right style='font-size:12pt;color:black;background-color:#dddddd'><b>$netpayablex</b></td>
                                                ...
                                                <div class='modal-content animated bounceInUp' id='printArea'><center>
                                                    ...
                                                    <div class='modal-body' style='padding:0px'>
                                                        ...
                                                        <table class='table table-striped table-bordered table-hover dataTables-example' style='width:100%'>
                                                            ...
                                                            <tbody>";
                                                                $todayx=strtotime($_COOKIE["shiftingid2"]);
                                                                $todayy=strtotime($_COOKIE["shiftingid3"]);
                                                                ...
                                                                if ($r5bp->num_rows > 0) { while($r5cp = $r5bp -> fetch_assoc()) {
                                                                    ...
                                                                    // if($r5cp["payroll"]==0) $totalovertimep=($totalovertimep+$total_overtimep);
                                                    ...
                                                    <div class='col-md-12'>
                                                        <div class='ibox'>
                                                            <div class='ibox-content text-left'>";
                                                                    ...
                                                                    <thead>
                                                                        ...
                                                                        if ($r->num_rows > 0) { while($rs = $r->fetch_assoc()) {
                                                                            ...
                                                                            echo"<tr>
                                                                                ...
                                                                                echo"<td align=center style='font-size:10pt'><a href='#' class='btn ' data-bs-toggle='modal' data-bs-target='#$myexperienceX' style='margin-top:0px;color:$topbar_color'><i class='fa fa-eye'></i></a></td>
                                                                                <td align=center style='font-size:10pt'>";
                                                                                    // echo"<a href='#' class='btn ' data-bs-toggle='modal' data-bs-target='#$myexperienceY' style='margin-top:0px;color:$topbar_color'><i class='fa fa-eye'></i></a>";
                                                                                    echo"<a href='".$rs["image"]."' class='btn ' style='margin-top:0px;color:$topbar_color'><i class='fa fa-eye'></i></a>";
                                                                                    
                                                                                echo"</td>
                                                                                <td align=right style='font-size:10pt;background-color:#eeeeee;color:black'><b>$".$rs["dr_amt"]."</b></td>
                                                                            </tr>";
                                                                ...
                                                                $payablex = $payablex;
                                                                echo"<table width='100%'>
                                                                    <tr><td align=right style='font-size:12pt'>Total Expense Payable :</b></td><td align=right style='width:150px;font-size:12pt'> <b>$epayable</b></td></tr>
                                                                    <tr><td align=right style='font-size:12pt'>Total Roster Payable :</b></td><td align=right style='width:150px;font-size:12pt'> <b>$netpayablex</b></td></tr>
                                                                    <tr><td align=right style='font-size:12pt'>Total Roster Paid :</b></td><td align=right style='width:150px;font-size:12pt'> <b>- $payablex</b></td></tr>
                                                                    <tr><td align=right style='font-size:16pt'>Gross Earning :</b></td><td align=right style='width:150px;font-size:14pt'> <b>$payableZ</b></td></tr>
                                                                </table><hr>";
                                ...
                                if($mtype=="ADMIN"){
                                    echo"<tr><td colspan=13>
                                        <table><tr>
                                            <td style='padding=20px'><a href='#'  class='btn btn-primary' data-bs-toggle='modal' data-bs-target='#payslip')\">View Payslip</a></td>
                                            <td style='padding=20px'><a href='#' onclick=\"printDiv('printArea')\" class='btn btn-secondary'>Print Payslip</a></td>
                                            <td style='padding=20px'><a href='index.php?smsbd=settle-payment&src_employeeid=".$_GET["src_employeeid"]."' target='dataprocessor' class='btn btn-tertiary'>Settle Payment</a></td>";
                                            // <td><a href='#' data-bs-toggle='modal' data-bs-target='#payslipexpense' class='dropdown-item' onclick=\"getDataXYZ('".$_GET["src_employeeid"]."-1', 'datatargetZ')\" style='width:150px;border-radius:50px;padding:5px;padding-left:10px;padding-right:10px;background-color:$topbar_color;color:$tbtc;'>Expense Over Payslip</a></td>
                                        echo"</tr></table>
                                    </td></tr>";
                                }
                            }
            ...
            echo"<div class='modal fade modal-close-out' id='approveexpense' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabelCloseOut' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content' style='padding:5px'>
                        <div class='modal-header'>
                            <h5 class='modal-title' id='exampleModalLabelCloseOut'>Admin Expense Approval</h5>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <div class='modal-body' id='PopupModalX' style='padding:5px'>
                            <iframe name='processor' src='https://www.nexis365.com/saas/modules/approveexpense.php?src_employeeid=".$_GET["src_employeeid"]."' height='400' width='100%' scrolling='no' border='0' frameborder='0'>&nbsp;</iframe>
                        </div>
                    </div>
                </div>
            </div>";
            ...
            echo"<div class='modal fade modal-close-out' id='myexperience' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabelCloseOut' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h5 class='modal-title' id='exampleModalLabelCloseOut'>Admin Expense Entry</h5>
                            <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                        </div>
                        <div class='modal-body' id='PopupModalX'>
                                ...
                                <div class='modal-body'>
                                    <div class='row'>
                                        ...
                                        <div class='col-md-6' style='padding-bottom:20px'><div class='form-group'>
                                            ...
                                            <option value='123'>Select Client</option>";
