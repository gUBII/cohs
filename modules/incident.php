...
<?php 
    ...
    echo"<div class='row'>
        ...
        <div class='col-4 col-md-7 d-flex align-items-start justify-content-end'>
            <a href='index.php?url=incident-reports.php' style='margin-right:10px'><button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button'><span>View Reports</span></button></a>";
            if($mtype=="ADMIN"){
                                        ...
                                        if($designation=="6"){
                                            echo"<div class='form-group' style='margin-bottom:25px'><label>Employee Name *</label>
                                                <select class='form-control m-b' name='employeeid' required>
                                                    <option value='".$_COOKIE["userid"]."'>$username $username2</option>";
                                            ...
                                            echo"<div class='form-group' style='margin-bottom:25px'><label>Employee Name *</label><select class='form-control m-b required' name='employeeid'>
                                                <option value='".$_COOKIE["userid"]."'>$username $username2</option></select>
                                            </div>";
                                        }
