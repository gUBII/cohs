<?php
    ...
    $tcount=0;
    $c1 = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='2' order by activity asc";
    $d1 = $conn->query($c1);
    if ($d1->num_rows > 0) { while($cs1 = $d1->fetch_assoc()) {
        $stime=time();
        $etime=$cs1["end"];
        if($etime<=$stime){
            $sql="update appointments_manager set activity='4' where id='".$cs1["id"]."'";
    ...
    if($designationy!=13){
        ...
        $sqlIncompleteX = "SELECT * FROM appointments_manager where employeeid='$userid' and activity<>'10' $projectidx ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncompleteX);
        $incomleteItemsX = mysqli_fetch_all($result,MYSQLI_ASSOC);
        
        $sqlIncomplete = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='0' $projectidx ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncomplete);
        $incomleteItems = mysqli_fetch_all($result,MYSQLI_ASSOC);
                        
        $sqlProcessing = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='1' $projectidx ORDER BY id desc";
        $processingResult = mysqli_query($conn, $sqlProcessing);
        $processingItems = mysqli_fetch_all($processingResult, MYSQLI_ASSOC);
                        
        $sqlCompleted = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='2' $projectidx ORDER BY id desc";
        $completeResult = mysqli_query($conn, $sqlCompleted);
        $completeItems = mysqli_fetch_all($completeResult, MYSQLI_ASSOC);
        
        $sqlOnhold = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='3' $projectidx ORDER BY id desc";
        $onholdResult = mysqli_query($conn, $sqlOnhold);
        $onholdItems = mysqli_fetch_all($onholdResult, MYSQLI_ASSOC);
        
        $sqlOnReject = "SELECT * FROM appointments_manager where employeeid='$userid' and activity='4' $projectidx ORDER BY id desc";
        $onRejectResult = mysqli_query($conn, $sqlOnReject);
        $onRejectItems = mysqli_fetch_all($onRejectResult, MYSQLI_ASSOC);
        
    }else{
        $sqlIncompleteX = "SELECT * FROM appointments_manager where  activity<>'10' $projectidx ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncompleteX);
        $incomleteItemsX = mysqli_fetch_all($result,MYSQLI_ASSOC);
        
        $sqlIncomplete = "SELECT * FROM appointments_manager where activity='0' $projectidx ORDER BY id desc";
        $result = mysqli_query($conn, $sqlIncomplete);
        $incomleteItems = mysqli_fetch_all($result,MYSQLI_ASSOC);
                        
        $sqlProcessing = "SELECT * FROM appointments_manager where activity='1' $projectidx ORDER BY id desc";
        $processingResult = mysqli_query($conn, $sqlProcessing);
        $processingItems = mysqli_fetch_all($processingResult, MYSQLI_ASSOC);
                        
        $sqlCompleted = "SELECT * FROM appointments_manager where activity='2' $projectidx ORDER BY id desc";
        $completeResult = mysqli_query($conn, $sqlCompleted);
        $completeItems = mysqli_fetch_all($completeResult, MYSQLI_ASSOC);
        
        $sqlOnhold = "SELECT * FROM appointments_manager where activity='3' $projectidx ORDER BY id desc";
        $onholdResult = mysqli_query($conn, $sqlOnhold);
        $onholdItems = mysqli_fetch_all($onholdResult, MYSQLI_ASSOC);
        
        $sqlOnReject = "SELECT * FROM appointments_manager where activity='4' $projectidx ORDER BY id desc";
        $onRejectResult = mysqli_query($conn, $sqlOnReject);
        $onRejectItems = mysqli_fetch_all($onRejectResult, MYSQLI_ASSOC);
    }
    ...
    echo"<div class='scroll-section' id='wrapper'>
        <div class='wrapper wrapper-content  animated fadeInTop' style='width:100%;'>
            <div class='row' id='sortable-view'>";
                ...
                if($projectid==0){ 
                    echo"<div class='col-md-3' id='droppable1' style='min-height:300px'><br><span style='font-size:12pt'>Pending</span><hr>";
                                            ...
                                            <td>
                                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                        ...
                                                        if($mtype=="ADMIN"){
                                                            echo"<hr><a href='#' target='dataprocessor' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#edittask' onmouseover=\"shiftdataV2('appointment_manager_process.php?cid=$cid&sheba=$sheba&ctitle=$title&url=appointment_manager.php&id=58&tid=".$item['id']."', 'edittask')\">Edit</a>";
                                                            echo"<hr><a href='deletetask.php?delid=".$item['id']."&tbl=appointments_manager' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                        }
                                                    echo"</div>
                                                </div>
                                            </td>
                    ...
                    echo"<div class='col-lg-3' id='droppable2' style='min-height:300px'><br><span style='font-size:12pt'>Processing</span><hr>";
                                            ...
                                            <td>
                                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                        ...
                                                        if($mtype=="ADMIN"){
                                                            echo"<hr><a href='#' target='dataprocessor' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#edittask' onmouseover=\"shiftdataV2('appointment_manager_process.php?cid=$cid&sheba=$sheba&ctitle=$title&url=appointment_manager.php&id=58&tid=".$pitem['id']."', 'edittask')\">Edit</a>";
                                                            echo"<hr><a href='deletetask.php?delid=".$pitem['id']."&tbl=appointments_manager' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                        }
                                                    echo"</div>
                                                </div>
                                            </td>
                    ...
                    <div class='col-lg-3' id='droppable3' style='min-height:300px'><br><span style='font-size:12pt'>Completed</span><hr>";
                                            ...
                                            <td>
                                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                        ...
                                                        if($mtype=="ADMIN"){
                                                            echo"<hr><a href='#' target='dataprocessor' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#edittask' onmouseover=\"shiftdataV2('appointment_manager_process.php?cid=$cid&sheba=$sheba&ctitle=$title&url=appointment_manager.php&id=58&tid=".$citem['id']."', 'edittask')\">Edit</a>";
                                                            echo"<hr><a href='deletetask.php?delid=".$citem['id']."&tbl=appointments_manager' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                        }
                                                    echo"</div>
                                                </div>
                                            </td>
                    ...
                    <div class='col-lg-3' id='droppable4' style='min-height:300px'><br><span style='font-size:12pt'>Onhold</span><hr>";
                                            ...
                                            <td>
                                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                        ...
                                                        if($mtype=="ADMIN"){
                                                            echo"<hr><a href='#' target='dataprocessor' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#edittask' onmouseover=\"shiftdataV2('appointment_manager_process.php?cid=$cid&sheba=$sheba&ctitle=$title&url=appointment_manager.php&id=58&tid=".$oitem['id']."', 'edittask')\">Edit</a>";
                                                            echo"<hr><a href='deletetask.php?delid=".$oitem['id']."&tbl=appointments_manager' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                        }
                                                    echo"</div>
                                                </div>
                                            </td>
                    ...
                    <div class='col-lg-3' id='droppable5' style='min-height:300px'><br><span style='font-size:12pt'>Expired Appointments</span><hr>";
                                            ...
                                            <td>
                                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                                        ...
                                                        if($mtype=="ADMIN"){
                                                            echo"<hr><a href='#' target='dataprocessor' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#edittask' onmouseover=\"shiftdataV2('appointment_manager_process.php?cid=$cid&sheba=$sheba&ctitle=$title&url=appointment_manager.php&id=58&tid=".$ritem['id']."', 'edittask')\">Edit</a>";
                                                            echo"<hr><a href='deletetask.php?delid=".$ritem['id']."&tbl=appointments_manager' target='dataprocessor' style='color:red' class='dropdown-item' >Delete</a>";
                                                        }
                                                    echo"</div>
                                                </div>
                                            </td>
