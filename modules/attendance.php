        ...
        if(!isset($_COOKIE["shiftingidtoday"])){        
            ...
            echo"<div class='row'>
                <div class='col-12 col-md-5' style='padding-bottom:10px'>
                    ...
                    <h1 class='mb-0 pb-0 display-4' id='title'>Clock IN/OUT (Attendance Keeper)</h1>
                                ...
                                <div class='col-lg-4'>
                                    <div class='ibox '>
                                        ...
                                        <div class='ibox-content' style='min-height:330px;padding-left:5px;padding-right:5px'>
                                            <center><span style='font-size:10pt;color:black'>Admin's Note</span></center><br>";
                                                $clientlocation="";
                                                ...
                                                if ($tc5->num_rows > 0) { while($tc6 = $tc5 -> fetch_assoc()) {
                                                    echo"<span style='font-size:10pt;color:black'>".$tc6["admin_note"]."</span>";
                                                    $clientlocation=$tc6["address"];
                                                } }
                                            echo"<hr><center><span style='font-size:10pt;color:black'>User's Note</span></center><br>
                                            ...
                                            <center><a href='scheduling-unset.php?unset=timeclock' class='btn-active btn' style='width:80%;height:30px;border-radius:20;background-color:#77DE78;color:black'>Back to Schedule</a></center><br>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='col-lg-4'>
                                    <div class='ibox '>
                                        ...
                                        <div class='ibox-content' style='min-height:330px;padding-left:10px;padding-right:10px'>
                                            <span style='font-size:12pt;color:black'><b>$clientlocation</b></span><Br>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class='ibox'>
                                                            ...
                                                            <td align=left width='50' nowrap>";
                                                                ...
                                                                echo"<table><tr>
                                                                    ...
                                                                    <td align=left width=50 nowrap style='padding-right:10px'>
                                                                        <a href='index.php?url=time_sheet.php' target='_self' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' style='margin-top:0px;margin-left:10px'>
                                                                            <span class='d-inline-block no-delay' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='View Time Sheet'>View Time Sheet</span>
                                                                        </a>
                                                                    </td>                                                                    
                                                                </tr></table>
                                                            </td>
                                            ...
                                            <div class='panel-body' style='padding:0px'>
                                                <div class='ibox-content' style='padding-left:5px;padding-right:5px'><br>
                                                    <center><h4 >Only today's shift can be Clocked-In</h4></center><hr>";
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d11 $d111 $m1, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d1&mm=$mm1&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-12'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:$topbar_color;color:$tbtc;text-align:center;padding:5px'>
                                                                                <a href='scheduling-set.php?dd=$d1&mm=$mm1&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <br><span style='font-size:12pt;color:white'>$d11 $d1 $m1, $y<br></span>
                                                                                
                                                                            </div>
                                                                            <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'><center>
                                                                                <div id='$datatarget' style='padding:0px;width:80%;text-align:center'><br><br>
                                                                                    <div class='row'>";
                                                                                        /*
                                                                                        ...
                                                                                        */
                                                                                            ...
                                                                                            if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                                                                ...
                                                                                                echo"<div class='col-lg-$tox1' style='min-height:200px;'> ";
                                                                                                    if($r5c["accepted"]==1 and $day=="$d1" AND $month=="$mm1" AND $y=="$y"){
                                                                                                        ...
                                                                                                        // }else{
                                                                                                            echo"<a href='scheduling-set.php?timeclock=".$r5c["id"]."' class='dropdown-item' style='border-radius:20px'>";
                                                                                                        // }
                                                                                                        ...
                                                                                                        echo"<div style='width:100%;padding:2px;color:white' id='".$r5c["id"]."' draggable='true' ondragstart='drag(event)'>
                                                                                                            <div class='btn' style='color:$statuscolor2;background-color:$statuscolor;width:200px;height:200px;text-align:center;border-radius:50%'>
                                                                                                                <br><br><i class='fa fa-clock-o' style='font-size:30pt'></i><br>
                                                                                                    ...
                                                                                                    echo"<center><table style='height:60px;'>
                                                                                                        <tr><td align=center>Location: <b><br>".$r5c["address"]."</b></td></tr>
                                                                                                        <tr><td align=center><br>Admin Note: <b><br>".$r5c["admin_note"]."</b></td></tr>
                                                    ...
                                                    echo"</div><hr>
                                                    <center><h4 style='color:green'>Weekly Allocated Shifting List</h4></center><hr>";
                                                        ...
                                                        if ($rb7->num_rows > 0) { while($rab7 = $rb7->fetch_assoc()) {        
                                                            ...
                                                            if($d1<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    ...
                                                                    echo"<div class='col-lg-3' style='margin-bottom:20px'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d1&mm=$mm1&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d11</b><br>$d1 $m1, $y<br></span></center>
                                                                                <div class='text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                                                        ...
                                                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                                                            ...
                                                                                            if($r5c["request2"]==0) echo"<a href='#' class='dropdown-item' data-toggle='modal' data-target='#schedulemover1' onclick=\"getDataMove1('".$r5c["id"]."', 'schedulemover2')\">";
                                                                                            else echo"<a href='#' class='dropdown-item' data-toggle='modal'>";
                                                                                                echo"<div style='width:100%;padding:2px;color:white' id='".$r5c["id"]."' draggable='true' ondragstart='drag(event)'>
                                                                                                    <div class='btn' style='color:white;background-color:$statuscolor;width:100%;text-align:left;border-radius:10px'>
                                                                                                        <i class='fa fa-clock-o' style='font-size:12pt'></i> <span style='font-size:12pt'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt'>$clientname @ $projectname<br>".$r5c["address"]."</span>
                                                                                                    </div>
                                                                                                </div>";
                                                                                            echo"</a>";
                                                            ...
                                                            if($d2<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d22 $d222 $m2, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d222&mm=$mm2&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d222&mm=$mm2&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d22</b><br>$d222 $m2, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                            ...
                                                            if($d3<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d33 $d333 $m3, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d333&mm=$mm3&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d333&mm=$mm3&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d33</b><br>$d333 $m3, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt;text-align:center'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d44 $d444 $m4, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d444&mm=$mm4&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d444&mm=$mm4&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d44</b><br>$d444 $m4, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                            ...
                                                            if($d5<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d55 $d555 $m5, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d555&mm=$mm5&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d555&mm=$mm5&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d55</b><br>$d555 $m5, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                            ...
                                                            if($d6<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d66 $d666 $m6, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d666&mm=$mm6&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox '>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d666&mm=$mm6&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d66</b><br>$d666 $m6, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
                                                            ...
                                                            if($d7<=$lastdate){
                                                                ...
                                                                if($lts==1){
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox' style='padding:5px;background-color:#F7C6C5;font-size:10pt'>
                                                                            <div class='ibox-title' style='padding:5px;color:black;background-color:#F7C6C5;'><center>NOT AVAILABLE</center><hr><span style='font-size:8pt;color:$color4'>$d77 $d777 $m7, $y<br></span></div>
                                                                            <div class='ibox-content text-center'>
                                                                                <a href='scheduling-set.php?dd=$d777&mm=$mm7&yy=$y&empid4=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Available</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>";
                                                                }else{
                                                                    ...
                                                                    echo"<div class='col-lg-3'>
                                                                        <div class='ibox'>
                                                                            <div class='ibox-title' style='background-color:#cccccc;color:#000000;text-align:center;padding:5px;border-radius:20px'>
                                                                                <center><a href='scheduling-set.php?dd=$d777&mm=$mm7&yy=$y&empid=".$_COOKIE["userid"]."' class='btn-active btn btn-xs' style='background-color:orange;color:black;border-radius:10px'>Set Unavailable</a>
                                                                                <hr><span style='font-size:12pt;color:black'><b>$d77</b><br>$d777 $m7, $y<br></span></center>
                                                                                <div class='ibox-content text-center'style='background-color:$sidebar_color;color:$sbtc;padding:5px;text-align:center'>
                                                                                    <div id='$datatarget' style='padding:0px;width:100%;text-align:center'>";
