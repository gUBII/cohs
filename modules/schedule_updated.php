                ...
                echo"<div class='row'>
                    ...
                    <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
                        ...
                        if(isset($_COOKIE["projectidx"])){
                            echo"<a href='index.php?url=projects.php&pstat=1' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' type='button' style='margin-right:5px'>
                                <span class='d-inline-block no-delay' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='View Project Profile' ><i data-acorn-icon='document'></i>View Project</span>
                            </a>";
                        }
                        ...
                        <table width=100%><tr>
                            <td align=left width=50 nowrap style='padding-right:10px'>
                                <div class='d-inline-block datatable-export' data-datatable='#datatableStripe' style='margin-top:-15px;margin-right:5px'>
                                    <button class='btn btn-primary btn-icon btn-icon-start w-md-auto btn-sm' btn-outline-muted btn-sm dropdown' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'>
                                    ...
                                    <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end' style='background-color:red;color:white'>
                            ...
                            <td align=left width='50'>";
                                ...
                                echo"<a href='index.php?url=daily_schedules.php&id=5206&src_employeeid=".$_GET["src_employeeid"]."'>
                                    <input type=button class='btn btn-outline-secondary btn-icon btn-icon-start w-md-auto btn-sm' value=\"Day View\" style='margin-right:5px' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Day View'>
                                </a>
                            </td>
                            <td align=left width='50'>
                    ...
                    echo"<div class='tab-content'><hr>
                        <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                            <tr style='position:sticky;margin-top:100px;top:0;z-index:1;height:70px' class='btn-primary'>
                                <th class='text-medium text-uppercase'>
                                    Users View
                                        ...
                                        if($d1<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor1;'>
                                                    <div style='width:100%;text-align:right;padding:0px'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d1&months=$mm1&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                    ...
                                                    <div id='$datatarget' style='padding:0px;height:80%'>";
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor2'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor3'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                        ...
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            ...
                                                            if($pstatus!=0){
                                                                ...
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";padding-left:10px;padding-right:10px;height:50px;width:100%;text-align:left;border-radius:10px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-5px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <div style='position:absolute;color:white;background-color:$nightcolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:10px;margin-top:-15px' title='Blue=Night OFF, Black=Night On'></div>
                                                                    <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname - $tdiv</span>
                                                                </a></div>";
                                                            }
                                                        } }
                                                    echo"</div>
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor4'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d444&months=$mm4&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor5'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d555&months=$mm5&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor6'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d666&months=$mm6&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:0px;background-color:$bgcolor7'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input type=hidden name='rgd' value='$getData'>";
                                                            /* <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                onclick=\"this.form.submit(); shiftdataV2('schedule-allocation-selector.php?days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'offcanvasRight'); 
