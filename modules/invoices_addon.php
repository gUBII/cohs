                ...
                if ($r1x->num_rows > 0) { while($r1y = $r1x -> fetch_assoc()) {
                    ...
                    echo"<tr class='gradeX'>";
                            ...
                            <td align=left style='font-size:8pt'>";
                                ...
                                <form name='form_$t3xy' method='post' action='../invoiceprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                                    <input type='hidden' name='processor' value='invoiceupdate'>
                                    <input type='hidden' name='id' value='".$r1y["id"]."'>
                            ...
                            <td style='font-size:8pt'><a href='../deleterecords.php?tbl=ndis_invoices_addon&delid=".$r1y["id"]."&pid=".$_GET["pid"]."&rid=".$_GET["rid"]."&sid=".$_GET["sid"]."&lid=".$_GET["lid"]."' target='_self' class='btn btn-outline-danger btn-icon btn-icon-start w-md-auto btn-sm' type='button' >Del</a></td>
                        </tr>
                    </form>";
                } }
            echo"</tbody>
