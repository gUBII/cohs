                ...
                <div class='data-table-rows slim' id='sample'>
                    ...
                    echo"<div class='tab-content'><hr>
                        <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                            <tr>
                                <th class='text-primary text-medium text-uppercase'>Users View</th>";
                                    ...
                                    echo"<tr>
                                        ...
                                        if($d1<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor1;'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d1&months=$mm1&rdt=$datatarget&years=$y&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                    ...
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        ...
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            ...
                                                            if($pstatus!=0){
                                                                ...
                                                                echo"<div style='padding:5px;width:100%'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-info ' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d1&months=$mm1&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px;width:100%;text-align:left;border-radius:10px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-15px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <div style='position:absolute;color:white;background-color:$nightcolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:0px;margin-top:-15px' title='Blue=Night OFF, Black=Night On'></div>
                                                                    <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname</span>
                                                                </a></div>";
                                                            }
                                                        } }
                                                    echo"</div>
                                        ...
                                        if($d2<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor2'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div id='$datatarget' style='padding:0px'>";
                                                        ...
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            ...
                                                            if($pstatus!=0){
                                                                ...
                                                                echo"<div style='padding:5px;text-align:left'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d222&months=$mm2&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px;width:100%;text-align:left;border-radius:10px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-15px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <div style='position:absolute;color:white;background-color:$nightcolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:0px;margin-top:-15px' title='Blue=Night OFF, Black=Night On'></div>
                                                                    <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname</span>
                                                                </a></div>";
                                        ...
                                        if($d3<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor3'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d333&months=$mm3&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                        ...
                                        if($d4<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor4'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d444&months=$mm4&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                        ...
                                        if($d5<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor5'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d555&months=$mm5&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                        ...
                                        if($d6<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor6'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d666&months=$mm6&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                        ...
                                        if($d7<=$lastdate){
                                            ...
                                            if($lts==1){
                                                ...
                                                echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor7'>
                                                    <div style='width:100%;text-align:right;'>
                                                        <form name='$datatarget' method='post' action='schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            <input type=hidden name='reidx' value='".$rab7["id"]."'>
                                                            ...
                                                            <button type='submit' class='btn btn-outline-primary btn-sm' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight' 
                                                                ...
                                                                shiftdataV2('schedule-track.php?days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', '$datatarget')\" style='padding:3px;height:17px;width:18px'>
                                                                <i class='fa-solid fa-plus' style='font-size:8pt'></i>
                                                            </button>
                                                            </form>
                                                        ...
                                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                            ...
                                                            if($pstatus!=0){
                                                                ...
                                                                echo"<div style='padding:5px'><a href='#' data-bs-toggle='modal' data-bs-target='#schedulemover1' class='btn btn-outline-primary btn-icon btn-icon-start' onclick=\"shiftdataV2('schedule-mover.php?t=1&smid=".$r5c["id"]."&days=$d777&months=$mm7&years=$y&rdt=$datatarget&empid=".$rab7["id"]."', 'schedulemover2')\" draggable='true' ondragstart='drag(event)' style='background-color:".$r5c["color"].";height:50px;width:100%;text-align:left;border-radius:10px'>
                                                                    <div style='position:absolute;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:-5px;margin-top:-15px' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                    <div style='position:absolute;color:white;background-color:$nightcolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;margin-left:0px;margin-top:-15px' title='Blue=Night OFF, Black=Night On'></div>
                                                                    <span style='font-size:8pt;color:white'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt;color:white'>$clientname</span>
                                                                </a></div>";
                                                            }
