...
<?php
    ...
    // echo"".$_POST["nid"]."";
        ...
        $s = "select * from ndis_invoices where id='".$_POST["nid"]."' and ledger_id='".$_POST["ledgerid"]."' and invoice_no='".$_POST["invoiceid"]."' order by id asc limit 1";
        $r = $conn->query($s);
                ...
                <table style='width:100%;border-color:#FFFFFF;padding:10px'>
                    ...
                    <tr><td colspan=10>
                        <table class='table stripe table-hover' style='width:100%;padding:10px;background-color:white'>
                            <thead><tr style='background-color:#cccccc'><th nowrap>Dt.From-To</th><th nowrap>Schedule Date</th><th nowrap>Description</th><th nowrap>NDIS S.L.Item</th><th nowrap>Hours</th><th nowrap>Rate</th><th nowrap>Amount</th></tr></thead>
                            <tbody>";
                                $ttx1=0;
                                ...
                                if ($r1x->num_rows > 0) { while($r1y = $r1x -> fetch_assoc()) {
                                    echo"<tr class='gradeX'>";
                                        ...
                                        echo"<td nowrap align=left style='font-size:10pt;color:black'>$dfrom - $dto</td>
                                        <td align=left nowrap style='font-size:10pt;color:black'>$rdate</td>
