<?php
    echo"<div class='row wrapper border-bottom white-bg page-heading'><div class='col-lg-12'>";
        if(isset($_COOKIE["projectidx"])) echo"<a href='client-cb-unset.php' class='btn btn-xs' style='margin-top:10px;background-color:blue;color:white'><i class='fa fa-arrow-left'></i> Project Home</a>";
        echo"<h2>Project & Communication Book</h2></td></tr></table>
    </div></div>
    ...
    <div class='wrapper wrapper-content animated fadeInRight' style='padding-left:5px;padding-right:5px'>";
        if($mtype=="ADMIN"){
                                    ...
                                    <form method='post' name='staffingx' action='dataprocessor03.php' target='dataprocessor' enctype='multipart/form-data'>";
                                        ...
                                        if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                            ...
                                            <div class='modal-body'>
                                                <div class='row'>
                                                    <div class='col-md-6'><div class='form-group'><label>Project Name *</label><input name='name' type='text' value='".$rab1["name"]."' class='form-control' required></div></div>
                                                    <div class='col-md-6'><div class='form-group'><label>Client Name *</label><select class='form-control m-b ' name='clientid' required>
                                                    ...
                                                    echo"</select></div></div>";
                                                    /*
                                                    <div class='col-md-6'><div class='form-group'><label>Start Date *</label><input name='sdate' type='date' value='$sdate' class='form-control' required></div></div>
                                                    <div class='col-md-6'><div class='form-group'><label>End Date *</label><input name='edate' type='date' value='$edate' class='form-control' required></div></div>
                                                    */
                                                    echo"<div class='col-md-5'><div class='form-group'><label>Start Time *</label><input name='stime' type='time' value='".$rab1["stime"]."' class='form-control' required></div></div>
                                                    <div class='col-md-5'><div class='form-group'><label>End Time *</label><input name='etime' type='time' value='".$rab1["etime"]."' class='form-control' required></div></div>
                                                    <div class='col-md-2'><div class='form-group'><label>Color</label><input name='pcolor' type='color' value='".$rab1["name"]."' class='form-control' style='height:38px' required></div></div>
                                                    
                                                    <div class='col-md-4'><div class='form-group'><label>Contact Value *</label><input name='rate' type='text' value='".$rab1["rate"]."' class='form-control' required></div></div>
                                                    <div class='col-md-4'><div class='form-group'><label>Contract Type *</label><select class='form-control m-b ' name='type' required>
                                                        <option value='".$rab1["rate_type"]."'>".$rab1["rate_type"]."</option><option value='Hourly'>Hourly</option><option value='Fixed'>Fixed</option>
                                                    </select></div></div>
                                                    <div class='col-md-4'><div class='form-group'><label>Priority *</label><select class='form-control m-b ' name='priority' required>
                                                    ...
                                                    <div class='col-md-6'><div class='form-group'><label>Team Leader *</label><select class='form-control m-b' name='teamleaderid' required>
                                                        ...
                                                        if ($r7->num_rows > 0) { while($rs7 = $r7->fetch_assoc()) { echo"<option value='".$rs7["id"]."'>".$rs7["username"]." ".$rs7["username2"]."</option>"; } }
                                                    echo"</select></div></div>
                                                    <div class='col-md-6'><div class='form-group'><label>Support Co-ordinator *</label><select class='form-control m-b' name='leaderid' required>
                                                        ...
                                                        if ($r7->num_rows > 0) { while($rs7 = $r7->fetch_assoc()) { echo"<option value='".$rs7["id"]."'>".$rs7["username"]." ".$rs7["username2"]."</option>"; } }
                                                    echo"</select></div></div>
                                                    <div class='col-md-12'><div class='form-group'><label>Description/Note</label>
                                            ...
                                            <fieldset>
                                                <div class='row'>
                                                    <div class='col-lg-12'><br><br><center><input name='submit' type='submit' value='UPDATE' class='btn btn-xs' style='font-size:12pt;background-color:$topbar_color;color:$tbtc;padding-left:20px;padding-right:20px'><br></center></div>
                                                </div>
                                            </fieldset>";
                                        } }
                                    echo"</form>
            ...
            if(isset($_COOKIE["projectidx"])){
                            ...
                            <div class='row'>";
                                ...
                                if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                    ...
                                    echo"<div class='col-lg-4'>
                                            ...
                                            <center>
                                                ...
                                                <table width='100%'><tr>
                                                    <td style='padding:3px;width:50%' align=center valign=top>
                                                        ...
                                                        <span style='font-size:8pt;color:black'>Client/Participant</span><br>
                                                        <span style='font-size:10pt;color:black'>$clientname1 $clientname2</span>
                                                    </td>
                                                    <td style='padding:3px;width:50%' align=center valign=top>
                                                        ...
                                                        <span style='font-size:10pt;color:black'>$leadername1 $leadername2</span>
                                                    </td>
                                                </tr></table><hr>
                                        ...
                                        <center>
                                            <a href='index.php?smsbd=client-dashboard&projectid=".$rab1["id"]."&clientid=".$rab1["clientid"]."' class='btn' style='margin-top:-5px;background-color:$topbar_color;color:$tbtc'>Client Dashboard</a>
                                            <a href='index.php?smsbd=client-service-agreement&projectid=".$rab1["id"]."&clientid=".$rab1["clientid"]."' class='btn' style='margin-top:-5px;background-color:$topbar_color;color:$tbtc'>Service Agreement</a>
                                        </center>
                                ...
                                echo"<div class='col-md-8'>
                                    <div class='row'>
                                        <div class='col-md-12'><span style='font-size:13pt;'>DOCUMENT MANAGEMENT SYSTEM</span></div>
                                        ...
                                        <div class='col-md-12'>";
                                            ...
                                            if ($cat2->num_rows > 0) { while($cat3 = $cat2->fetch_assoc()) {
                                                ...
                                                $t=$cat3["id"];
                                                if($cat3["status"]==1){ 
                                                    echo"<div class='faq-item' style='background-color:#eee;padding:10px;'>
                                                        <div class='row'>
                                                            <div class='col-md-7'>
                                                                <a data-toggle='collapse' href='#".$cat3["id"]."' class='faq-question' style='font-size:10pt;margin-top:5px;color:black' onmouseover=\"$datatargetZ('".$cat3["id"]."', '$datatargetY')\"><i class='fa fa-book'></i>&nbsp;&nbsp;".$cat3["category"]."</a>
                                                            </div><div class='col-md-1' style='text-align:center'>
                                                                <a href='#' class='btn' data-toggle='modal' data-target='#$datatargetX' style='background-color:#cccccc;font-size:10pt;margin-top:0px;color:grey'><i class='fa fa-plus'></i></a>
                                                            </div><div class='col-md-1' style='text-align:center'>
                                                                <a href='#' class='btn' data-toggle='modal' data-target='#$datatargetXX' style='background-color:#cccccc;font-size:10pt;margin-top:0px;color:grey'><i class='fa fa-edit'></i></a>
                                                            </div><div class='col-md-1' style='text-align:center'>
                                                                <a href='updaterecord.php?susid=".$cat3["id"]."&tbl=project_category&status=0' target='dataprocessor' class='btn' style='background-color:#cccccc;font-size:10pt;color:grey'><i class='fa fa-times'></i></a>
                                                            </div><div class='col-md-1' style='text-align:center'>
                                                                <a href='#' class='btn' onclick=\"$datatargetZ('".$cat3["id"]."', '$datatargetY')\" style='background-color:#cccccc;font-size:10pt;color:grey'><i class='fa fa-refresh'></i></a>
                                                            </div><div class='col-md-1 style='text-align:center'>
                                                                <a data-toggle='collapse' href='#".$cat3["id"]."' class='faq-question' style='font-size:15pt;color:black' onmouseover=\"$datatargetZ('".$cat3["id"]."', '$datatargetY')\"><i class='fa fa-angle-down'></i></a>
                                                            </div>
                                                        </div>
                                                        <div class='row'><div class='col-lg-12'><div id='".$cat3["id"]."' class='panel-collapse collapse '><div class='faq-answer' style='padding:0px'>
                                                    ...
                                                    echo"<div class='faq-item' style='background-color:grey;padding:10px;'>
                                                        <div class='row'>
                                                            <div class='col-md-9'>
                                                                <a data-toggle='collapse' href='#' class='faq-question' style='font-size:10pt;margin-top:5px;color:black'><i class='fa fa-book'></i>&nbsp;&nbsp;".$cat3["category"]."</a>
                                                            </div><div class='col-md-3' style='text-align:center'>
                                                                <a href='updaterecord.php?susid=".$cat3["id"]."&tbl=project_category&status=1' target='dataprocessor' class='btn' style='background-color:#cccccc;font-size:10pt;color:grey'><i class='fa fa-play'></i></a>";
                                                            echo"</div>
                                                        </div>
                                                        <div class='row'><div class='col-lg-12'><div id='".$cat3["id"]."' class='panel-collapse collapse '><div class='faq-answer' style='padding:0px'>
                ...
                echo"<div class='tabs-container' style='background-color:white'>
                    <ul class='nav nav-tabs'>
                        <li><a class='nav-link active' data-toggle='tab' href='#tab-1'>Ongoing</a></li>
                        <li><a class='nav-link' data-toggle='tab' href='#tab-2'>Suspended</a></li>
                        <li><a class='nav-link' data-toggle='tab' href='#tab-3'>Completed</a></li>
                    </ul>
                    <div class='tab-content'>
                        <div id='tab-1' class='tab-pane active'>
                            <table style='width:98%;margin-top:15px' align=center><tr><td align=right style='padding-bottom:20px;'>
                                <button class='btn-primary btn btn-xs' data-toggle='modal' data-target='#createproject' >Create Project</button>
                                <button class='btn-info btn btn-xs' onclick=\"getDataProject('1000', 'projectdata')\">Reload</button>
                            </td></tr></table>
                            
                            <div class='row' style='padding-left:5px;padding-right:5px'>";
                                $ra1 = "select * from project where status='1' order by name asc";
                                $rb1 = $conn->query($ra1);
                                if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                    $sdate=date("d.m.Y",$rab1["start_date"]);
                                    $edate=date("d.m.Y",$rab1["end_date"]);
                                    ...
                                    <div class='contact-box center-version' style='padding:5px;background-color:#fff;min-height:400px'>
                                            <center>
                                                ...
                                                <table width='100%'><tr>
                                                    <td style='padding:3px;width:50%' align=center valign=top>
                                                        <img src='$teamleaderimage' style='border:1px solid #ccc;border-radius:50%;width:65px;height:65px' title=''><br>
                                                        <span style='font-size:8pt;color:black'>Team Leader</span><br>
                                                        <span style='font-size:10pt;color:black'>$teamleadername1 $teamleadername2</span>
                                                    </td>
                                                    <td style='padding:3px;width:50%' align=center valign=top>
                                                        <img src='$leaderimage' style='border:1px solid #ccc;border-radius:50%;width:65px;height:65px' title=''><br>
                                                        <span style='font-size:8pt;color:black'>Support Co-ordinator</span><br>
                                                ...
                                                echo"<td><button class='btn btn-xs' data-toggle='modal' data-target='#manageteam' style='border-radius:50%;width:35px;height:35px;margin-top:0px;background-color:$topbar_color;color:$tbtc' onclick=\"getTeamData('".$rab1["id"]."', 'TeamManager')\">+</button><br>&nbsp;</td></tr></table>
                                                <hr><div class='btn-group'>
                                                    <a href='index.php?smsbd=projectx&pid=".$rab1["id"]."' class='btn-white btn btn-xs' target='_top' style='margin-top:0px;color:$topbar_color'>Edit</a>
                                        ...
                                        <div class='contact-box-footer' style='background-color:$topbar_color;padding:10px;'><center><div class='m-t-xs btn-group'>
                        ...
                        <div id='tab-2' class='tab-pane'>
                            <div class='panel-body' style='padding-left:5px;padding-right:5px'>
                                <div class='table-responsive' id='suspendedprojects'></div>
                            </div>
                        </div>
                        
                        <div id='tab-3' class='tab-pane'>
                            <div class='panel-body' style='padding-left:5px;padding-right:5px'>
                                <div class='table-responsive' id='completedprojects'></div>
                            </div>
                        </div>
    ...
    echo"<div class='modal inmodal cardt' id='manageteam' tabindex='-1' role='dialog' aria-hidden='true'>
        <div class='modal-dialog'>
            ...
            /*
                <form class='m-t' role='form' method='post' action='dataprocessor.php' id='schedule-form' target='dataprocessor' enctype='multipart/form-data'>
        		    ...
        		    <div class='modal-body'>
                        <div class='row'>
        		            <div class='col-md-12'><div class='form-group'><label>Participant/Job *</label><select class='form-control m-b ' name='projectid' required>
                                <option value=''>Select Project/Perticipant</option>";
                            ...
                            <div class='col-md-2'><div class='form-group'>
                                ...
                                <input type='submit' class='btn btn-primary' value='Save' onmouseout=\"shiftdata('100000', 'datashiftX')\">
                            </div></div>
                        </div>
                    </div>
                </form>
            */ 
                echo"<div style='width:100%' id='TeamManager'></div>"; ?>
                <script type="text/javascript">
                    function getTeamData(projectid1,projectid2){
                        $.ajax({
                            url: 'projects-team.php?pid='+projectid1, 
                            success: function(html) {
    ...
    /*
    <div class='modal inmodal' id='' tabindex='-1' role='dialog' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content animated flipInY'>
                <div class='modal-header'>
                    <button type='button' class='close' data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button>
                    <h4 class='modal-title'>Allocate Team Member to Project</h4>
                </div>
                <form class='m-t' role='form' method='post' action='dataprocessor.php' id='image_upload_form' target='dataprocessor' enctype='multipart/form-data'>
				    <input type='hidden' name='processor' value='manageteam'>
                    <div class='modal-body'>
                        <div class='row'>
                            <div class='col-md-6'><div class='form-group'><label>Project Name *</label><select class='form-control m-b ' name='projectid' required>
                            ...
                            echo"</select></div></div>
                            <div class='col-md-6'><div class='form-group'><label>Allocation Date *</label><input name='sdate' type='date' value='' class='form-control' required></div></div>
                            <div class='col-md-6'><div class='form-group'><label>Support Worker *</label><select class='form-control m-b' name='employeeid' required>
                    ...
                    <div class='modal-footer'>
                        ...
                        <input type='submit' class='btn btn-primary recordadded' value='Allocate'>
                    </div>
                </form>
            </div>
        </div>
    ...
    */
    ...
    echo"<div class='modal inmodal' id='createproject' tabindex='-1' role='dialog' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content animated flipInY'>
                <div class='modal-header'>
                    <button type='button' class='close' data-dismiss='modal'><span aria-hidden='true'>&times;</span><span class='sr-only'>Close</span></button>
                ...
                <form class='m-t' role='form' method='post' action='dataprocessor03.php' id='image_upload_form' target='dataprocessor' enctype='multipart/form-data'>
				    <input type='hidden' name='processor' value='createproject'>
                    <div class='modal-body'>
                        <div class='row'>
                            <div class='col-md-12'><div class='form-group'><label>Project Name *</label><input name='name' type='text' value='' class='form-control' required></div></div>
                            <div class='col-md-6'><div class='form-group'><label>Client Name *</label><select class='form-control m-b ' name='clientid' required>
                            ...
                            echo"</select></div></div>";
                            /*
                            <div class='col-md-6'><div class='form-group'><label>Start Date *</label><input name='sdate' type='date' value='' class='form-control' required></div></div>
                            <div class='col-md-6'><div class='form-group'><label>End Date *</label><input name='edate' type='date' value='' class='form-control' required></div></div>
                            */
                            echo"<div class='col-md-5'><div class='form-group'><label>Clock-In Time *</label><input name='stime' type='time' value='08:00' class='form-control' required></div></div>
                            <div class='col-md-5'><div class='form-group'><label>Clock-Out Time *</label><input name='etime' type='time' value='17:00' class='form-control' required></div></div>
                            <div class='col-md-2'><div class='form-group'><label>Color</label><input name='pcolor' type='color' value='#CCCCCC' class='form-control' required></div></div>
                            
                            <div class='col-md-6'><div class='form-group'><label>Contact Value *</label><input name='rate' type='text' value='' class='form-control' required></div></div>
                            <div class='col-md-6'><div class='form-group'><label>Contract Type *</label><select class='form-control m-b ' name='type' required>
                                <option value=''>Select Contract Type</option><option value='Hourly'>Hourly</option><option value='Fixed'>Fixed</option>
                            </select></div></div>
                            <div class='col-md-6'><div class='form-group'><label>Priority *</label><select class='form-control m-b ' name='priority' required>
                            ...
                            <div class='col-md-6'><div class='form-group'><label>Support Co-ordinator *</label><select class='form-control m-b' name='leaderid' required>
                                <option value=''>Select Support Co-ordinator</option>";
                                $s7 = "select * from uerp_user where mtype='ADMIN' and status='1' order by id asc";
                                $r7 = $conn->query($s7);
                                if ($r7->num_rows > 0) { while($rs7 = $r7->fetch_assoc()) { echo"<option value='".$rs7["id"]."'>".$rs7["username"]." ".$rs7["username2"]."</option>"; } }
                            echo"</select></div></div>
