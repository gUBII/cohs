<?php
    $sheba="sales_voucher";
    $cid=5;
    $title="Add New Sales Voucher";
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Sales Voucher</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('sales_process.php?cid=$cid&sheba=$sheba&ctitle=$title', 'offcanvasTop2'); shiftdataV2('purchase_multi_data.php?cid=5&sheba=purchase_voucher', 'datatableXX')\">
