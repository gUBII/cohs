            ...
            if(isset($_GET["mid"]) && $_GET["mid"]!=0){
                    ...
                    if ($r1x->num_rows > 0) { while($rs1x = $r1x->fetch_assoc()) {
                        ...
                        <div class='row'>
                            ...
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Paid To</label>
                            ...
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Paid Amount</label><input class='form-control' type='number' name='dr_amt' placeholder='Type here' min-value='1' value='".$rs1x["dr_amt"]."' ></div>
                            ...
                            <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                                ...
                                <button class='btn btn-primary' type='submit' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('payment_voucher_data.php?cid=6&sheba=payment_voucher', 'datatableX')\">Update</button>
                            </div>
                        </div>";
                    } }
                    ...
                    <div class='row'>
                        ...
                        <div class='col-4' style='margin-top:15px'><label class='form-label'>Paid Amount</label><input class='form-control' type='number' name='dr_amt' placeholder='Type here' min-value='1' value='0' ></div>
                        ...
                        <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                            <button type='button' class='btn btn-outline-primary' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('payment_voucher_data.php?cid=6&sheba=payment_voucher', 'datatableX')\">Close</button>&nbsp;
                            ...
                            <button class='btn btn-primary' type='submit' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('payment_voucher_data.php?cid=6&sheba=payment_voucher', 'datatableX')\">Save</button>
                        </div>
                    </div>";
