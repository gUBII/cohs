                ...
                echo"<div class='data-table-rows slim' id='sample'>
                    <div class='data-table-responsive-wrapper'>
                        ...
                        <tr>
                            ...
                            <th onclick='sortTable(0)'>Invoice ID <i data-acorn-icon='sort' style='height:12px'></i></th>
                            <th onclick='sortTable(6)'>Card ID <i data-acorn-icon='sort' style='height:12px'></i></th>
