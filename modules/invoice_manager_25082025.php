            ...
            echo"<form name='xcarbon' method='post' action='invoiceprocessor.php' target='invoicedataxxxx' enctype='multipart/form-data'>";
                    ...
                    if ($r->num_rows > 0) { while($rs = $r->fetch_assoc()) {
                        ...
                        echo"<div class='row' style='margin-left:0px;width:100%;padding:5px;'>";
                            ...
                            echo"<div class='col-lg-12'><h4>Add Item for INV# $invno2<br></h5></center><hr></div>
                ...
                if($_GET["cid"]==1001){
                    ...
                    <div class='row'>
                        ...
                        <div class='col-lg-12' style='padding:10px'><div style='width:100%;text-align:left'>
                            ...
                            echo"<select class='form-control' name='cname' required style='width:100%' id='clientProject' onchange='updateInvoice()'>";
                        ...
                        <div class='col-md-6' style='padding:10px'><div style='width:100%;text-align:left'>
                            <label>Manual Invoice Number</label><br><input type='text' class='form-control' id='invoice_no2' name='invoice_no2' value='$invoice_no2x' required style='width:100%'>
                        </div></div>
                        <div class='col-md-6' style='padding:10px'><div style='width:100%;text-align:left'>
                        ...
                        <div class='col-md-12' style='padding:10px'><div style='width:100%;text-align:left'>
                            <b>Select Data Sync Date Range</b>
                        </div></div>
                        <div class='col-md-6' style='padding:10px'><div style='width:100%;text-align:left'>
