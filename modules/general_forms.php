...
echo"<div class='row'>
    <div class='col-8 col-md-5' style='padding-bottom:10px'>
        ...
        <h1 class='mb-0 pb-0 display-4' id='title'>General Forms</h1>
...
if($mtype!="CLIENT"){
    if(!isset($_GET["formid"])){
            ...
            <fieldset>
                <div class='row'>
                    ...
                    <div class='col-4 col-lg-2'><div class='form-group'><label>&nbsp; </label><Br>
                        <input type='submit' class='btn btn-icon btn-icon-start btn-outline-primary' data-style='expand-right' value='Upload'>
                    </div></div>
                </div>
            </fieldset>
        ...
        $sessionid = rand(1234567890,9876543210);
        echo"<form class='m-t' role='form' method='post' action='dataprocessor03.php' id='image_upload_form' target='dataprocessor' enctype='multipart/form-data'>
            <input type='hidden' name='formid' value='".$_GET["formid"]."'>
                    ...
                    echo"<fieldset>
                        <div class='row'>
                            ...
                            <div class='col-lg-1'><br><div class='form-group'><label>&nbsp; </label><Br>
                                <input type='submit' class='btn btn-icon btn-icon-start btn-outline-primary' data-style='expand-right' value='Update'>
                            </div></div>
                            <div class='col-lg-1'><br><div class='form-group'><label>&nbsp; </label><Br>
                                <a href='index.php?url=general_forms.php'><input type='button' class='btn btn-icon btn-icon-start btn-outline-secondary' data-style='expand-right' value='New'></a>
                            </div></div>
                        </div>
                    </fieldset><br><br>";
                } }
...
if($mtype!="CLIENT"){
    echo"<div class='table-responsive'>
        <table class='table table-striped table-bordered table-hover dataTables-example' >
            ...
            <tbody>";
                if($designationy==17) $ra1 = "select * from general_forms where clientid='$userid' and status='1' order by id desc";
                else if($designationy==13) $ra1 = "select * from general_forms where status='1' order by id desc";
                else $ra1 = "select * from general_forms where employeeid='$userid' and status='1' order by id desc";
                $rb1 = $conn->query($ra1);
                if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                    ...
                    echo"<tr class='gradeX'>
                        ...
                        <td align=center><a href='index.php?url=general_forms.php&formid=".$rab1["id"]."' style='color:lightgreen'><i class='fa fa-edit'></i></a></td>
                        <td align=center><a href='deleterecord.php?formid=".$rab1["id"]."&tbl=general_forms' style='color:lightred' target='dataprocessor'><i class='fa fa-trash'></i></a></td>
                    </tr>";
