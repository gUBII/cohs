    ...
    echo"<div class='container'>
        <div>
            <div class='hide-area page-title-container'>
                <div class='row'>
                    <div class='col-12 col-sm-6'>
                        <h1 class='mb-0 pb-0 display-4' id='title'>LEGAL Dashboard</h1>
                        <nav class='breadcrumb-container d-inline-block' aria-label='breadcrumb'>
                            <ul class='breadcrumb pt-0'>
                                <li class='breadcrumb-item'><a href='index.php'>Home</a></li>
                                <li class='breadcrumb-item'><a href='index.php?url=legal_dashboard.php&id=55'>LEGAL</a></li>                            
                                <li class='breadcrumb-item'><a href='index.php?url=legal_dashboard.php&id=55'>Dashboard</a></li>                            
                            </ul>
                        </nav>
                    </div>
            ...
            <div class='page-title-container'>
                <div class='row'>
                    <div class='col-12 col-sm-6'>
                        <span style='font-size:12pt'>Welcome back to Nexis 365, $username $username2</span><br>
                        <span style='font0-size:15pt'>Quickly access your Cases, Documents, Notifications, Accounts and Workspaces</span>
                    </div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Clients' data-intro='Showing total clients. click see detail.' data-step='1'>";
                        $c1x=0;
                        $c2x=0;
                        ...
                        if ($aa1->num_rows > 0) { while($a1 = $aa1->fetch_assoc()) {
                            $c2x=($c2x+1);
                            if($a1["status"]==1) $c1x=($c1x+1);
                        } }
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Clients</span></a></td><td align='right'><span>$c1x/$c2x</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=clients.php'>View Clients</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Cases' data-intro='Showing total cases. click see detail.' data-step='1'>";
                        $a1x=0;
                        $a2x=0;
                        $aaa1 = "select * from project order by id asc";
                        $aa1 = $conn->query($aaa1);
                        if ($aa1->num_rows > 0) { while($a1 = $aa1->fetch_assoc()) {
                            $a2x=($a2x+1);
                            if($a1["status"]==1) $a1x=($a1x+1);
                        } }
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Cases</span></a></td><td align='right'><span>$a1x/$a2x</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=projects.php'>View Cases</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Tasks' data-intro='Showing total tasks. click see detail.' data-step='1'>";
                        $t1x=0;
                        $t2x=0;
                        $aaa1 = "SELECT * FROM tasks ORDER BY id asc";
                        $aa1 = $conn->query($aaa1);
                        if ($aa1->num_rows > 0) { while($a1 = $aa1->fetch_assoc()) {
                            $t2x=($t2x+1);
                            if($a1["activity"]==0) $t1x=($t1x+1);
                        } }
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Tasks</span></a></td><td align='right'><span>$t1x/$t2x</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=task_manager.php'>View Tasks</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Employees' data-intro='Showing total employees. click see detail.' data-step='1'>";
                        $e1x=0;
                        $e2x=0;
                        $aaa1 = "select * from uerp_user where mtype='USER' order by id asc";
                        $aa1 = $conn->query($aaa1);
                        if ($aa1->num_rows > 0) { while($a1 = $aa1->fetch_assoc()) {
                            $e2x=($e2x+1);
                            if($a1["status"]==1) $e1x=($e1x+1);
                        } }
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Employees</span></a></td><td align='right'><span>$e1x/$e2x</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=employees.php'>View Employees</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Today`s Schedule' data-intro='Showing all rostered schedules for today and click on this link to see all schedules.' data-step='1'>";
                        $tst=0;
                        $tss=0;
                        $tday=date("d", time());
                        $tmonth=date("m", time());
                        ...
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Attendance</span></a></td><td align='right'><span>$tss - $tst</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=daily_schedules.php'>View Time Sheet</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Pending Invoices' data-intro='Total Pending Invoices, visit this link for notifying clients and get paid.' data-step='1'>";
                        $pi=0;
                        $po=0;
                        ...
                        $pi1 = "select * from receipt_voucher where invoice_no<>'0' group by invoice_no";
                        $pp1 = $conn->query($pi1);
                        if ($pp1->num_rows > 0) { while($ppi1 = $pp1->fetch_assoc()) {  $po=($po+1); } }
                        echo"<div class='card-body'>
                            <div class='heading mb-0 d-flex justify-content-between lh-1-25 mb-3'>
                                <table style='width:100%'><tr><td align='left'><a href='#'><span>Pending Invoices</span></a></td><td align='right'><span>$pi/$po</span></td></tr></table>
                            </div><hr>
                            <a class='btn btn-outline-info btn-sm' style='width:100%' href='index.php?url=unpaid_invoices.php'>View Invoices</a>
                        </div>
                    </div>
                    <br><br>
                </div>
                ...
                <div class='col-6 col-md-3'>
                    <div class='card hover-border-primary' data-title='Upcoming Case Date' data-intro='Upcoming Case Date.' data-step='1'>";
                        $pi=0;
                        $po=0;
                        $dtov=date('Y-m-d H:i:s', strtotime($_COOKIE["shiftingid3"] . ' +1 day'));
                        $dtov=strtotime($dtov);
                                                                                
                        $pi1 = "select * from project where invoice_no<>'0' and paid='1' group by invoice_no";
                        $pp1 = $conn->query($pi1);
                        if ($pp1->num_rows > 0) { while($ppi1 = $pp1->fetch_assoc()) {  $pi=($pi+1); } }
                        $pi1 = "select * from receipt_voucher where invoice_no<>'0' group by invoice_no";
                        $pp1 = $conn->query($pi1);
