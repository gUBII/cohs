<?php
    ...
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Monthly Analytics (Clients)</h1>
    ...
    <div class='data-table-rows slim' id='sample'><br><br><br>"; ?>
        ...
        <script type="text/javascript">
            ...
            function drawVisualization() {
                ...
                ['20024/06',  135,      1120,        599,             1268,          288,      682],
                ['2024/07',  157,      1167,        587,             807,           397,      623],
                ['2024/08',  139,      1110,        615,             968,           215,      609.4],
                ['2024/09',  136,      691,         629,             1026,          366,      569.6]
                ]);

                var options = {
                    title : 'Monthly Client Campaign and leads report',
                    vAxis: {title: 'Campaigns, Opportunity & Leads'},
                    hAxis: {title: 'Month'},
                    seriesType: 'bars',
                    series: {5: {type: 'line'}}
                };
        ...
        <div style='border-radius:10px;padding:20px;background-color:white'>
