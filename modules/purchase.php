<?php
    $sheba="purchase_voucher";
    $cid=5;
    $title="Add New Purchase Voucher";
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Purchase Voucher</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('purchase_process.php?cid=$cid&sheba=$sheba&ctitle=$title', 'offcanvasTop2'); shiftdataV2('purchase_multi_data.php?cid=5&sheba=purchase_voucher', 'datatableXX')\">
                ...
                <div class='d-inline-block'>
                    <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                        ...
                        <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                            ...
                            <button class='dropdown-item' onclick='sortTable1()'type='button'>Purchase No.</button>
                            <button class='dropdown-item' onclick='sortTable2()'type='button'>Date</button>
                            <button class='dropdown-item' onclick='sortTable3()'type='button'>Invoice No.</button>
                            <button class='dropdown-item' onclick='sortTable4()'type='button'>Vendor Name</button>
                            <button class='dropdown-item' onclick='sortTable5()'type='button'>Project</button>
                            <button class='dropdown-item' onclick='sortTable6()'type='button'>Quantity</button>
                            <button class='dropdown-item' onclick='sortTable7()'type='button'>Amount</button>     
                            <button class='dropdown-item' onclick='sortTable8()'type='button'>Total Amount</button>     
                    ...
                    <div class='dropdown-as-select d-inline-block datatable-length' data-datatable='#datatableStripe'>
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='SortForm'>
                            ...
                            <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=10000000; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">All Data</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=5; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">5 Items</a>
                                <a class='dropdown-item active' href='#' onmouseover=\"document.SortForm.sortvalue.value=10; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">10 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=25; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">25 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=50; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">50 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=100; document.SortForm.submit()\" onmouseup=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">100 Items</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class='data-table-rows slim' id='sample'>
        <body onload=\"shiftdataV2('purchase_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">
        <div class='data-table-responsive-wrapper'>
            <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                <tr>
                    <th onclick='sortTable(0)'>Id <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Purchase No. <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Date <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Invoice No. <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Vendor Name <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Project <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Total QTY <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Group Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Total Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Status <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Action <i data-acorn-icon='sort' style='height:12px'></i></th>                     
                </tr>
