<?php
    ...
    echo"<div class='card-body' style='width:100%;'>";
        if($viewmode=="LIST"){
            if($_GET["utype"]=="CAMPAIGN"){
                $s1 = "select * from campaigns order by campaign_name asc";            
                $r1 = $conn->query($s1);
                if ($r1->num_rows > 0) { while($rs1 = $r1->fetch_assoc()) {
                    $lastid=$rs1["id"];
                    $rand=rand(100,999);
                    $teamleader="";
                    $d1 = "select * from uerp_user where id='".$rs1["employeeid"]."' order by id asc limit 1";
                    $d2 = $conn->query($d1);
                    if ($d2->num_rows > 0) { while($d3 = $d2->fetch_assoc()) { $teamleader="".$d3["username"]."".$d3["username2"]."" ; } }
                    $clientname="";
                    $d1 = "select * from uerp_user where id='".$rs1["clientid"]."' order by id asc limit 1";
                    $d2 = $conn->query($d1);
                    if ($d2->num_rows > 0) { while($d3 = $d2->fetch_assoc()) { $clientname="".$d3["username"]."".$d3["username2"]."" ; } }
                    
                    $uid=$rs1["id"];
                    $status=$rs1["status"];

                    $sdate=date("d-m-Y", $rs1["start_date"]);
                    $edate=date("d-m-Y", $rs1["end_date"]);
                        ...
                        <div class='card-body mb-n2 border-last-none h-100' style='width:100%;padding-top:10px;padding-bottom:20px;padding-left:20px;padding-right:20px'>
                            <div class='row' style='width:100%'>
                                <div class='col-4 col-md-2' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Campaign Name</div><div class='text-small text-muted'>".$rs1["campaign_name"]."</div>                                
                                </div>
                                <div class='col-4 col-md-2' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Start Date</div><div class='text-small text-muted'>".$rs1["start_date"]."</div>                                
                                </div>
                                <div class='col-4 col-md-2' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Expected Close</div><div class='text-small text-muted'>".$rs1["end_date"]."</div>                                
                                </div>
                                <div class='col-4 col-md-2' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Targeted Client Name</div><div class='text-small text-muted'>$clientname</div>                                
                                </div>
                                <div class='col-4 col-md-2' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Team Leader</div><div class='text-small text-muted'>$teamleader</div>                                
                                </div>
                                ...
                                <div class='col-4 col-md-1' style='text-align:center;padding-bottom:5px;padding-top:10px'>
                                    <div class='d-inline-block datatable-export' data-datatable='#datatableRows' style='background-color:grey;padding:5px;width:30px;text-align:center;border-radius:5px'>
                                        ...
                                        <div class='dropdown-menu shadow dropdown-menu-end' onmouseup=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">
                                            ...
                                            if($status=="ON") echo"<a class='dropdown-item' href='./system/dataprocessor_1.php?processor=StatusSuspend&status=10&tid=$sheba&pid=$uid' target='dataprocessor' onblur=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">Suspend</a>";
                                            else echo"<a class='dropdown-item' href='./system/dataprocessor_1.php?processor=StatusSuspend&status=1&tid=$sheba&pid=$uid' target='dataprocessor' onblur=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">Activate</a>";
                                            echo"<a class='dropdown-item' style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop' aria-controls='offcanvasTop' onclick=\"shiftdataV2('../system/delete_records.php?processor=users_table&cid=$cid&delid=$uid&tbl=$sheba&utype=$utype', 'offcanvasTop')\">Delete</a>";                                
                                        echo"</div>
                                    </div>
                                </div>                        
                            </div>
            ...
            if($_GET["utype"]=="OPPORTUNITY"){
                $s1 = "select * from opportunities order by opportunity_name asc";            
                $r1 = $conn->query($s1);
                if ($r1->num_rows > 0) { while($rs1 = $r1->fetch_assoc()) {
                    $lastid=$rs1["id"];
                    $rand=rand(100,999);
                    ...
                    if ($d2->num_rows > 0) { while($d3 = $d2->fetch_assoc()) { $teamleader="".$d3["username"]."".$d3["username2"]."" ; } }
                    $campaignname="";
                    $d1 = "select * from campaigns where id='".$rs1["campaignid"]."' order by id asc limit 1";
                    $d2 = $conn->query($d1);
                    if ($d2->num_rows > 0) { while($d3 = $d2->fetch_assoc()) { $campaignname="".$d3["campaign_name"]."" ; } }
                        ...
                        <div class='card-body mb-n2 border-last-none h-100' style='width:100%;padding-top:10px;padding-bottom:20px;padding-left:20px;padding-right:20px'>
                            <div class='row' style='width:100%'>
                                <div class='col-4 col-md-3' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Opportunity Name</div><div class='text-small text-muted'>".$rs1["opportunity_name"]."</div>                                
                                </div>                                    
                                <div class='col-4 col-md-3' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Campaign Name</div><div class='text-small text-muted'>$campaignname</div>                                
                                </div>
                                <div class='col-4 col-md-3' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Date</div><div class='text-small text-muted'>".$rs1["start_date"]."</div>                                
                                </div>
                                ...
                                <div class='col-4 col-md-3' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Note</div><div class='text-small text-muted'>".$rs1["plan"]."</div>                                
                                </div>
                                <div class='col-4 col-md-3' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Opportunity</div><div class='text-small text-muted'>".$rs1["opportunity"]."</div>                                
                                </div>
                                <div class='col-4 col-md-6' style='text-align:left;padding-bottom:5px;padding-top:10px'>
                                    <div>Possibility</div><div class='text-small text-muted'>".$rs1["possibility"]."</div>                                
                                </div>
            ...
            if($_GET["utype"]=="LEADS"){
                echo"<div class='row' style='width:100%'>";
                    $s1 = "select * from leads order by lead_name asc";
                    $r1 = $conn->query($s1);
                    if ($r1->num_rows > 0) { while($rs1 = $r1->fetch_assoc()) {
                        $lastid=$rs1["id"];
                        $rand=rand(100,999);
                        ...
                        echo"<div class='col-12 col-md-3' style='text-align:center;padding-bottom:5px;padding-top:4px'>
                            <div class='card mb-3'>
                                <div class='card-body mb-n5' style='padding:10px'>
                                    <div class='d-flex align-items-center flex-column mb-5'>
                                        <div class='mb-5 d-flex align-items-center flex-column'>
                                            <div class='sw-13 position-relative mb-3'>
                                                <img src='./assets/noimage.png' class='img-fluid rounded-xl' alt='' />
                                            </div>
                                            <div class='h5 mb-0'>Jenny Enderson</div>
                                            <div class='text-muted'>
                                                <i data-acorn-icon='pin' class='me-1'></i>
                                                <span class='align-middle'>Full Address Goes Here...., Zipcode-1233, Australia. </span>
                                            </div>
                                        </div>
                                        <div class='d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100'>";
                                            ...
                                            echo"<a class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button'style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('users_manager.php?cid=1000&sheba=$sheba&mid=$uid&ctitle=Profile&utype=$utype', 'offcanvasTop2')\"><span>Emails</span></a>
                                            <div class='d-inline-block datatable-export' data-datatable='#datatableRows' style='background-color:grey;padding:5px;width:30px;text-align:center;border-radius:5px'>
                                                <button class='btn p-0' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'><i class='fa-solid fa-bars'></i></button>
                                                <div class='dropdown-menu shadow dropdown-menu-end' onmouseup=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">
                                                    <a class='dropdown-item' style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('users_manager.php?cid=$cid&sheba=$sheba&mid=$uid&ctitle=$title&utype=$utype', 'offcanvasTop2')\">Edit</a>";
                                    ...
                                    <div class='mb-5'>";
                                            ...
                                            echo"<div class='row g-0 align-items-center mb-2'>
                                                ...
                                                <div class='col ps-3'><div class='row g-0'>
                                                    <div class='col' style='text-align:left'>Lead Name:</div><div class='col-auto' style='text-align:right'>".$rs1["lead_name"]."</div>
                                                </div></div>
                                            </div>";
                                            echo"<div class='row g-0 align-items-center mb-2'>
                                                ...
                                                <div class='col ps-3'><div class='row g-0'>
                                                    <div class='col' style='text-align:left'>Date:</div>
                                                    <div class='col-auto' style='text-align:right'>".$rs1["date"]."</div>
                                                </div></div>
                                            </div>";
                                            echo"<div class='row g-0 align-items-center mb-2'>
                                                <div class='col-auto'><div class='border border-primary sw-4 sh-4 rounded-xl d-flex justify-content-center align-items-center'><i class='fa-solid fa-phone'></i></div></div>
                                                <div class='col ps-3'><div class='row g-0'>
                                                    <div class='col' style='text-align:left'>Speech Note:</div>
                                                    <div class='col-auto' style='text-align:right'>".$rs1["speech_note"]."</div>
                                                </div></div>
                                            </div>";
                                            echo"<div class='row g-0 align-items-center mb-2'>
                                                <div class='col-auto'><div class='border border-primary sw-4 sh-4 rounded-xl d-flex justify-content-center align-items-center'><i class='fa-solid fa-phone'></i></div></div>
                                                <div class='col ps-3'><div class='row g-0'>
                                                    <div class='col' style='text-align:left'>Additional Note:</div>
                                                    <div class='col-auto' style='text-align:right'>".$rs1["note"]."</div>
                                                </div></div>
                                            </div>";
                                            echo"<div class='row g-0 align-items-center mb-2'>
            ...
            echo"<div class='row' style='width:100%'>";
                if($utype=="EMPLOYEE") $s1 = "select * from uerp_user where mtype='USER' OR mtype='$utype' OR mtype='ADMIN' order by username asc";
                else $s1 = "select * from uerp_user where mtype='$utype' order by username asc";
                $r1 = $conn->query($s1);
                if ($r1->num_rows > 0) { while($rs1 = $r1->fetch_assoc()) {
                    $lastid=$rs1["id"];
                    $rand=rand(100,999);
                            ...
                            <div class='card-body mb-n5' style='padding:10px'>
                                <div class='d-flex align-items-center flex-column mb-5'>
                                    ...
                                    <div class='d-flex flex-row justify-content-between w-100 w-sm-50 w-xl-100'>";
                                        ...
                                        echo"<a class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button'style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('users_manager.php?cid=1000&sheba=$sheba&mid=$uid&ctitle=Profile&utype=$utype', 'offcanvasTop2')\"><i class='fa-solid fa-user'></i>&nbsp;&nbsp;<span>Profile</span></a>
                                        <div class='d-inline-block datatable-export' data-datatable='#datatableRows' style='background-color:grey;padding:5px;width:30px;text-align:center;border-radius:5px'>
                                            <button class='btn p-0' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'><i class='fa-solid fa-bars'></i></button>
                                            <div class='dropdown-menu shadow dropdown-menu-end' onmouseup=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">
                                                <a class='dropdown-item' style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('users_manager.php?cid=$cid&sheba=$sheba&mid=$uid&ctitle=$title&utype=$utype', 'offcanvasTop2')\">Edit</a>";
