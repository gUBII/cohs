<?php
        ...
        echo"<div class='row'>
            ...
            <div class='col-4 col-md-7 d-flex align-items-start justify-content-end'>            
                <a href='index.php?url=boc-reports.php'>
                ...
                <fieldset>
                    ...
                    <div class='row'>
                        <div class='col-lg-3'>
                            ...
                            <div class='form-group' style='margin-bottom:25px'>
                                <label>Email Address *</label><input name='eod_employee_email' type='text' value='$unbox' class='form-control ' readonly>
                            </div>
                        </div>
                        <div class='col-lg-3'>";
                            $designation=6;
                            if($designation=="6"){
                                echo"<div class='form-group' style='margin-bottom:25px'>
                                    <label>Employee Name *</label><select class='form-control m-b ' name='eod_employee_name'>
                                        ...
                                        $s7 = "select * from uerp_user where mtype='EMPLOYEE' order by id asc";
                                        $r7 = $conn->query($s7);
