<?php
    ...
    $utype="PROJECT REPORT AI";
    
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            
            <h1 class='mb-0 pb-0 display-4' id='title'>Project Report Generator AI Bot</h1>
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <div class='data-table-responsive-wrapper'id=''>";
            echo"<iframe src='https://bots.easy-peasy.ai/bot/ae4fed13-28ec-4c7d-97db-9a572031aeed?mode=iframe' width='100%' height='600' />";
        echo"</div>
