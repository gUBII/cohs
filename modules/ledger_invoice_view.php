        ...
        if ($r->num_rows > 0) { while($rs = $r->fetch_assoc()) {
            ...
            if($idstatus==1){
                echo"<div class='panel-body' style='background-color:white;padding:20px'>
                    <table style='width:100%;border-color:#FFFFFF;padding:10px'>
                        <tr style='background-color:#FFFFFF'>
                            ...
                            <td style='width:25%' align=right><img src='$logo' style='width:100px'><br></td>
                        ...
                        <tr><td colspan=10>
                            <table class='table stripe table-hover' style='width:100%;padding:10px;background-color:white'>
                                ...
                                <tbody>";
                                    ...
                                    if($_GET["viewer"]==10) $r1 = "select * from receipt_voucher where invoice_no2='".$rs["invoice_no2"]."' and ledger_id='".$rs["ledger_id"]."' and paid='10' order by receipt_date asc";
                                    else $r1 = "select * from receipt_voucher where invoice_no2='".$rs["invoice_no2"]."' and ledger_id='".$rs["ledger_id"]."' and paid='1' order by receipt_date asc";
                                    $r1x = $conn->query($r1);
                    ...
                    <center><table>
                        ...
                        <tr><td align=center style='width:33%'>
                            <form method='post' action='modules/ledger_invoice_print.php' target='dataprocessor' enctype='multipart/form-data'>
                            ...
                            <form method='post' action='modules/ledger_invoice_csv.php' target='dataprocessor' enctype='multipart/form-data'>
                                <input type='hidden' name='invoiceid' value='".$rs["invoice_no2"]."'>
                                <input type='hidden' name='ledgerid' value='".$rs["ledger_id"]."'>
                                <input type='submit' class='btn btn-warning' style='margin-top:0px;color:$topbar_color' value='Download CSV'>
                            </form>";
                            /* <a href='' onclick='' target='dataprocessor'>
                                <input type='button' class='btn btn-success' style='margin-top:0px;color:white' value='Payment Received'>
                            </a> */
                        echo"</td><td align=center style='width:33%'>
                            <a href='#' onclick=\"shiftdataV2('ledger_invoice_view.php?selection=INCOME&pid=".$rs["id"]."-2', 'offcanvasTop2')\">
                                <input type='button' class='btn btn-info' style='margin-top:0px;color:$topbar_color' value='Edit Invoice'>
                            </a>
                        </td></tr>
                        
                        <tr><td align=center colspan=5><hr><br>
                            <form method='POST' action='email_invoice.php' target='dataprocessor' enctype='multipart/form-data'>
                                <input type='hidden' name='iid' value='".$rs["invoice_no2"]."'>
                                <input type='hidden' name='lid' value='".$rs["ledger_id"]."'>
                                <input type='hidden' name='randomid' value='$randomid'>
                                <input type='hidden' name='pid' value='<b>$companynamex</b><br>ABN : $abn_number<br>Address: $addressx, $cityx, $statex-$postalcodex, $countryx.<br>Phone: $phonex<br>Email: $emailx'>
                                <table><tr>
                                    <td style='color:black'>Name: </td><td><input type='text' name='sname' value='' class='form-control' required></td>
                                    <td style='color:black'>Email: </td><td><input type='email' name='semail' value='' class='form-control' required></td>
                                    <td style='color:black'><input type='submit' class='btn btn-warning form-control' style='margin-top:0px;color:$topbar_color' value='Send Email'></td>
                                </tr></table>
                            </form>
                        </td></tr>
                ...
                echo"<div class='row' style='margin-left:0px;width:100%;padding:5px;'>";
                    ...
                    echo"<form class='m-t' id='InvoiceEditForm' name='xcarbon1' role='form2' method='post' action='accountsprocessor.php' id='schedule-form' target='invoicedatax' enctype='multipart/form-data'>    
                        <div class='row' style='margin-left:0px;width:100%;padding:0px;'>
                            <div class='col-lg-2'>Receipt Number<br><input type='text' class='form-control' name='receipt_no' value='$invno' readonly></div>
                            <div class='col-lg-2'>Invoice Number<br><input type='text' class='form-control' name='invoice_no' value='$invno2' readonly></div>
                            <div class='col-lg-2'>Schedule Date<br><input type='date' class='form-control' name='receipt_date' value='$invdate1'></div>
                            <div class='col-lg-2'>Item Number<br>
                            ...
                            echo"<div class='col-lg-1' style='margin-top:25px'>
                                ...
                                <input type='hidden' class='form-control' name='invoice_no2' value='$invno2'>
                                ...
                                <input type='hidden' name='receipt_date' value='$invdate'>
                                <input type='hidden' name='date_from' value='$invdate1'>
                                <input type='hidden' name='date_to' value='$invdate2'>
                ...
                <div style='width:100%;padding:0px'>
                    <iframe name='invoicedatax' src='modules/ledger_forms_addon_edit.php?rid=$participantid&lid=$lid&sid=$invno2&pid=$invoiceid' scrolling='yes' style='border: 0px dashed #000000' border='0' frameborder='0' width='100%' height='440'>BROWSER NOT SUPPORTED</iframe>
                    <center><br>";
                    // <a href='#' onclick=\"getDataXYZ('$pid-1', 'datatargetZ')\" class='btn btn-danger' style='height:30px;width:200px;'>Close</a><br><br></center>
                echo"</div>";
            }
        } }
    }
