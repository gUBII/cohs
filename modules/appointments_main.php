        ...
        <div class='page-title-container'>
            ...
            echo"<div id='calendar-container'>
                ...
                if(isset($_GET["prjsrc"])){
                    ...
                    <a href='index.php?url=schedule_jobs_updated.php&viewstatus=".$_GET["viewstatus"]."&prjsrc=".$_GET["prjsrc"]."&accepted=$accepteds' class='btn btn-outline-info btn-sm' style='margin-right:5px' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Allocated Shifts'>Weekly Planner</a>
                ...
                <div class='modal fade' id='eventModal' tabindex='-1' role='dialog' aria-labelledby='formTitle' aria-hidden='true'>
                    <div class='modal-dialog' role='document'>
                        ...
                        <form id='edit-event-form'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='verticallyCenteredLabel'>Shift Manager x</h5>
                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                </div>";
