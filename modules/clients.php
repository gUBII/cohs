<?php
    ...
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            ...
            <h1 class='mb-0 pb-0 display-4' id='title'>Client/Participants Account</h1>
                ...
                <div class='d-inline-block'>
                    ...
                    <table><tr><td nowrap>
                        ...
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='ViewModeForm'>
                            ...
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='LIST'\" onclick=\"document.ViewModeForm.viewmode.value='LIST'; document.ViewModeForm.submit()\" onblur=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=$status&mtype=$mtype', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='list'></i></a>
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='CARD'\" onclick=\"document.ViewModeForm.viewmode.value='CARD'; document.ViewModeForm.submit()\" onblur=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=$status&mtype=$mtype', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='grid-3'></i></a>                        
        ...
        <div class='col-12 col-md-7 d-flex align-items-start'>";
            if($designationy==13){
                echo"<button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('clients_process.php?cid=$cid&sheba=$sheba&ctitle=$title&utype=$utype&status=$status&mtype=$mtype', 'offcanvasTop2')\">
                    <i data-acorn-icon='plus'></i>&nbsp;&nbsp;<span>$title</span>
                </button>&nbsp;&nbsp;";
            }
            echo"<button class='btn btn-outline-success btn-icon btn-icon-start w-md-auto btn-sm' type='button' onclick=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=1&mtype=CLIENT', 'datatableX')\">
                <i data-acorn-icon='user'></i>&nbsp;&nbsp;<span>Active</span>
            </button>&nbsp;&nbsp;
            <button class='btn btn-outline-danger btn-icon btn-icon-start w-md-auto btn-sm' type='button' onclick=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=10&mtype=$mtype', 'datatableX')\">
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('chart_table.php?cid=$cid&sheba=$sheba&utype=$utype&status=$status&mtype=$mtype', 'chartmodeX'); shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=$status&mtype=$mtype', 'datatableX')\">";
