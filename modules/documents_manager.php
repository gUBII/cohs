...
echo"<div class='row'>
    <div class='col-12 col-md-5' style='padding-bottom:10px'>
        ...
        <h1 class='mb-0 pb-0 display-4' id='title'>Participant's Document Manager</h1>
    ...
    <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
        ...
        <a href='index.php?url=general-form-reports.php'>
        <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button'>
            <i data-acorn-icon='plus'></i>&nbsp;&nbsp;<span>View Forms Reports</span>
        </button></a>
                ...
                <div class='col-lg-2'>
                    <div class='form-group'>
                        <label>Client Name *</label><select class='form-control m-b required' name='clientid'>
                            ...
                            $s7 = "select * from uerp_user where mtype='CLIENT' and status='1' order by id asc limit 1";
                            $r7 = $conn->query($s7);
        ...
        <tbody>";
            ...
            if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                ...
                echo"<tr class='gradeX'>
                    ...
                    <td><a href='deleterecord.php?formid=".$rab1["id"]."&tbl=general_forms' style='color:red' target='dataprocessor'><i class='fa fa-trash'></i></a></td>
                </tr>";
