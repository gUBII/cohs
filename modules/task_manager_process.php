            ...
            <div class='modal-content' style='padding:5px'>
                ...
                <div class='modal-body' id='PopupModalX' style='padding:5px'>
                    <form method='post' name='dataform' action='taskprocessor.php' target='dataprocessor' enctype='multipart/form-data' >
                        ...
                        <input type=hidden name='pstat' value='1'><input type=hidden name='processor' value='edittask'>";
                        $randid=rand(100,999);
                        $s1 = "select * from tasks where id='".$_GET["tid"]."' order by id asc limit 1";
                        $r1 = $conn->query($s1);
                ...
                <fieldset>
                        <div class='row'>
                            ...
                            <div class='col-lg-12' style='margin-bottom:25px'><div class='form-group'>
                                <label>Assignee Name * </label>
                                <select class='form-control m-b' required name='employeeid'>";
                                    echo"<option value=''>Select Tasks Leader</option>";
                                    $ra7 = "select * from uerp_user where id='".$_COOKIE["userid"]."' order by id asc limit 1";
                                    $rb7 = $conn->query($ra7);
                                    if ($rb7->num_rows > 0) { while($rab7 = $rb7->fetch_assoc()) {
                                        echo"<option value='".$rab7["id"]."'>".$rab7["username"]." ".$rab7["username2"]."</option>";
                                    } }
                            ...
                            <div class='col-lg-6' style='margin-bottom:25px'><div class='form-group'>
                                <label>Start Date & Time *</label>
                                <input type='datetime-local' class='form-control' name='date1' value='' required>
                            </div></div>
                            <div class='col-lg-6' style='margin-bottom:25px'><div class='form-group'>
                                <label>End Date & Time *</label>
                                <input type='datetime-local' class='form-control' name='date2' value='' required>
                            </div></div>
                            <div class='col-lg-12' style='margin-bottom:25px'><div class='form-group'>
                                <label>Attachment (if any)</label>
            			        <input type='file' name='images[]' multiple class='form__field__img form-control' accept='.doc, .docx, .pdf, .jpg, .png, .gif, .jpeg'>
