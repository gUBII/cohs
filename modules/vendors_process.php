        ...
        if(isset($_GET["mid"]) && $_GET["mid"]!=0){
            if($_GET["cid"]==7){
                ...
                if ($r1->num_rows > 0) { while($t1 = $r1->fetch_assoc()) {
                    if(strlen($t["dob"])==10) $dob=date("Y-m-d", $t1["dob"]);
                    else $dob=$t["dob"];
                    
                    echo"<fieldset>
                        <h2>Shop/Store Details</h2><br>
                        <div class='row'>
                            <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Support ID *</label><input name='employeeid' type='text' value='".$t1["uid"]."' readonly class='form-control'></div></div>
                            ...
                            <div class='col-lg-2'><div class='form-group'><label>Shop Email (Login ID) *</label><input name='email' type='email' value='".$t1["email"]."' class='form-control' readonly></div></div>
                            ...
                            <div class='col-lg-2'><div class='form-group'><label>Shop/Store Name *</label><input name='store_name' type='text' value='".$t1["store_name"]."' class='form-control' required></div></div>
                            <div class='col-lg-4'><div class='form-group'><label>Shop Address</label><input name='store_address' type='text' value='".$t1["store_address"]."' class='form-control'></div></div>
                            ...
                            <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Country # *</label><select class='form-control m-b required' name='country' required>
                                ...
                                <option value='Afghanistan'>Afghanistan</option><option value='Åland Islands'>Åland Islands</option>
                                ...
                                <option value='Aruba'>Aruba</option><option value='Australia' selected>Australia</option>
                                ...
                                <option value='France'>France</option><option value='French Guiana'>French Guiana</option>
                                ...
                                <option value='Guinea-bissau'>Guinea-bissau</option><option value='Guyana'>Guyana</option>
                                <option value='Haiti'>Haiti</option><option value='Heard Island and Mcdonald Islands'>Heard Island and Mcdonald Islands</option>
                                ...
                                <option value='Indonesia'>Indonesia</option><option value='Iran, Islamic Republic of'>Iran, Islamic Republic of</option>
                                ...
                                <option value='Macao'>Macao</option><option value='Macedonia, The Former Yugoslav Republic of'>Macedonia, The Former Yugoslav Republic of</option>
                                <option value='Madagascar'>Madagascar</option><option value='Malawi'>Malawi</option>
                                ...
                                <option value='Marshall Islands'>Marshall Islands</option><option value='Martinique'>Martinique</option>
                                <option value='Mauritania'>Mauritania</option><option value='Mauritius'>Mauritius</option>
                                <option value='Mayotte'>Mayotte</option><option value='Mexico'>Mexico</option>
                                <option value='Micronesia, Federated States of'>Micronesia, Federated States of</option>
                                <option value='Moldova, Republic of'>Moldova, Republic of</option><option value='Monaco'>Monaco</option>
                                ...
                                <option value='Netherlands Antilles'>Netherlands Antilles</option><option value='New Caledonia'>New Caledonia</option>
                                ...
                                <option value='Oman'>Oman</option><option value='Pakistan'>Pakistan</option>
                                <option value='Palau'>Palau</option><option value='Palestinian Territory, Occupied'>Palestinian Territory, Occupied</option>
                                ...
                                <option value='Puerto Rico'>Puerto Rico</option><option value='Qatar'>Qatar</option>
                                <option value='Reunion'>Reunion</option><option value='Romania'>Romania</option>
                                <option value='Russian Federation'>Russian Federation</option><option value='Rwanda'>Rwanda</option>
                                <option value='Saint Helena'>Saint Helena</option><option value='Saint Kitts and Nevis'>Saint Kitts and Nevis</option>
                                ...
                                <option value='Switzerland'>Switzerland</option><option value='Syrian Arab Republic'>Syrian Arab Republic</option>
                                <option value='Taiwan'>Taiwan</option><option value='Tajikistan'>Tajikistan</option>
                                ...
                                <option value='Turkmenistan'>Turkmenistan</option><option value='Turks and Caicos Islands'>Turks and Caicos Islands</option>
                                ...
                                <option value='Virgin Islands, U.S.'>Virgin Islands, U.S.</option><option value='Wallis and Futuna'>Wallis and Futuna</option>
                                <option value='Western Sahara'>Western Sahara</option><option value='Yemen'>Yemen</option>
                                <option value='Zambia'>Zambia</option><option value='Zimbabwe'>Zimbabwe</option>
                            </select></div></div>
                            <div class='col-lg-2'><div class='form-group'><label>Shop Phone # *</label><input name='phone' type='text' value='".$t1["store_phone"]."' class='form-control'></div></div>
                    ...
                    <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                        <button type='button' class='btn btn-outline-primary' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=1', 'datatableX')\">Close</button>&nbsp;
                        <button class='btn btn-primary' type='reset' >Reset</button> &nbsp; 
                        <button class='btn btn-primary' type='submit' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=1', 'datatableX')\">Update</button>
                    </div>";
                } }
            }
            ...
            <fieldset>
                <h2>Shop/Store Details</h2><br>
                <div class='row'>
                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Support ID *</label><input name='employeeid' type='text' value='$puid' readonly class='form-control'></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>First Name *</label><input name='fname' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Last Name *</label><input name='lname' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Shop Email (Login ID) *</label><input name='email' type='email' value='' class='form-control'></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Login Password *</label><input name='password' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Shop/Store Name *</label><input name='store_name' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-4'><div class='form-group'><label>Shop Address</label><input name='store_address' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>City # *</label><input name='city' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>State # *</label><input name='state' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Zip # *</label><input name='zip' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Country # *</label><select class='form-control m-b required' name='country' required>
                    ...
                    <div class='col-lg-2'><div class='form-group'><label>Shop Phone # *</label><input name='phone' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>DOB *</label><input name='dob' type='date' value='' class='form-control'></div></div>
                    <div class='col-lg-2'><div class='form-group'><label>Gender *</label><select class='form-control m-b required ' name='gender'>
            ...
            <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                ...
                <button class='btn btn-primary' type='submit' onblur=\"shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=1', 'datatableX')\">Save</button>
            </div>";
        }
    echo"</form>
</div>";
