<?php
    ...
    echo"<div class='row'>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('receipt_voucher_process.php?cid=$cid&sheba=$sheba&ctitle=$title', 'offcanvasTop2')\">
                ...
                <div class='d-inline-block'>
                    <div class='d-inline-block datatable-export' data-datatable='#datatableStripe'>
                        ...
                        <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                            ...
                            <button class='dropdown-item' onclick='sortTable1()'type='button'>Receipt No.</button>
                            <button class='dropdown-item' onclick='sortTable2()'type='button'>Date</button>
                            <button class='dropdown-item' onclick='sortTable3()'type='button'>Income Note</button>
                            <button class='dropdown-item' onclick='sortTable4()'type='button'>Received From</button>
                            <button class='dropdown-item' onclick='sortTable5()'type='button'>Ledger ID</button>
                            <button class='dropdown-item' onclick='sortTable6()'type='button'>Amount</button>
                            <button class='dropdown-item' onclick='sortTable7()'type='button'>Status</button>                            
                        </div>
                    </div>
                    ...
                    <div class='dropdown-as-select d-inline-block datatable-length' data-datatable='#datatableStripe'>
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='SortForm'>
                            ...
                            <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=10000000; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">All Data</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=5; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">5 Items</a>
                                <a class='dropdown-item active' href='#' onmouseover=\"document.SortForm.sortvalue.value=10; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">10 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=25; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">25 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=50; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">50 Items</a>
                                <a class='dropdown-item' href='#' onmouseover=\"document.SortForm.sortvalue.value=100; document.SortForm.submit()\" onmouseup=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">100 Items</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class='data-table-rows slim' id='sample'>
        <body onload=\"shiftdataV2('receipt_voucher_data.php?cid=$cid&sheba=$sheba', 'datatableX')\">
        <div class='data-table-responsive-wrapper'>
            <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                <tr>
                    ...
                    <th onclick='sortTable(0)'>Receipt No. <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Date <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Income Note <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Received From <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Ledger ID <i data-acorn-icon='sort' style='height:12px'></i></th>
                    <th onclick='sortTable(0)'>Amount <i data-acorn-icon='sort' style='height:12px'></i></th>
