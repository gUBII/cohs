<?php
    ...
    echo"<div class='offcanvas-body'>";
        ...
        /*
            ...
            echo"</table>";
        */
        echo"<table class='table stripe table-hover'>
            <tbody>
                <tr><th>Date</th><th nowrap>Description</th><th nowrap>NDIS S.L.Item</th><th nowrap align=right>Frequency</th><th nowrap>Rate</th><th nowrap>Amount</th><th nowrap></th></tr>";
                $ttx==0;
                ...
                if ($r1x->num_rows > 0) { while($r1y = $r1x -> fetch_assoc()) {
                    ...
                    echo"<tr class='gradeX'>";
                            ...
                            echo"<td nowrap align=left>";
                                ...
                                echo"<form name='form_$t1x' method='post' action='../invoiceprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                            ...
                            <td align=left>";
                                ...
                                echo"<form name='form_$t2x' method='post' action='../invoiceprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                                    <input type='hidden' name='processor' value='invoiceupdate'>
                                    <input type='hidden' name='id' value='".$r1y["id"]."'>
                            ...
                            <td align=left>";
                                $t3x=rand(1000,9999);
                                echo"<form name='form_$t3x' method='post' action='../invoiceprocessor.php' target='_self' enctype='multipart/form-data'>
                                    <input type='hidden' name='processor' value='invoiceupdate'>
                                    <input type='hidden' name='id' value='".$r1y["id"]."'>
                            ...
                            <td align=right colspan=3>";
                                $t4=rand(100,999);
                                echo"<form name='form_$t4' method='post' action='../invoiceprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                                    <input type='hidden' name='processor' value='invoiceupdate'>
                                    <input type='hidden' name='id' value='".$r1y["id"]."'>
                                    <input type='hidden' name='pointer' value='4'>
                                    <table style='width:100%'><tr>
                                        <td nowrap align=right><input type='text' name='thour' value='".$r1y["hours"]."' class='form-control' style='padding:5px;width:100px' onchange='document.form_$t4.ttotal.value=(document.form_$t4.trate.value*document.form_$t4.thour.value); document.form_$t3x.thour.value=document.form_$t4.thour.value;document.form_$t4.submit()'>
                                        <td nowrap align=right><input type='text' name='trate' value='".$r1y["rate"]."' class='form-control' style='padding:5px;width:100px' onchange='document.form_$t4.ttotal.value=(document.form_$t4.trate.value*document.form_$t4.thour.value);document.form_$t4.submit()'></td>
                                        <td nowrap align=right><input type='text' name='ttotal' value='".$r1y["cr_amt"]."' class='form-control' readonly style='padding:5px;width:150px'></td>
                                    </tr></table>
                                </form>
                            </td>
