            ...
            <div class='panel-body'>
                <div class='row'>";
                    ...
                    if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                        ...
                        $sdatex=date("Y-m-d",$rab1["start_date"]);
                        $edatex=date("Y-m-d",$rab1["end_date"]);
                        ...
                        if($rab1["managed_by"]=="PLAN Managed"){
                            $ra6 = "select * from ndis_card_number where id='".$rab1["teamleaderid"]."' and status='1' order by id asc limit 1";
                            $rb6 = $conn->query($ra6);
                            if ($rb6->num_rows > 0) { while($rab6 = $rb6->fetch_assoc()) {
                                $teamleadername1=$rab6["referrer"];
                                $teamleadername2=$rab6["card_number"];
                                $teamleaderimage = "$mainurl/assets/noimage.png";
                                $teamleaderdepartment=null;
                                $teamleaderdesignation=null;
                            } }
                        }else{ 
                        ...
                        echo"<div class='col-12 col-md-4'>
                            <h2 class='small-title'>Client Detail</h2>
                            <div class='row'>
                                <div class='col-lg-12'>
                                    <div class='contact-box center-version' style='padding:5px;'>
                                        <div class='card d-flex mb-2' style='padding:10px;min-height:260px'><center>";
                                            ...
                                            if ($b1->num_rows > 0) { while($c1 = $b1->fetch_assoc()) {
                                                ...
                                                $aboutclient=$c1["aboutme"];
                                                $note_for_staff=$c1["note_for_staff"];
                                ...
                                <div class='col-md-12'>
                                    <div class='card d-flex mb-2' style='padding:20px'>
                                        <span>Detail Story/Enquiry of $clientname!</span><hr>
                        ...
                        <div class='col-12 col-md-4'>
                            <h2 class='small-title'>Allocated Support Team</h2>
                            <div class='row'>
                                ...
                                <div class='col-12'>
                                    <div class='contact-box' style='padding:5px'>
                                        <div class='card d-flex mb-2' style='padding:10px;'>
                                            <div class='row'>
                                                <div class='col-12 col-md-3'><img src='$clientimage' style='border:1px solid #ccc;border-radius:5px;height:60px' title=''></div>
                                                <div class='col-12 col-md-7'>
                                                    ...
                                                    <b><span>$clientname1 $clientname2</span></b><br>NDIS # : $ndisnumber
                                                </div>
                                                <div class='col-12 col-md-2'>
                                                    <a class='btn btn-outline-primary btn-sm' style='cursor: pointer' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' 
                                                        onmouseover=\"shiftdataV2('clients_edit.php?cid=7&sheba=uerp_user&mid=".$rab1["clientid"]."&ctitle=$title&utype=$utype&status=1&mtype=CLIENT&profile=1', 'offcanvasTop2')\">
                                        ...
                                        <div class='card d-flex mb-2' style='padding:10px;'>
                                            <div class='row'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <a href='index.php?url=users_dashboard.php&id=5210&projectid=".$rab1["id"]."&clientid=".$rab1["caseid"]."'><span>Support Co-Ordinator</span></a><br>
                                                    <b><span>$casename1 $casename2</span></b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='contact-box' style='padding:5px'>
                                        <div class='card d-flex mb-2' style='padding:10px;'>
                                            <div class='row'>
                                                ...
                                                <div class='col-12 col-md-9'>
                                                    <a href='index.php?url=users_dashboard.php&id=5210&projectid=".$rab1["id"]."&clientid=".$rab1["leaderid"]."'><span>Team Leader</span></a><br>
                                                    <b><span>$leadername1 $leadername2</span></b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='contact-box' style='padding:5px'>
                                        <div class='card d-flex mb-2' style='padding:10px;'>
                                            <div class='row'>
                                                <div class='col-12 col-md-3'><img src='$caseimage' style='border:1px solid #ccc;border-radius:5px;height:60px' title=''></div>
                                                <div class='col-12 col-md-9'>
                                                    <a href='#'><span>$sc</span></a><br>
                                                    <b><span>$teamleadername1 $teamleadername2</span></b></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class='ibox-title'>
                                            <div class='card-body' style='padding:5px'>
                                                <table style='width:100%'><tr>
                                                    <td align=left style='font-size:10pt;width:90%'><div class='btn btn-link list-item-heading p-0'>Support Workers</div></td>
                                                    <td align=right>
                                                        <button class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRightLarge' aria-controls='offcanvasRightLarge' onmouseover=\"shiftdataV2('projects-team.php?pid=".$rab1["id"]."&sheba=$sheba&ctitle=$title', 'offcanvasRightLarge')\" title='View All $ast'><i class='fa fa-plus'></i></button>
                                                    </td>
                                                </tr></table>
                                                <div class=''><hr>
                                                    <table style='width:100%'><tr>";
                        ...
                        <div class='col-12 col-md-4'>
                            <h2 class='small-title'>Tasks, Appointments & Notes</h2>
                            <div class='row'>
                                <div class='col-lg-12'>
                                    <div class='contact-box center-version' style='padding:5px'>
                                        <div class='card d-flex mb-2' style='padding:10px'>
                                    ...
                                    <div class='contact-box center-version' style='padding:5px'>
                                        <div class='card d-flex mb-2' style='padding:10px'>
                                            <table style='width:100%'><tr>
                                                ...
                                                <td align=right>
                                                    <a href='index.php?url=appointments.php&viewstatus=2&prjsrc=".$rab1["id"]."'>
                            ...
                            <div class='col-md-12'>
                                <div class='card d-flex mb-2' style='padding:20px'><span>Important Notes for Staffs</span><hr><p class='small'>$note_for_staff</p></div>
                            </div>
                        </div>
                            ...
                            <div class='row'>";
                                        ...
                                        <section class='scroll-section' id='lineChartTitlex'>
                                            <div class='card mb-5' ><div class='card-body'>
                                                            ...
                                                            <div class='modal-dialog modal-fullscreen modal-dialog-centered'>
                                                                <div class='modal-content'>
                                                                    <div class='modal-header'>
                                                                        ...
                                                                        <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close' onclick=\"shiftdataV2('projects_profile.php?sheba=$sheba&utype=$utype&sourceid=leads&url=".$_GET["url"]."&clientid=".$rab1["clientid"]."', 'datatableX')\"></button>
                                                                    </div>
                                                                    <div class='modal-body'>
                                                                        <iframe src='workspace_budget_editor.php?pid=".$_COOKIE["projectidx"]."' name='budgetmanagerx' scrolling='yes' style='border: 0px dashed #000000' border='0' frameborder='0' width='100%' height='1550'>BROWSER NOT SUPPORTED</iframe>
                                                ...
                                                <div style='width:100%'>";
                                                    ...
                                                    if($budgetunset==1){
                                                        if($goforit==1){    
                                                            echo"<hr><h2 class='small-title'>Budget Plan & Summary</h2>
                                                                ...
                                                                <div class='card-body' style='min-height:120px'>
                                                                    <div style='width:100%;align:center;text-align:left'>";
                                                                        ...
                                                                        echo"<table align=center width=100%>
                                                                            <thead><tr>
                                                                                <th notrap style='text-align:left;font-size:8pt'></th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 1</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 2</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 3</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 4</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 5</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 6</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 7</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 8</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 9</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 10</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 11</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 12</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 13</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 14</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>CAT 15</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>SDA</th>
                                                                                <th notrap style='text-align:center;font-size:8pt'>TOTAL</th>
                                                                            </tr></thead>
                                                                            <tbody>";
                                                                                $p1 = "select * from project where id='".$_COOKIE["projectidx"]."' and status='1' order by id desc limit 1";
                                                                                $p2 = $conn->query($p1);
                                                                                if ($p2->num_rows > 0) { while($p3 = $p2 -> fetch_assoc()) {
                                                                                    echo"<tr>
                                                                                        <td align='left' style='font-size:8pt'><strong>CORE</strong></td>
                                                                                        <td align='right' style='font-size:8pt'>$ ".$p3["cat1"]."</td>
                                                                                        <td align='right' style='font-size:8pt'>$ ".$p3["cat2"]."</td>
                                                                                        <td align='right' style='font-size:8pt'>$ ".$p3["cat3"]."</td>
                                                                                        <td align='right' style='font-size:8pt'>$ ".$p3["cat4"]."</td>
                                                                                        ...
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='right' style='font-size:8pt'><strong>$ ".$p3["core"]."</strong></td>
                                                                                    </tr>";
                                                                                    
                                                                                    echo"<tr>
                                                                                        <td align='left' style='font-size:8pt'><strong>CAPACITY</strong></td>
                                                                                        ...
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat7"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat8"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat9"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat10"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat11"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat12"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat13"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat14"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat15"]."</td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='right' style='font-size:8pt'><strong>$ ".$p3["capacity"]."</strong></td>
                                                                                    </tr>";
                                                                                    
                                                                                    echo"<tr>
                                                                                        <td align='left' style='font-size:8pt'><strong>CAPITAL</strong></td>
                                                                                        <td align='right' style='font-size:8pt'> - </td>
                                                                                        <td align='right' style='font-size:8pt'> - </td>
                                                                                        <td align='right' style='font-size:8pt'> - </td>
                                                                                        <td align='right' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat5"]."</td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["cat6"]."</td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        ...
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'> - </td>
                                                                                        <td align='center' style='font-size:8pt'>$ ".$p3["sda"]."</td>
                                                                                        <td align='right' style='font-size:8pt'><strong>$ ".$p3["capital"]."</strong></td>
                                                                                    </tr>";
                                                                                } }
                                                                            echo"</tbody>
                                                                        </table><hr>";
                                                                        ...
                                                                        echo"<table align=center width=100%>
                                                                            <thead><tr>
                                                                                <th></th>
                                                                                <th style='text-align:right'>Budget Planned</th>
                                                                                <th style='text-align:right'>SOS Allocated</th>
                                                                            ...
                                                                            if($budgetunset==1){
                                                                                ...
                                                                                if($budgetvalue!=0){
                                                                                    $budgetbalance=($totalscheduled-$budgetspent);
                                                                                ...
                                                                                if($totalscheduled<=$totalamount) $colset="red";
                                                                                else $colset="black";
                                                                                
                                                                                if($budgetbalance<=0) $colset1="red";
                                                                                else $colset1="black";
                                                                                echo"<tbody>
                                                                                    <tr>
                                                                                        <td  valign=bottom style='text-align:left;font-size:12pt'>Total Budget</td>
                                                                                        <td  valign=bottom style='text-align:right;font-size:12pt;color:$colset'>$ $totalscheduledz</td>
                                                                                        <td  valign=bottom style='text-align:right;font-size:12pt'>$ $totalamounty</td>
                                                                                        <td  valign=bottom style='text-align:right;font-size:12pt'>$ $budgetspenty</td>
                                                                                        <td  valign=bottom style='text-align:right;font-size:12pt;color:$colset1'>$ $budgetbalancey</td>
                                                                                        <td  style='text-align:right;font-size:11pt'>$percentageused %</td>
                                                                                    </tr>
                                                                                </tbody>";
                                                                            }else{
                                                            ...
                                                            echo"<h2 class='small-title'>Schedule of Support</h2>";
                                ...
                                echo"<div>
                                    <div class='col-12'>
                                        <div class='row'>
                                            <div class='col-12 col-md-4'>
                                                <h2 class='small-title'>Client Data</h2>
                                                        ...
                                                        <table style='width:100%'><tr>";
                                                            if($mtype=="ADMIN"){
                                                                echo"<td align=center>
                                                                    <a href='index.php?invdate1=$sdatex&invdate2=$edatex&clientid=".$rab1["clientid"]."&url=create_invoice.php&id=5161&refby=project' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' type='button'>
                                                                        <i data-acorn-icon='book'></i>&nbsp;&nbsp;<span>Create/View Invoice</span>
                                                                    </a>
                                                                </td>";
                                                            }
                                                            ...
                                                            echo"<td align=center>
                                                                <a href='index.php?url=appointment_manager.php&id=5310' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' type='button'>
                                                                    <i data-acorn-icon='eye'></i>&nbsp;&nbsp;<span>Task</span>
                                                                </a>
                                                            </td>";
                                                            
                                                            echo"<td align=center>
                                                                <a href='index.php?url=unpaid_invoices.php&id=5162&selection=INCOME&statusupdate=2&poinz=2&cid=1002&sheba=ndis_invoices&utype=UNPAID+INVOICES&lid_date_from=$sdatex&lid_date_to=$sdatex&lid=800000032&cname=".$rab1["clientid"]."&clientid=".$rab1["clientid"]."&refby=project' class='btn btn-outline-danger btn-icon btn-icon-start w-md-auto btn-sm' type='button'>
                                                                    <i data-acorn-icon='book'></i>&nbsp;&nbsp;<span>Unpaid</span>
                                                                </a>
                                                            </td>
                                                            <td align=center>
                                                                <a href='index.php?url=paid_invoices.php&id=5162&selection=INCOME&statusupdate=2&poinz=2&cid=1002&sheba=ndis_invoices&utype=PAID+INVOICES&lid_date_from=$sdatex&lid_date_to=$sdatex&lid=800000032&cname=".$rab1["clientid"]."&clientid=".$rab1["clientid"]."&refby=project' class='btn btn-outline-success btn-icon btn-icon-start w-md-auto btn-sm' type='button'>
                                                        ...
                                                        <span>Category & Documents</span><hr>";
                                                            if($advocatex!=1){
                                                                ...
                                                                echo"<table style='width:100%'><tr>
                                                                    ...
                                                                    <td align=center>
                                                                        <a href='$mainurl/index.php?url=case_category_manager.php&id=5394' class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' style='margin-right:5px'><span>Documents</span></a>
                                                                    </td>
                                                                    <td align=center>
