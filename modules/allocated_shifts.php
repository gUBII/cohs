    ...
    //    if($_COOKIE["projectid"]=="0"){
            ...
            echo"<div class='row'>
                <div class='col-12 col-md-5' style='padding-bottom:10px'>
                    ...
                    <h1 class='mb-0 pb-0 display-4' id='title'>Allocated Shifts.</h1>
            ...
            <div class='data-table-rows slim' id='sample'>
                    ...
                    <table width=100%><tr>
                        ...
                        <td align=left width='50' nowrap>";
                            ...
                            echo"<table><tr>
                                ...
                                <td valign=top style='width:150px'><form method='POST' name='shift_date' action='index.php' target='_self' enctype='multipart/form-data'>
                            ...
                            <table ><tr>
                                ...
                                <td align=left width=50 nowrap style='padding-right:10px'>
                                    <div class='d-inline-block datatable-export' data-datatable='#datatableStripe' style='margin-top:-15px;margin-right:5px'>
                                        <button class='btn btn-success btn-icon btn-icon-start w-md-auto btn-sm' btn-outline-muted btn-sm dropdown' data-bs-toggle='dropdown' type='button' data-bs-offset='0,3'>
                                            <span class='d-inline-block no-delay' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='View Option' ><i data-acorn-icon='eye'></i> <i data-acorn-icon='tools'></i></span>
                                        </button>
                                        <div class='dropdown-menu dropdown-menu-sm dropdown-menu-end'>
                ...
                <div class='tab-content'>
                    <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                        <thead><tr>
                            <th class='text-muted text-small text-uppercase' >Users View</th>";
                        ...
                        <tbody id='datatableX'>";
                            ...
                            if($src_employeeid=="ALL") $ra7 = "select * from uerp_user where status='1' and mtype='USER' or status='1' and mtype='ADMIN' order by username asc limit 5";
                            else if($src_employeeid=="") $ra7 = "select * from uerp_user where status='1' and mtype='USER' or status='1' and mtype='ADMIN' order by username asc limit 5";
                            else $ra7 = "select * from uerp_user where id='$src_employeeid' and status='1' and mtype='USER' or status='1' and mtype='ADMIN' order by username asc limit 5";
                            $rb7 = $conn->query($ra7);
                            if ($rb7->num_rows > 0) { while($rab7 = $rb7->fetch_assoc()) {
                                echo"<tr>
                                    <td nowrap>
                                        <img src='".$rab7["images"]."' style='border:1px solid #ccc;border-radius:50%;width:30px;height:30px' title='".$rab7["username"]."'><br>
                                        ...
                                        if($lts==1){
                                            ...
                                            echo"<td valign=top style='vertical-align:top;padding:5px;background-color:$bgcolor1;border-left: 1px solid #333333'>
                                                <div style='width:100%;text-align:right;'>
                                                    <form name='$datatarget' method='post' action='./modules/schedule-allocation-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                        ...
                                                        <button type='submit' class='btn btn-outline-primary btn-sm' 
                                                            ...
                                                            onmouseover=\"shiftdataV2('schedule-allocation-selector.php?days=$d1&months=$mm1&years=$y&empid=".$rab7["id"]."', 'offcanvasRight')\"
                                                            onmouseover='this.form.submit();' style='padding:3px;height:16px'>
                                                ...
                                                <div id='$datatarget' style='padding:0px'>";
                                                    ...
                                                    if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                        ...
                                                        if($pstatus!=0){
                                                            echo"<a href='#' data-toggle='modal' data-target='#schedulemover1' onclick=\"getDataMove1('".$r5c["id"]."', 'schedulemover2')\">
                                                                <div style='width:100%;padding:2px;max-width:150px' id='".$r5c["id"]."' draggable='true' ondragstart='drag(event)'>
                                                                    <div class='btn' style='color:white;background-color:".$r5c["color"].";width:100%;text-align:left;max-width:150px;border-radius:10px'>
                                                                        <div style='margin-left:-16px;margin-top:-12px;color:white;background-color:$statuscolor;width:12px;height:12px;border:1px solid #cccccc;border-radius:50%;' title='Grey=Waiting, LightGreen=Accepted/Clock-out, Orange=Clock-in'></div>
                                                                        <i class='fa fa-clock-o'></i> <span style='font-size:8pt'>$stimeA1 - $etimeA1</span><br><span style='font-size:8pt'>$clientname</span>
                                                                    </div>
                                                                </div>
                                                            </a>";
                                                        }
            ...
            // SHIFT
            echo"<div class='modal fade modal-close-out' id='buttontemplates' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabelCloseOut' aria-hidden='true'>
                <div class='modal-dialog'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                        ...
                        <div class='modal-body' style='padding:5px'>
                            <form class='m-t' role='form' method='post' action='dataprocessor.php' id='schedule-form' target='dataprocessor' enctype='multipart/form-data'>
                                ...
                                <div class='modal-body' style='padding:5px'>
                                    <div class='row'>
                                        <div class='col-md-9'><div class='form-group'><label>Participant/Job *</label><select class='form-control m-b ' name='projectid' required>
                                            ...
                                            $yy=date("Y",$timex);
                                        echo"</select></div></div>
                                        <div class='col-md-3'><div class='form-group'><br>
                                            <label for='end_datetime' class='control-label'>Over Night?</label><br>
                                            <input type='checkbox' class='btn btn-primary' value='1' name='over_night'>
                                        </div></div>
                                        <div class='col-md-4'><div class='form-group'><br>
                                        ...
                                        <div class='col-md-1'><div class='form-group'><br>
                                            <label for='end_datetime' class='control-label'>&nbsp;</label>
                            ...
                            <div style='width:100%' id='datashiftX'>
                                ...
                                <table class='table stripe table-hover' id='mySortTable' style='width:100%;padding:5px'>
                                            ...
                                            echo"<tr class='gradeX'>
                                                ...
                                                <td nowrap style='font-size:10pt'>
                                                    <form name='form_$ttx' method='post' action='dataprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                                                        ...
                                                        <input type='time' name='stime' value='".$r1y['stime']."' onchange='this.form.submit()' style='width:70px'>
                                                        <input type='time' name='etime' value='".$r1y['etime']."' onchange='this.form.submit()' style='width:70px'>
                                                    </form>
                                                </td>
                                                <td nowrap style='font-size:10pt'>
                                                    <form name='form_$ttx' method='post' action='dataprocessor.php' target='dataprocessor' enctype='multipart/form-data'>
                                                ...
                                                <td style='width:20px' style='font-size:10pt'><div class='btn-group' onmouseout=\"shiftdata('100000', 'datashiftX')\">
                                                    <a href='deleterecord.php?delid=".$r1y["id"]."&tbl=shifting_schedule' target='dataprocessor' style='margin-top:0px;'>
            ...
            <script type="text/javascript">
                function getDataMove1(sm1,schedulemoverx){
                    $.ajax({
                        url: 'schedule-mover.php?<?php echo"t=1&" ?>smid='+sm1, 
                        success: function(html) {
