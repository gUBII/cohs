                ...
                <div class='data-table-responsive-wrapper'>
                    <table width=100%><tr>
                        ...
                        <td align=left width='50'>";
                            ...
                            echo"<a class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' href='index.php?url=schedule.php' target='_self' style='margin-right:5px' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Roster by Jobs'>Roster by Jobs</a>
                        ...
                        <td align=left width='50' style='padding-right:5px' nowrap>
                        ...
                        </td><td align=left width='250' nowrap>
                            <form method='post' name='shift_today' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                                <table><tr>
                                    <td style='padding-right:5px' ><input type='date' name='shiftingidtoday' class='form-control' value='$shift_today' style='width:150px'></td>
                                    <td><input type=submit style='margin-top:0px' class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' value='View by Date'  style='margin-right:5px' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='View by Date'></td>
                                </tr></table>
                            </form>
                        </td><td align=right>
                            <table ><tr>
