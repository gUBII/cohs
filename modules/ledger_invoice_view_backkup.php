        ...
        if ($r->num_rows > 0) { while($rs = $r->fetch_assoc()) {
            ...
            if($idstatus==1){
                        ...
                        <tr><td colspan=10>
                            <table class='table stripe table-hover' style='width:100%;padding:10px;background-color:white'>
                                <thead><tr style='background-color:grey'>
                                    <th nowrap>Dt.From</th><th nowrap>Dt.To</th><th nowrap>Description</th><th nowrap>NDIS S.L.Item</th>
                                    <th nowrap style='text-align:center'>Frequency</th>
                                    <th nowrap style='text-align:right'>Rate</th>
                                    <th nowrap style='text-align:right'>Amount</th>
                                </tr></thead>
                                <tbody>";
                                    $ttx1=0;
                                    
                                    if($_GET["viewer"]==10) $r1 = "select * from receipt_voucher where invoice_no='".$rs["invoice_no"]."' and ledger_id='".$rs["ledger_id"]."' and paid='10' order by ledger_id desc";
                                    else $r1 = "select * from receipt_voucher where invoice_no='".$rs["invoice_no"]."' and ledger_id='".$rs["ledger_id"]."' and paid='1' order by ledger_id desc";
                                    $r1x = $conn->query($r1);
                    ...
                    <center><table>
                        ...
                        <tr><td align=center colspan=5><hr><br>
                            <form method='POST' action='email_invoice.php' target='dataprocessor' enctype='multipart/form-data'>
                                <input type='hidden' name='iid' value='".$rs["invoice_no"]."'>
                ...
                echo"<div class='row' style='margin-left:0px;width:100%;padding:5px;'>";
                    ...
                    echo"<form class='m-t' id='InvoiceEditForm' name='xcarbon1' role='form2' method='post' action='accountsprocessor.php' id='schedule-form' target='invoicedatax' enctype='multipart/form-data'>    
                        <div class='row' style='margin-left:0px;width:100%;padding:0px;'>
                            ...
                            <div class='col-lg-2'>$lidname Card ID<br><input type='text' class='form-control' name='cc_code' value='$cc_code' onchange='document.xcarbon1.submit()'></div>
                            <div class='col-lg-2'>$lidname Invoice Number<br><input type='text' class='form-control' name='invoice_no2' value='$invno2' onchange='document.xcarbon1.submit()'></div>
                            <div class='col-lg-2'>Invoice Date<br><input type='date' class=form-control name='idate' value='$invdate' required onchange='document.xcarbon1.submit()'></div>
                ...
                <div style='width:100%;padding:0px'>
                    <iframe name='invoicedatax' src='modules/ledger_forms_addon_edit.php?lid=$lid&sid=$invno' scrolling='yes' style='border: 0px dashed #000000' border='0' frameborder='0' width='100%' height='440'>BROWSER NOT SUPPORTED</iframe>
                    <center><br>";
