                    ...
                    <script type="text/javascript">
                        ...
                        echo"<div class='hide-area'><form method='post' name='shift_date' action='scheduling-set.php' target='_self' enctype='multipart/form-data'>
                            ...
                            <table><tr>
                                ...
                                <td valign=top style='padding-right:25px'>&nbsp;&nbsp;&nbsp;&nbsp;A/c Name: 
                                    <select class='form-control m-b' name='src_employeeid' required>";
            ...
            echo"<div class='data-table-responsive-wrapper'>
                <table class=' stripe hover' id='myTable' style='width:100%'>
                    <thead class='bg-info color-white' style='padding:10px;border-radius:10px'><tr>
                        ...
                        <th style='text-align:right'>Shift Hours</th><th style='text-align:right'>Worked Hours</th>
                        <th style='text-align:right'>Overtime</th><th style='text-align:right'>Wage ($)</th>
                        <th style='text-align:right'>OT ($)</th><th style='text-align:right'>Payable</th>
                        <th style='text-align:right'>Travel</th>";
                        if($mtype=="ADMIN") echo"<th style='text-align:right'>Action</th>";
                    echo"</tr></thead>
                        ...
                        */
                        ...
                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                            ...
                            if(strlen($r5c["clockin"])>=5 AND strlen($r5c["clockout"])>=5){
                                ...
                                if($r5c["night"]==1) $total_hour_worked= "1:00";
                                else $total_hour_worked= $diff1->format("%H:%I");
                            ...
                            if($r5c["night"]=="1") $nightcolor="Sleepover";
                            else $nightcolor="";
                            ...
                            // if ($cin2x >= 6 && $cout2x < 20) { $wageamount=$weekday_rate; }
                            // elseif ($cin2x >= 20 && $cout2x < 24) { $wageamount=$afternoon_shift_rate; }
                            // else { $shift = $wageamount=$night_shift_rate; }
                            
                            if($sday=="Monday" ||$sday=="Tuesday" ||$sday=="Wednesday" ||$sday=="Thursday" ||$sday=="Friday"){
                            ...
                            if($r5c["milage"]<=0) echo"<tr style='background-color:#333333;color:white'>";
                                                ...
                                                <div class='modal-content'>
                                                    ...
                                                    <div class='modal-body' id='PopupModalX'>
                                                        <form method='post' name='shiftediting' action='scheduling-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                            ...
                                                            <input name='wage_amount' type='hidden' value='$wageamt' class='form-control'>
                                                            <div class='row'>
                                                                ...
                                                                echo"<div class='col-lg-6' style='padding-bottom:20px'><div class='form-group'><label>Total Overtime *</label><input name='total_overtime' type='text' value='".$r5c["total_overtime"]."' class='form-control' required></div></div>
                                                                ...
                                                                <div class='col-lg-12' style='padding-bottom:20px'><div class='form-group'><label>Quick EOD *</label><textarea name='activity_log' class='form-control' required>".$r5c["activity_log"]."</textarea></div></div>
                                ...
                                // $total_hour_worked = is_numeric($total_hour_worked) ? (float)$total_hour_worked : 0;
                                /// $wageamount = is_numeric($wageamount) ? (float)$wageamount : 0;
                                ...
                                if($r5c["night"]==1){
                                    ...
                                    $pb0=($total_hour_worked_H*$wageamount);
                                    $pb3=($total_overtime*$r5c["overtime_amt"]); 
                                    $pb=($pb0+$pb3);
                                ...
                                */
                                ...
                                echo"<td align=left style='min-width:200px;font-size:8pt'>";
                                    if($mtype=="ADMIN") echo"<b>$employeename</b><br><a href='tel:$employeephone'>$employeephone</a><br>";
                                    echo"<b>$clientname<br><span style='color:yellow'>$schads_status ($schads_level - Paypoint $schads_paypoint).</span><br>$projectname<br>$stimeX1:$stimeX2 $sstatX - $etimeX1:$etimeX2 $estatX<hr>
                                </td>";
                                ...
                                echo"<td nowrap valign=top align=center style='font-size:12pt;'><br><b>$clockin</b><br>";
                                    ...
                                    // if($mtype=="ADMIN" and $clockin!="-") echo"<a href='dataupdate.php?sid=".$r5c["id"]."&clockin=$cin&clockout=$cout' target='dataprocessor' style='font-size:8pt'>update</a>";
                                    echo"<br><a href='#' class='btn btn-outline-warning btn-icon btn-icon-start w-md-auto btn-sm' data-bs-toggle='modal' data-bs-target='#userlog$t')\" style='font-size:10pt'>";
                                ...
                                <td nowrap valign=top align=center style='font-size:12pt;'><br>";
                                    ...
                                    if($r5c["clockout_request"]==0){
                                        if($r5c["payroll"]!="1"){ 
                                            if(strlen($r5c["clockout"])>=5) echo"<a href='#' class='btn btn-outline-success btn-icon btn-icon-start w-md-auto btn-sm' data-bs-toggle='modal' data-bs-target='#requestlog$t')\" style='font-size:10pt'>Request Edit</a>";
                                        }
                                ...
                                echo"</td>
                                <td nowrap valign=top align=right style='font-size:10pt'><br>$shift_total <span style='font-size:8pt'>Hr</span></td>
                                <td nowrap valign=top align=right style='font-size:10pt;'><br><b>$total_hour_worked</b> <span style='font-size:8pt'>Hr</span></td>
                                <td nowrap valign=top align=right style='font-size:10pt'><br>$total_overtime <span style='font-size:8pt'>OT</span></td>
                                <td valign=top align=right nowrap style='font-size:10pt'><br>$ $wageamount<br><span style='font-size:8pt'>$tempclokout</span></td>
                                <td valign=top align=right nowrap style='font-size:10pt'><br>$ ".$r5c["overtime_amt"]."</td>
                                <td valign=top align=right nowrap style=''><br>";
                                    ...
                                    echo"<br><span style='font-size:8pt;color:orange'>$nightcolor</span>
                                </td>
                                ...
                                if($mtype=="ADMIN") {
                                    ...
                                    echo"<td align=left valign=top style='padding-top:20px;padding-left:20px;font-size:8pt'><div class='form-check form-switch'>
                                        
                                        <form name='saas$rand' method='post' action='dataprocessor.php' target='dataprocessor'>
                                            <input type='hidden' name='processor' value='timesheetswitch1'>
                                            <input type='hidden' name='shiftid' value='".$r5c["id"]."'>
                                            <input type='hidden' name='switchx1' value='".$r5c["ignored"]."'>";
                                            
                                            $swstatus1=$r5c["ignored"];
                                            $checked = $swstatus1 == 1 ? "checked" : "";
                                            
                                            echo"<input class='form-check-input' type='checkbox' id='flexSwitchCheckChecked' name='switch1' $checked 
                                                onclick=\"this.form.switchx1.value = (this.form.switchx1.value == '1') ? '0' : '1'; this.form.submit();\"> 
                                            Ignore List
                                        </form><br>
                                        
                                        <form name='saas$rand2' method=post action='dataprocessor.php' target='dataprocessor'>
                                            <input type='hidden' name='processor' value='timesheetswitch2'>
                                            <input type='hidden' name='shiftid' value='".$r5c["id"]."'>
                                            <input type='hidden' name='switchx2' value='".$r5c["status"]."'>";
                                            
                                            $swstatus2=$r5c["status"];
                                            $checked2 = $swstatus2 == 4 ? "checked" : "";
                                            
                                            echo"<input class='form-check-input' type='checkbox' id='flexSwitchCheckChecked' name='switch2' $checked2 
                                                onclick=\"this.form.switchx2.value = (this.form.switchx2.value == '1') ? '4' : '1'; this.form.submit();\"> 
                                            Suspend
                                        </form>
                                    </div></td>";
                                }
                                                ...
                                                <div class='modal-content animated bounceInUp' id='printArea'><center>
                                                    ...
                                                    <div class='modal-body' style='padding:10px'>
                                                        <table style='width:100%'>
                                                            <tr><td style='width:50%' align=left><img src='https://nexis365.com/cohs/media/company/1758211847saas_ndisadmin_cohs_com_au.png' style='width:100px'><br></td>
                                                        ...
                                                        <table class='table table-striped table-bordered table-hover dataTables-example' style='width:100%'>
                                                            ...
                                                            <tbody>";
                                                                ...
                                                                if ($r5bp->num_rows > 0) { while($r5cp = $r5bp -> fetch_assoc()) {
                                                                    ...
                                                                    $totaworkedp=($total_hour_workedp*$wageamount);
                                                                    ...
                                                                    if($pb2p>=1){
                                                                        echo"<tr class='gradeX'>
                                                                            ...
                                                                            <td align=right nowrap style='font-size:10pt'>$ $wageamount/H</td>
                                ...
                                if($mtype=="ADMIN"){
                                    ...
                                    echo"<tr><td colspan=13>
                                        <table><tr>
                                            ...
                                            echo"<td style='padding:10px'><a href='modules/myob_payroll_export.php?src_employeeid=$employeeid' target='dataprocessor' class='btn btn-success'>Generate MYOB Payroll File</span></a></td>";
