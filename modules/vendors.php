<?php
    $sheba="uerp_user";
    $cid=7;
    $title="Add New Vendor/Contractor";
    $utype="VENDOR";
    ...
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            ...
            <h1 class='mb-0 pb-0 display-4' id='title'>Vendor/Contractor Account</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start'>";
            if($designationy==13){
                echo"<button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('vendors_process.php?cid=$cid&sheba=$sheba&ctitle=$title&utype=$utype', 'offcanvasTop2')\">
                    <i data-acorn-icon='plus'></i>&nbsp;&nbsp;<span>$title</span>
                </button>&nbsp;&nbsp;";
            }
            echo"<button class='btn btn-outline-success btn-icon btn-icon-start w-md-auto btn-sm' type='button' onclick=\"shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=1', 'datatableX')\">
                <i data-acorn-icon='user'></i>&nbsp;&nbsp;<span>Active</span>
            </button>&nbsp;&nbsp;
            <button class='btn btn-outline-danger btn-icon btn-icon-start w-md-auto btn-sm' type='button' onclick=\"shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=10', 'datatableX')\">
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('chart_table.php?cid=$cid&sheba=$sheba&utype=$utype&status=1', 'chartmodeX'); shiftdataV2('vendors_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=$status', 'datatableX')\">";
