<?php
    ...
    $utype="DEPARTMENTS";
        ...
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            ...
            <h1 class='mb-0 pb-0 display-4' id='title'>Departments Manager</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            ...
            <button class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onmouseover=\"shiftdataV2('departments_process.php?cid=$cid&sheba=$sheba&ctitle=$title&utype=$utype', 'offcanvasTop2')\">
                ...
                <div class='d-inline-block'>
                    ...
                    <table><td nowrap>
                        <form method='post' action='cookie_set.php' target='dataprocessor' enctype='multipart/form-data' name='ViewModeForm'>
                            ...
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='LIST'; document.ViewModeForm.submit()\" onmouseup=\"shiftdataV2('departments_data.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='list'></i></a>
                            <a onmouseover=\"document.ViewModeForm.viewmode.value='CARD'; document.ViewModeForm.submit()\" onmouseup=\"shiftdataV2('departments_data.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\" href='#' class='btn btn-icon btn-icon-only btn-outline-muted btn-sm ' type='button' data-datatable='#datatableStripe'><i data-acorn-icon='grid-3'></i></a>                        
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('chart_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'chartmodeX'); shiftdataV2('departments_data.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">";
