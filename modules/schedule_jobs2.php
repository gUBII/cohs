<?php    
    ...
    if(isset($_COOKIE["projectid"])){
        ...
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Appointment Calendar</h1>
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            <button type='button' data-bs-toggle='modal' data-bs-target='#ShiftModal' class='btn btn-outline-primary btn-icon btn-icon-start w-md-auto btn-sm'>
            ...
            echo"<div class='data-table-rows slim' id='sample'>
                ...
                <div class='tab-content'><hr>
                    <table class='data-table data-table-pagination data-table-standard responsive nowrap stripe hover' id='myTable' style='width:100%'>
                        <tr>
                            <th class='text-primary text-medium text-uppercase'>Calendar View</th>";
                        ...
                        <tbody id='datatableX'>";
                            ...
                            $rb1 = $conn->query($ra1);
                            if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) { $clientidx=$rab1["clientid"]; }}
                            echo"<hr>$clientidx<hr>";
                            $ra7 = "select * from uerp_user where id='$clientidx' and status='1' and mtype='CLIENT' order by username asc";
                            $rb7 = $conn->query($ra7);
