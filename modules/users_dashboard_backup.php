        ...
        <div class='wrapper wrapper-content animated fadeInRight' style='padding-left:5px;padding-right:5px'>
            <div class='row'>
                ...
                <div class='col-md-4'>
                    <section class='scroll-section' id='lineChartTitle'>";
                        ...
                        <div class='card mb-5'><div class='card-body'>";
                            ...
                            $ra7 = "select * from uerp_user where id='$cid' and status='1' order by username asc";
                            $rb7 = $conn->query($ra7);
                                        ...
                                        echo"<div class='ibox '>
                                            <div class='ibox-content text-center'style='padding:5px;text-align:center'><center><br>
                                                <center>
                                                    ...
                                                    <a href='index.php?url=clock_in-out.php&id=5199' class='btn btn-tertiary btn-sm'>View Time Clock</a>
                                                </center><br>";
                                                $tox=0;
                                                $tox1=0;
                                                ...
                                                if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                                                ...
                                                                echo"<div style='width:100%;padding:2px'>";
                                                                    if($r5c["accepted"]==1){
                                                                        ...
                                                                        echo"<a href='#' data-bs-toggle='offcanvas' data-bs-target='#offcanvasTop2' aria-controls='offcanvasTop2' onclick=\"shiftdataV2('schedule-request.php?t=1&smid=".$r5c["id"]."&url=users_dashboard.php&src_employeeid=$userid&id=1&sheba=schedule_allocation&ctitle=Schedule Updater', 'offcanvasTop2')\">
                                                                        <div class='bg-info' style='width:100%;text-align:left;border-radius:10px;padding:5px'>";
                                                                    }
                                                                        echo"<span style='font-size:8pt'><b>Clock IN</b>: $stimeA1 - <b>Clock OUT</b>: $etimeA1</b></span><br>
                                                                        <span style='font-size:8pt'><b>Client</b>: $clientname</span><br>
                                                                        <span style='font-size:8pt'><b>Location</b>: ".$r5c["address"]."</span><br>
                                                                    </div></a>
                                                                </div>";
                                                            } }
                                            echo"</div><br><br>
                                    ...
                                    <tbody>";
                                        ...
                                        if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                            ...
                                            echo"<tr class='gradeX'>
                                                <td nowrap>
                                                    <a href='index.php?url=reporting-forms&kroyee=eod-reports&sheba=1708323155&postid=".$rab1["id"]."' target='url'>
                                                        <i class='fa fa-eye'></i>&nbsp;$eod_date
                                                    </a><br>
                                                    $clientname<br><b>Shift: ".$rab1["shiftid"]."</b>
                                                </td>
                                                <td>".$rab1["activityid"]."</td>
                                            </tr>";
                ...
                <div class='col-12 col-xl-4'>
                    <section class='scroll-section' id='lineChartTitle'>
                        <h2 class='small-title'>Monthly Task Status Chart</h2>
                        <div class='card mb-5'>
                            <div class='card-body'>
                                <div class='sh-30'><iframe name='chart_accounts' src='./modules/users_chart.php?c=pie&v=M&uc=1' scrolling='no' border='0' frameborder='0' width='100%' height='260'>BROWSER NOT SUPPORTED</iframe></div>
                            </div>
                        </div>
                    </section>
                <br></div>
                ...
                <div class='col-12 col-xl-4'>
                    <section class='scroll-section' id='lineChartTitle'>
                        ...
                        <div class='card mb-5'>
                            <div class='card-body'>
                                <div class='sh-30'><iframe name='chart_accounts' src='./modules/users_chart.php?c=bar&v=M&uc=1' scrolling='no' border='0' frameborder='0' width='100%' height='265'>BROWSER NOT SUPPORTED</iframe></div>
                            </div>
                        </div>
                    </section>
                <br></div>
                            ...
                            <div class='card-body'>
                                <div id='projectdata' style='padding:0px'>
                                    <table class='table table-striped table-bordered table-hover dataTables-jobs1' >
                                        <thead><tr><th nowrap>ID</th><th>Project</th><th>Client</th><th>Support Co.</th><th>Team Members</th><th>Priority</th></tr></thead>
                                        <tbody>";
                                            ...
                                            if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                                ...
                                                echo"<tr class='gradeX'>
                                                    <td nowrap>
                                                        <i class='fa fa-briefcase'></i>&nbsp; PRO-".$rab1["id"]." ";
                                                        // Start Date: $sdate
                                                        // Dead Line: $edate
                                                        // <br>$leaderdesignation, $leaderdepartment
                                                    echo"</td>
                                                    <td nowrap>".$rab1["name"]."</td>
                                                    <td>$clientname1 $clientname1</td>
                                                    <td><b>$leadername1 $leadername2</b></td>
                                                    <td>";
                                                        $tt=0;
                                                        ...
                                                        if ($rb6->num_rows > 0) { while($rab6 = $rb6->fetch_assoc()) {
                                                            ...
                                                            if ($rb7->num_rows > 0) { while($rab7 = $rb7->fetch_assoc()) {
                                                                $tt=($tt+1);
                                                                echo"<span style='font-size:8pt;color:purple'>$tt. ".$rab7["username"]."</span><br>";
                                                            } }
                                                        } }
                                                    echo"</td>
                                                    <td nowrap>".$rab1["priority"]."</td>
                                                </tr>";
                                            } }
                ...
                echo"<div class='col-md-6'>
                    <section class='scroll-section' id='lineChartTitle'>
                        ...
                        <div class='card mb-5'>
                            <div class='card-body'>
                                <table class='table table-hover margin bottom'>
                                    <thead><tr><th >Date</th><th >Status</th><th >Clocked IN</th><th >Clocked OUT</th><th>Receivable</th></tr></thead>
                                    <tbody>";       
                                        $d1= date("d", $todayx);
                                        $m1= date("m", $todayx);
                                        $y1= date("Y", $todayx);
                                        ...
                                        if ($r5b->num_rows > 0) { while($r5c = $r5b -> fetch_assoc()) {
                                            ...
                                            if($r5c["clockout_request"]==0) echo"<tr class='gradeX' style='background-color:$bgcolor'>";
                                            else if($r5c["clockout_request"]>=2) echo"<tr class='gradeX' style='background-color:orange'>";
                                            else echo"<tr class='gradeX' style='background-color:$bgcolor'>";
                                            
                                                echo"<td nowrap><b><a href='#".$r5c["id"]."'> $sday</a></b><br>$sdate</td>";
                                                ...
                                                */
                                                ...
                                                <td nowrap align=center style='font-size:10pt'><b>$clockin</b><br>
                                                    <a href='#' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#userlog$t')\" style='font-size:8pt;border-radius:50px;padding-top:2px;padding-bottom:2px;padding-left:5px;padding-right:5px;background-color:#CCCCCC;margin-top:3px'>User Log</a>
                                                    <div class='modal inmodal' id='userlog$t' tabindex='-1' role='dialog' aria-hidden='true'>
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content animated bounceInUp'>
                                                                <div class='modal-header'><h4 class='modal-title'>User`s Note/Log</h4></div>
                                                                <div class='modal-body'>".$r5c["activity_log"]."</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td nowrap align=center style='font-size:10pt'>";
                                                    ...
                                                    if($r5c["clockout_request"]==0){
                                                        if($r5c["payroll"]!="1"){ 
                                                            if($r5c["clockout"]!=0) echo"<a href='#' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#requestlog$t')\" style='font-size:8pt;border-radius:50px;padding-top:2px;padding-bottom:2px;padding-left:5px;padding-right:5px;background-color:$topbar_color;color:$tbtc;margin-top:3px'>Request Edit</a>";
                                                        }
                                                        echo"<div class='modal inmodal' id='requestlog$t' tabindex='-1' role='dialog' aria-hidden='true'>
                                                            <div class='modal-dialog'>
                                                                <div class='modal-content animated bounceInUp'>
                                                                    <div class='modal-header'><h4 class='modal-title'>Edit $employeename</h4><p>$sday</b> - $sdate</p></div>
                                                                    <div class='modal-body'>
                                                                        <form method='post' name='shiftediting' action='scheduling-set.php' target='dataprocessor' enctype='multipart/form-data'>
                                                                            <input type='hidden' name='url' value='$url'><input type='hidden' name='request_edit' value='request-edit'>
                                                                            <input type='hidden' name='src_employeeid' value='".$_GET["src_employeeid"]."'>";
                                                                            $cdate=date("H:i", $r5c["clockin"]);
                                                                            $cdate1=date("h:i A", $r5c["clockin"]);
                                                                            if($r5c["clockout"]!=0) $edate=date("H:i", $r5c["clockout"]); else $edate="--";
                                                                            
                                                                            if($r5c["clockout"]!=0) $edate1=date("h:i A", $r5c["clockout"]); else $edate1="--";
                                                                            
                                                                            if($r5c["clockin"]!="0") $pdate=date("Y-m-d", $r5c["clockin"]);
                                                                            else{
                                                                            ...
                                                                            <div class='row'>
                                                                                ...
                                                                                <div class='col-lg-12'><div class='form-group'><input type=submit name='submit' style='background-color:orange;border-radius:10px' value='Submit Request' class='form-control' required></div></div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        if($r5c["clockout_request"]>=2){
                                                            ...
                                                            echo"<span style='color:blue;font-size:10pt'>Pending Request<br><b>$newclockout</b></span><br>";
                                                        }
                                                    }
                                                echo"</td>
                                                <td align=right nowrap style='font-size:10pt'>";
                                                    ...
                                                    echo"<a href='#' class='dropdown-item' data-bs-toggle='modal' data-bs-target='#adminlog$t')\" style='font-size:8pt;border-radius:50px;padding-top:2px;padding-bottom:2px;padding-left:5px;padding-right:5px;background-color:#CCCCCC;margin-top:3px'>Admin Log</a>
                                                    <div class='modal inmodal' id='adminlog$t' tabindex='-1' role='dialog' aria-hidden='true'>
                                                        <div class='modal-dialog'>
                                                            <div class='modal-content animated bounceInUp'>
                                                                <div class='modal-header'><h4 class='modal-title'>Admin`s Note/Log</h4></div>
                                                                <div class='modal-body'>".$r5c["address"]."<hr>".$r5c["admin_note"]."</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                        ...
                        if ($r1->num_rows > 0) { while($t1 = $r1->fetch_assoc()) {
                            ...
                            echo"<div class='container'>
                                <div class='row'>
                                    ...
                                    echo"<div class='col-12 col-xl-8 col-xxl-9 mb-5 tab-content'>
