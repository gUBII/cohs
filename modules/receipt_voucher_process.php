    ...
    <div class='offcanvas-body'>
        <form method='post' action='dataprocessor_1.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >";
            if(isset($_GET["mid"]) && $_GET["mid"]!=0){
                    ...
                    $s1x = "select * from receipt_voucher where id='".$_GET["mid"]."' order by id asc limit 1";                    
                    $r1x = $conn->query($s1x);
                    if ($r1x->num_rows > 0) { while($rs1x = $r1x->fetch_assoc()) {
                        $rdate=date("Y-m-d",$rs1x["receipt_date"]);
                        echo"<input type=hidden name='processor' value='".$_GET["sheba"]."'><input type=hidden name='id' value='".$_GET["mid"]."'>
                        <div class='row'>
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Receipt No.</label><input class='form-control' type='text' name='receipt_no' required='' placeholder='Type here' value='".$rs1x["receipt_no"]."' ></div>                            
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Date</label><input class='form-control' type='date' name='receipt_date' required='' placeholder='Type here' value='$rdate' ></div>
                            ...
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Received From</label>
                            ...
                            <div class='col-4' style='margin-top:15px'><label class='form-label'>Received Amount</label><input class='form-control' type='number' name='cr_amt' placeholder='Type here' min-value='1' value='".$rs1x["cr_amt"]."' ></div>
                            ...
                            <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                                ...
                                <button class='btn btn-primary' type='submit' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('receipt_voucher_data.php?cid=5&sheba=receipt_voucher', 'datatableX')\">Update</button>
                            </div>
                        </div>";
                    } }
                    ...
                    $rc1 = "select * from receipt_voucher order by receipt_no desc limit 1";
                    $rc2 = $conn->query($rc1);
                    if ($rc2->num_rows > 0) { while($rc3 = $rc2->fetch_assoc()) { $receiptno=($rc3["receipt_no"]+1); } }
    
                    echo"<input type=hidden name='processor' value='new_receipt_voucher'>
                    <div class='row'>
                        <div class='col-4' style='margin-top:15px'><label class='form-label'>Receipt No.</label><input class='form-control' type='text' name='receipt_no' required='' placeholder='Type here' value='$receiptno'></div>
                        <div class='col-4' style='margin-top:15px'><label class='form-label'>Date</label><input class='form-control' type='date' name='receipt_date' required='' placeholder='Type here' value='$rdate'></div>
                        ...
                        <div class='col-4' style='margin-top:15px'><label class='form-label'>Received Amount</label><input class='form-control' type='number' name='cr_amt' placeholder='Type here' min-value='1' value='0' ></div>
                        <div class='col-8' style='margin-top:15px'><label class='form-label'>Receive Note</label><input class='form-control' type='text' name='narration' placeholder='Type here' min-value='1' value='' ></div>
                        <div class='col-4' style='margin-top:15px'><label class='form-label'>Status</label>
                            <select class='form-select' name='status' required=''><option value='ON'>ON</option><option value='OFF'>OFF</option></select>
                        </div>
                        <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                            <button type='button' class='btn btn-outline-primary' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('receipt_voucher_data.php?cid=5&sheba=receipt_voucher', 'datatableX')\">Close</button>&nbsp;
                            ...
                            <button class='btn btn-primary' type='submit' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('receipt_voucher_data.php?cid=5&sheba=receipt_voucher', 'datatableX')\">Save</button>
                        </div>
                    </div>";
