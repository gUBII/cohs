...
<div class='offcanvas-body'>";
    if(isset($_GET["mid"]) && $_GET["mid"]!=0){
        ...
        if(isset($_GET["pid"])){
            echo"<form name='xcarbon' method='post' action='invoiceprocessor_gwc.php' target='invoicedataxxxx' enctype='multipart/form-data'>";
                    ...
                    if ($r->num_rows > 0) { while($rs = $r->fetch_assoc()) {
                            ...
                            echo"<div class='col-lg-12'><h4>Add Item for INV# $invno<br></h5></center><hr></div>
                                ...
                                <div class='row' style='margin-left:0px;width:100%;padding:5px;'>
                                    ...
                                    <div class='col-md-3' style='margin-top:25px'>";
                                        /*
                                        <form method='POST' action='invoiceprocessor_gwc.php' target='dataprocessor' enctype='multipart/form-data' style='margin-top:8px;margin-bottom:5px'>
                        ...
                        <div style='width:100%;padding:0px'>
                            <iframe name='invoicedataxxxx' src='./modules/invoices_addon_gwc.php?rid=$participantid&lid=$lid&sid=$invno&pid=$invoiceid' scrolling='yes' style='border: 0px dashed #000000' border='0' frameborder='0' width='100%' height='450'>BROWSER NOT SUPPORTED</iframe>
            ...
            echo"<form name='xcarbon' method='post' action='invoiceprocessor_gwc.php' target='dataprocessor' enctype='multipart/form-data'>";
                if($_GET["cid"]==1001){
                    $invoice_no2x=0;
                    $invoice_nox=0;
