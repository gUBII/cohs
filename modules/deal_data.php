        ...
        <div class='row' style='padding-left:5px;padding-right:5px'>
            <div class='col-12'>";
                ...
                // if($sourceid=="Leave_Application"){
                    ...
                    echo"<thead>
                        <tr><th>Sl.</th><th>Deal Name</th><th>Lead Name</th><th>Client</th><th>Team Leader</th>
                        <th>Date</th><th>Product/Service</th><th>Detail</th><th>Deal Value</th><th>Note</th>
                        <th>status</th><th>&nbsp;</th></tr>
                    </thead>
                    <tbody>";
                        $t=0;
                        $ra1 = "select * from deals order by id asc";
                        $rb1 = $conn->query($ra1);
                        if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                            
                            $deal_date=date("d.m.Y",$rab1["deal_date"]);
                            ...
                            echo"<tr>
                                <td>$t</td>
                                <td>".$rab1["deal_name"]."</td>
                                <td>$leadname</td>
                                <td>$clientname</td>
                                <td>$employeename</td>
                                <td>$deal_date</td>
                                <td>".$rab1["product_name"]."</td>
                                <td>".$rab1["product_detail"]."</td>
                                <td>".$rab1["deal_value"]."</td>
                                <td>".$rab1["note"]."</td>
                                <td>".$rab1["status"]."</td>
