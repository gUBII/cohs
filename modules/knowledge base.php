    ...
    <link rel="stylesheet" href="tools/css/vendor/glide.core.min.css" />
        ...
        <div class="container">
          ...
          <div class="page-title-container">
            <div class="row">
              ...
              <div class="col-12 col-md-7">
                <h1 class="mb-0 pb-0 display-4" id="title">E-learning & Knowledge Base</h1>
                <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                  <ul class="breadcrumb pt-0">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="index.php">E-Learning</a></li>
          ...
          <div class="row">
                ...
                <div class="scroll-by-count" data-count="3">
                    ...
                    <div class="row g-0 sh-14">
                      <div class="col-auto">
                        <a href="#" class="d-block position-relative h-100">
                          <img src="tools/img/course/small/course-1.webp" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                        </a>
                      </div>
                      <div class="col">
                        <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
                          <div class="w-100">
                            <div class="d-flex flex-row justify-content-between mb-2">
                              <a href="#" class="font-heading mb-1">React Web Developer Course</a>
                  ...
                  <div class="card mb-2">
                    <div class="row g-0 sh-14">
                      <div class="col-auto">
                        <a href="#" class="d-block position-relative h-100">
                          <img src="tools/img/course/small/course-2.webp" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                        </a>
                      </div>
                      <div class="col">
                        <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
                          <div class="w-100">
                            <div class="d-flex flex-row justify-content-between mb-2">
                              <a href="#" class="font-heading mb-1">Python: From Zero to Expert</a>
                  ...
                  <div class="card mb-2">
                    <div class="row g-0 sh-14">
                      <div class="col-auto">
                        <a href="#" class="d-block position-relative h-100">
                          <img src="tools/img/course/small/course-3.webp" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                        </a>
                      </div>
                      <div class="col">
                        <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
                          <div class="w-100">
                            <div class="d-flex flex-row justify-content-between mb-2">
                              <a href="#" class="font-heading mb-1">Learn and Understand NodeJS</a>
                  ...
                  <div class="card mb-2">
                    <div class="row g-0 sh-14">
                      <div class="col-auto">
                        <a href="#" class="d-block position-relative h-100">
                          <img src="tools/img/course/small/course-4.webp" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                        </a>
                      </div>
                      <div class="col">
                        <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
                          <div class="w-100">
                            <div class="d-flex flex-row justify-content-between mb-2">
                              <a href="#" class="font-heading mb-1">HTML 5 - The Complete Guide</a>
                  ...
                  <div class="card mb-2">
                    <div class="row g-0 sh-14">
                      <div class="col-auto">
                        <a href="#" class="d-block position-relative h-100">
                          <img src="tools/img/course/small/course-5.webp" alt="alternate text" class="card-img card-img-horizontal sw-14 sw-lg-18" />
                        </a>
                      </div>
                      <div class="col">
                        <div class="card-body pt-0 pb-0 h-100 d-flex align-items-center">
                          <div class="w-100">
                            <div class="d-flex flex-row justify-content-between mb-2">
                              <a href="#" class="font-heading mb-1">Getting Started with Gulpjs</a>
            ...
            <div class="col-xl-6 mb-5">
              ...
              <div class="card w-100 sh-50 sh-md-40 h-xl-100-card hover-img-scale-up position-relative">
                <img src="tools/img/banner/cta-standard-3.webp" class="card-img h-100 scale position-absolute" alt="card image" />
                <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                  <div>
                    ...
                    <div class="w-50 text-white mb-3 opacity-75">
                      Liquorice caramels chupa chups bonbon.
                    </div>
                    <div class="mb-2">
          ...
          <div class="row row-cols-1 row-cols-md-2 row-cols-xl-5 g-2 mb-5">
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-footer border-0 pt-0">
                  <div class="mb-2">
                    <div class="br-wrapper br-theme-cs-icon d-inline-block">
                      <select class="form-control rating" name="rating" autocomplete="off" data-readonly="true" data-initial-rating="5">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
            ...
            <div class="col d-none d-xl-block">
              <div class="card h-100">
                <img src="tools/img/course/small/course-9.webp" class="card-img-top sh-22" alt="card image" />
                <div class="card-body">
                  <h5 class="heading mb-0"><a href="#" class="body-link stretched-link">Fruit Decorations</a></h5>
                </div>
                <div class="card-footer border-0 pt-0">
                  <div class="mb-2">
                    <div class="br-wrapper br-theme-cs-icon d-inline-block">
              ...
              <div class="card sh-40 h-xl-100-card">
                <div class="card-body d-flex align-items-center justify-content-center h-100">
                  <div class="text-center">
                    <img src="tools/img/illustration/icon-analytics.webp" class="theme-filter mb-3" alt="launch" />
    ...
    <script src="tools/js/vendor/glide.min.js"></script>

    <script src="tools/js/vendor/Chart.bundle.min.js"></script>
    ...
    <script src="tools/js/cs/glide.custom.js"></script>
    <script src="tools/js/cs/charts.extend.js"></script>
    <script src="tools/js/pages/dashboard.elearning.js"></script>
