    ...
    <form method='post' name='dataform' action='dataprocessor_1.php' target='dataprocessor' enctype='multipart/form-data' >";
        if(isset($_GET["mid"]) && $_GET["mid"]!=0){
            ...
            if($cid==9){
                ...
                $next_uid=0;
                $s7 = "select * from uerp_user where mtype='USER' OR mtype='$utype' OR mtype='ADMIN' order by id desc limit 1";                
                $r7 = $conn->query($s7);
                ...
                echo"<input type=hidden name='processor' value='new_$utype'>                            
                            <fieldset>
                                <h2>Personal Detail</h2>
                                <div class='row'>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Posting Date *</label><input name='pdate' type='date' value='$rdate' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Joining Date *</label><input name='jdate' type='date' value='$rdate' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>First Name *</label><input name='fname' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Last Name *</label><input name='lname' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Phone # *</label><input name='phone' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Email Address *</label><input name='email' type='text' value='' class='form-control' required onchange='document.dataform.userid.value=this.value'></div></div>

                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Employee ID *</label><input name='employeeid' type='number' value='$next_uid' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Login User ID *</label><input name='userid' type='text' value='' placeholder='Auto Generated' class='form-control' required readonly></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Login Password *</label><input name='password' type='text' value='1234567' class='form-control' required ></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>DOB *</label><input name='dob' type='date' value='$rdate' class='form-control'></div></div>
                                    ...
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Address *</label><input name='address' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Address 2</label><input name='address2' type='text' value='' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>City # *</label><input name='city' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>State # *</label><input name='state' type='text' value='' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Zip # *</label><input name='zip' type='text' value='' class='form-control' required></div></div>
                            ...
                            <fieldset><br>
                                <h2>Financial Detail</h2><br>
                                <div class='row'>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>ABN *</label><input name='abn' type='text' value='' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Bank Name</label><input name='bankname' type='text' value='' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>BSB</label><input name='bsb' type='text' value='' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Account Name</label><input name='accountname' type='text' value='' class='form-control'></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Account Number</label><input name='accountnumber' type='text' value='' class='form-control'></div></div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset><br>
                                ...
                                <div class='row'>
                                    ...
                                    echo"</select></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Account Type</label><select class='form-control m-b required' name='mtype' required>
                                        <option value=''>Select Account Type</option><option value='EMPLOYEE'>EMPLOYEE</option><option value='ADMIN'>ADMIN</option>
                                    </select></div></div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset><br>
                                ...
                                <div class='row'>        
                                    ...
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Regular Wage Amount</label><input name='reg_amt' type='number' value='0' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Saturday Wage Amount</label><input name='sat_amt' type='number' value='0' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Sunday Wage Amount</label><input name='sun_amt' type='number' value='0' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Public holiday Wage Amount</label><input name='hol_amt' type='number' value='0' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Over Night Wage Amount</label><input name='night_amt' type='number' value='0' class='form-control' required></div></div>
                                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Overtime (Per Hour)</label><input name='overtime' type='text' value='0' class='form-control' required></div></div>
                            ...
                            <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                                ...
                                <button class='btn btn-primary' type='submit' onblur=\"shiftdataV2('users_table.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\"  onmouseover='document.dataform.userid.value=document.datafrom.email.value'>Save</button>
                            </div>";
            }
        }
    echo"</form>
