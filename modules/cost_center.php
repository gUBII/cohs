<?php
    ...
    echo"<div class='row'>
        <div class='col-12 col-md-5' style='padding-bottom:10px'>
            <h1 class='mb-0 pb-0 display-4' id='title'>Cost Center</h1>
            <nav class='breadcrumb-container d-inline-block' aria-label='breadcrumb'>
              <ul class='breadcrumb pt-0'>
                <li class='breadcrumb-item'><a href='index.php'>Home</a></li>";
                if(isset($_GET["url"])) echo"<li class='breadcrumb-item'><a href='index.php'>Dashboard</a></li>";
    ...
    <div class='data-table-rows slim' id='sample'>
        ...
        <body onload=\"shiftdataV2('cost_center_data.php?cid=$cid&sheba=$sheba&utype=$utype', 'datatableX')\">
        
        <div class='data-table-responsive-wrapper' id='chartmodeX'></div>
        <div class='data-table-responsive-wrapper'id='datatableX'>";
          include 'cost_center_data.php';
