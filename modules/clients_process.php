...
<div class='offcanvas-body'>
    <form method='post' name='dataform' action='dataprocessor_1.php' target='dataprocessor' enctype='multipart/form-data' >";
        ...
        if(isset($_GET["mid"]) && $_GET["mid"]!=0){
                ...
                if ($r1->num_rows > 0) { while($t1 = $r1->fetch_assoc()) {
                    ...
                    echo"<fieldset>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>HCP Grandfathered *</label><select class='form-control m-b required ' name='hcp_grandfathered'>
                        ...
                        <div class='row'>
                            <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>NDIS # *</label><input name='ndis_number' type='text' value='".$t1["ndis_number"]."' class='form-control'></div></div>
                    ...
                    <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                        <button type='button' class='btn btn-outline-primary' data-bs-dismiss='offcanvas' onblur=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=".$_GET["status"]."&mtype=".$_GET["mtype"]."', 'datatableX')\">Close</button>&nbsp;
                        <button class='btn btn-primary' type='reset' >Reset</button> &nbsp;
                        <button class='btn btn-primary' type='submit' onblur=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=".$_GET["status"]."&mtype=".$_GET["mtype"]."', 'datatableX')\">Update</button>
                    </div>";
                } }
            }
            ...
            $next_uid=0;
            $s7 = "select * from uerp_user where mtype='CLIENT' OR mtype='$utype' order by id desc limit 1";
            $r7 = $conn->query($s7);
            ...
            <fieldset>
                ...
                <div class='row'>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Posting Date *</label><input name='pdate' type='date' value='$rdate' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Contract Date *</label><input name='jdate' type='date' value='$rdate' class='form-control' required></div></div>
                    <div class='col-md-2' style='margin-bottom:25px'><div class='form-group'><label>Title *</label>
                        <select class='form-control m-b required ' name='title'>
                    ...
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>First Name *</label><input name='fname' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Last Name *</label><input name='lname' type='text' value='' class='form-control' required></div></div>
                    ...
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Phone # *</label><input name='phone' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>DOB *</label><input name='dob' type='date' value='$rdate' class='form-control'></div></div>
                                    
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Client ID *</label><input name='employeeid' type='text' value='$next_uid' class='form-control' readonly></div></div>
                    <div class='col-lg-2' style='margin-bottom:25px'><div class='form-group'><label>Login User ID *</label><input name='userid' type='text' value='' placeholder='Auto Generated' class='form-control' readonly></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Email Address (Login ID) *</label><input name='email' type='text' value='' class='form-control' required onchange='document.dataform.userid.value=this.value'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Login Password *</label><input name='password' type='text' value='1234567' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Gender *</label><select class='form-control m-b required ' name='gender'>
                    ...
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Address *</label><input name='address' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Address 2</label><input name='address2' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>City *</label><input name='city' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>State *</label><input name='state' type='text' value='' class='form-control' required></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Post Code *</label><input name='zip' type='text' value='' class='form-control' required></div></div>
                    ...
                    <div class='col-md-2' style='margin-bottom:25px'><div class='form-group'><label>Geographic Region *</label><select class='form-control m-b required' name='geographic_regions' required>";
                        echo"<option value=''>Select Referrer</option>";
                        $s7x = "select * from geographic_regions where status='1' order by id asc";
                        $r7x = $conn->query($s7x);
                        if ($r7x->num_rows > 0) { while($rs7x = $r7x->fetch_assoc()) {
                    ...
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Ref # / URN / MAC</label><input name='ref_number' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Medicare Import Ref</label><input name='medicare_import_ref' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>NAPS Service ID</label><input name='naps_service_id' type='text' value='' class='form-control'></div></div>
                ...
                <div class='row'>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Contact Person Name</label><input name='cp_name' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Phone 1</label><input name='cp_phone1' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Phone 2</label><input name='cp_mobile' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Email Address</label><input name='cp_email' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Home Address</label><input name='cp_address' type='text' value='' class='form-control'></div></div>
                </div>
                
                <br><h2>Financial Detail</h2><br>
                <div class='row'>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>NDIS Number</label><input name='ndisnumber' type='text' value='' class='form-control'></div></div>
                    <div class='col-md-2' style='margin-bottom:25px'><div class='form-group'><label>NDIS Price Zone</label><select class='form-control m-b required' name='ndis_price_zone' required>
                    ...
                    /*<div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>ABN *</label><input name='abn' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Bank Name</label><input name='bankname' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>BSB</label><input name='bsb' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Account Name</label><input name='accountname' type='text' value='' class='form-control'></div></div>
                    <div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Account Number</label><input name='accountnumber' type='text' value='' class='form-control'></div></div>
                    */
                    
                    echo"<div class='col-lg-2' style='margin-bottom:15px'><div class='form-group'><label>Client Plan Manager Card ID</label>
                        <select class='form-control m-b required ' name='application_id'><option value=''>Select Plan Manager (Card ID)</option>";
                            $ra1 = "select * from ndis_card_number where status='1' order by id desc";
                            $rb1 = $conn->query($ra1);
                            if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                                if($t1["application_id"]==$rab1["id"]) echo"<option selected value='".$rab1["id"]."'>".$rab1["referrer"]." (".$rab1["card_number"].")</option>";
                    ...
                    <div class='col-lg-3' style='margin-bottom:25px'><div class='form-group'><label>If Yes! Aging Period (Day Wise)</label><input name='aging_days' type='number' value='0' class='form-control' min='1' max='10000'></div></div>
                    */
                echo"</div>
                ...
                <div class='row'>
                    ...
                    <div class='col-12' style='margin-bottom:15px'><div class='form-group'>
                        <label>Inportent Note for Support Workers</label>
                        <textarea name='note_for_staff' class='form-control' style='width:100%'></textarea>";
                        ?><script>
                            $('#summernote1').summernote({
                                placeholder: 'Detail Note', tabsize: 2, height: 120,
                                toolbar: [
            ...
            <div class='modal-footer' class='col-md-12' style='margin-top:15px;padding:5px;border-width:0px'>
                ...
                <button class='btn btn-primary' type='submit' onblur=\"shiftdataV2('clients_data.php?cid=$cid&sheba=$sheba&utype=$utype&status=".$_GET["status"]."&mtype=".$_GET["mtype"]."', 'datatableX')\"  onmouseover='document.dataform.userid.value=document.datafrom.email.value'>Save</button>
            </div>";
        }
    echo"</form>
</div>";
