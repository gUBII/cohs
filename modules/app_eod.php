...
<?php 
    ...
    echo"<h1 class='mb-0 pb-0 display-4' id='title'>EOD Reporting</h1>
    <form id='form' method='post' action='report_processor.php' target='dataprocessor' enctype='multipart/form-data'>
        ...
        echo"<label class='mb-3 top-label'><input name='eod_employee_phone' type='text' value='$phonex' class='form-control required' readonly><span>Phone *</span></label>
        ...
        <br><br>
        <span>Client Name *</span><select class='form-control m-b required' name='clientid'>
        ...
        <br><Br><h5 class='card-title'>Behavior</h5>
        <p class='card-text text-alternate mb-4'>Challenges in behavior today.</p><hr>
        ...
        <label class='mb-3 top-label'>
            <textarea name='eod_eat' class='form-control'></textarea>
            <span>Eating, Walking, Personal Care, Listening/Comprehending (If Required)</span>
        </label>
        <input type=hidden name='eod_walk' value='&nbsp;'><input type=hidden name='eod_care' value='&nbsp;'><input type=hidden name='eod_listen' value='&nbsp;'>
        <label>
        ...
        <br><br><h5 class='card-title'></h5><p class='card-text text-alternate mb-4'></p>
        <h2>Communication</h2><hr>
        ...
        <label>How effective was their communication? (On a rating of 1 to 10).</label>
