<?php    
    ...
    if(isset($_COOKIE["projectid"])){
        ...
        <div class='col-12 col-md-7 d-flex align-items-start justify-content-end'>
            <a href='index.php?url=appointments.php&viewstatus=2&prjsrc=".$_GET["prjsrc"]."&accepted=".$_GET["accepted"]."' class='btn btn-warning btn-icon btn-icon-start w-md-auto btn-sm' type='button' style='margin-right:5px'>
                <span class='d-inline-block no-delay' data-bs-delay='0' data-bs-offset='0,3' data-bs-toggle='tooltip' data-bs-placement='bottom' title='View Appointments' ><i data-acorn-icon='eye'></i> Back to Appointments</span>
            </a>";
