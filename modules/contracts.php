...
echo"<div class='row'>
    <div class='col-12 col-md-5' style='padding-bottom:10px'>
        ...
        <h1 class='mb-0 pb-0 display-4' id='title'>CONTRACT Forms</h1>
...
if(!isset($_GET["formid"])){
    ...
    echo"<form class='m-t' role='form' method='post' action='dataprocessor03.php' id='image_upload_form' target='dataprocessor' enctype='multipart/form-data'>
        ...
        <h1>Service Contract Documents</h1>
        <fieldset>
            <div class='row'>
                <div class='col-lg-2'>
    ...
    echo"<form class='m-t' role='form' method='post' action='dataprocessor03.php' id='image_upload_form' target='dataprocessor' enctype='multipart/form-data'>
        ...
        <h1>EDIT - General Form</h1>";
            $ra1X = "select * from contract_forms where status='1' and id='".$_GET["formid"]."' order by id desc";
...
echo"<div class='table-responsive'>
    <table class='table table-striped table-bordered table-hover dataTables-example' >
        ...
        <tbody>";
            $ra1 = "select * from contract_forms where status='1' order by id desc";
            $rb1 = $conn->query($ra1);
            if ($rb1->num_rows > 0) { while($rab1 = $rb1->fetch_assoc()) {
                ...
                echo"<tr class='gradeX'>
                    ...
                    <td><a href='deleterecord.php?formid=".$rab1["id"]."&tbl=contract_forms' style='color:red' target='dataprocessor'><i class='fa fa-trash'></i></a></td>
                </tr>";
