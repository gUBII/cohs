        ...
        <div class='nav-content d-flex'>
            ...
            <div class='menu-container flex-grow-1' style='margin-left:-20px;width:320px'>
                <ul id='menu' class='menu'>";
                    if($designationy==22){
                        echo"<li class=''><a href='$mainurl/index.php?url=client_dashboard.php&id=5210' data-href='$mainurl/index.php?url=cost_center.php&id=786'>
                            <i data-acorn-icon='category' class='icon' data-acorn-size='15'></i><span class='label'>Dashboard</span>
                        </a></li>";
                    }
                    if($designationy==11){
                        echo"<li class=''><a href='$mainurl/index.php?url=users_dashboard.php&id=5210' data-href='$mainurl/index.php?url=cost_center.php&id=786'>
                            <i data-acorn-icon='category' class='icon' data-acorn-size='15'></i><span class='label'>Dashboard</span>
                        </a></li>";
                    }
