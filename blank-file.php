                    ...
                    <div class='modal-content'>
                      ...
                      <div class='modal-body'>
                        ...
                        <select class='form-control' id='cancelReasons' required>
                            ...
                            <option 'NSDH'>No show due to health reason (NSDH)</option>
                            <option 'NSDF'>No show due to family issues (NSDF)</option>
                            <option 'NSDT'>No show due to unavailability of transport (NSDT)</option>
                            <option 'NSDO'>Other (NSDO)</option>
                        </select><Br>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function openCancelHoursModal() {
    ...
    document.getElementById('cancelReasonsPreview').textContent = '—';
  ...
  function ensureModalActionButtons() {
    ...
    if (confirmBtn && !confirmBtn.dataset.bound) {
      ...
      confirmBtn.addEventListener('click', async () => {
        ...
        let cancel_reasons = parseFloat(document.getElementById('cancelReasons').value || '0');
        ...
        if (!isFinite(cancel_reasons) || cancel_reasons == '') { alert('Select Cancellation Reason.'); return; }
