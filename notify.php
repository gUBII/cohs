<?php
    $randno=rand(1234567890,12345678900);
    echo"<span style='color:white;font-size:25pt'>$randno</span>";
    ...
    echo"<ul class='list-unstyled border-last-none'>";
        ...
        if ($n11->num_rows > 0) { while($n111 = $n11->fetch_assoc()) {
            ...
            $sdate1=date("d-m-y", $item["start"]);
            $sdate2=date("d-m-Y", $item["end"]);
            echo"<li class='mb-3 pb-3 border-bottom border-separator-light d-flex'>
                <div class='align-self-center'><a href='index.php?url=task_manager.php&id=58'>$clientname</a> ".$n111["title"]."<br>$sdate1 - $sdate2</div>
            </li>";
        } }
    echo"</ul>";
        ...
        <main>
            ...
            <div class='row'>
                ...
                <section class='scroll-section' id='title'>
                    ...
                    <h1 class='mb-0 pb-0 display-4'>Notify</h1>
                ...
                <div>
                    <div class='card mb-5'>
                    <div class='card-body'>
                        <p class='mb-0'>A simple plugin that turns standard Bootstrap alerts into 'Growl-like' notifications.</p>
                    </div>
                    </div>
