...
<html lang='en' data-footer='true'>
    ...
    <body class='fade-in card mb-5'><?php
        ...
        // echo"<meta http-equiv='refresh' content='5;url=workspace_budget.php?pid=$pid'>";
        ...
        $wsp11 = "select * from project where status='15' and id='$pid' order by id desc limit 1";
                    ...
                    <div class='card-body' >
                        <div class='row'>
                            ...
                            <div class='col-12 col-md-12' style=';margin-top:-5px;margin-bottom:25px'>
                                ...
                                <form method='post' name='budgetstage' action='workspace_budget.php' enctype='multipart/form-data' class='tooltip-end-bottom'>
                            ...
                            if ($ln2->num_rows > 0) { while($ln3 = $ln2 -> fetch_assoc()) {
                                ...
                                echo"<tr style='padding:10px'>
                                    <th scope='row' style='font-size:10pt;width:30%'>
                                        <form method='post' name='budgetstage' action='workspace_budget.php' enctype='multipart/form-data' class='tooltip-end-bottom'>
                                            ...
                                            <table width='100%' height='39'><tr>
                                                ...
                                                <td width=5 align='right'><button type='button'><a href='workspace_budget.php?delid=".$ln3["id"]."&pid=$pid' target='_self'><span style='margin-top:5px;font-size:10pt;'><i class='fa fa-times'></i></span></a></td>
                                            </tr></table>
                                        ...
                                        <form method='post' name='form_18_".$ln3["id"]."' id='myForm' onsubmit='handleSubmit(event)' action='workspace_budget_valuation.php' target='budgetmanagerz$tt' enctype='multipart/form-data' class='tooltip-end-bottom'>
                                            ...
                                            <table style='width:100%;height:45;margin-top:10px'><tr>";
                                                ...
                                                */
                                                ...
                                                <td style='padding:5px;color:black;background-color:lightblue;text-align:center;font-size:10pt;width:12.5%' nowrap>Over Night<br><input type='checkbox' name='night' value='1' $d9 onclick='this.form.submit()'></td>";
                                                // echo"<td style='padding:5px;color:black;background-color:lightblue;text-align:center;font-size:10pt;width:12.5%'>Night<br><input type='checkbox' name='evening' value='1' $d8 onclick='this.form.submit()'></td>";
                                    ...
                                    <td style='text-align:left;font-size:10pt' nowrap colspan=4>";
                                        ...
                                        echo"<iframe src='workspace_budget_valuation.php?zid=".$ln3["id"]."' name='budgetmanagerz$tt' scrolling='no' style='border: 0px dashed #000000' border='0' frameborder='0' width='400px' height='80px'>BROWSER NOT SUPPORTED</iframe>";
                                        echo"<a style='margin-left:-50px;margin-top:30px;position:absolute;color:purple;align:right' href='workspace_budget_valuation.php?zid=".$ln3["id"]."' class='btn' target='budgetmanagerz$tt'><i class='fa fa-refresh' style='color:purple'></i></a>";
                                        echo"<form method='post' name='form_10_".$ln3["id"]."' action='workspace_budget_processor.php' target='budgetmanagerz' enctype='multipart/form-data' class='tooltip-end-bottom'>
                        ...
                        echo"<div style='width:100%;align:right;text-align:right'>";
                            ...
                            echo"<iframe src='workspace_budget_allocated.php?pidz=$pid' id='budgetmanager_xyzz' name='budgetmanager_xyz' scrolling='no' style='border: 0px dashed #000000' border='0' frameborder='0' width='400px' height='250px'>BROWSER NOT SUPPORTED</iframe>";
