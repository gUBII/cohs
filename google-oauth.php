...
$google_oauth_client_id = '68171100671-ttr97l95mbaqljht8n3ke2a5tisj7uve.apps.googleusercontent.com';
$google_oauth_client_secret = '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';
$google_oauth_redirect_uri = 'https://nexis365.com/saas/google-oauth.php';
...
if (isset($_GET['code']) && !empty($_GET['code'])) {
    ...
    if (isset($response['access_token']) && !empty($response['access_token'])) {
        ...
        if (isset($profile['email'])) {
            ...
            header('Location: loginbygoogle.php');
            exit;
        } else {
