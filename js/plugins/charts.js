...
class Charts {
    ...
    if (document.getElementById('radarChart')) {
      ...
      this._radarChart = new Chart(radarChart, {
        ...
        data: {
          ...
          labels: ['Assigned', 'Processing', 'Completed'],
        },
      });
    }
  }
    ...
    if (document.getElementById('polarChart')) {
      ...
      this._polarChart = new Chart(polarChart, {
        ...
        data: {
          ...
          labels: ['Not Satisfied', 'Satisfied', 'Good Service'],
        },
      });
    }
  }
  ...
  _initPieChart() {
    if (document.getElementById('pieChart')) {
      ...
      this._pieChart = new Chart(pieChart, {
        type: 'pie',
        data: {
          labels: ['Assigned', 'Completed', 'Processing'],
          datasets: [
            {
              label: '',
              borderColor: [Globals.primary, Globals.secondary, Globals.tertiary],
  ...
  _initDoughnutChart1() {
    ...
    if (document.getElementById('doughnutChart1')) {
      ...
      this._doughnutChart1 = new Chart(doughnutChart1, {
        plugins: [ChartsExtend.CenterTextPlugin()],
        type: 'doughnut',
        data: {
          labels: ['Assigned', 'Completed', 'Processing'],
            ...
            xAxes: [
              {
                scaleLabel: {
                  display: true,
                  labelString: 'Clock IN/Out Time Frame',
                },
