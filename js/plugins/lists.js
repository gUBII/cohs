...
class Lists {
  ...
  _initExistingHtmlList() {
    ...
    if (document.getElementById('existingHtmlList2')) {
      var existingHtmlList2 = new List('existingHtmlList2', {valueNames: ['name', 'position']});
    }
    if (document.getElementById('existingHtmlList3')) {
      var existingHtmlList3 = new List('existingHtmlList3', {valueNames: ['name', 'position']});
    }
    if (document.getElementById('existingHtmlList4')) {
      var existingHtmlList4 = new List('existingHtmlList4', {valueNames: ['name', 'position']});
    }
    if (document.getElementById('existingHtmlList5')) {
      var existingHtmlList5 = new List('existingHtmlList5', {valueNames: ['name', 'position']});
    }
  }
