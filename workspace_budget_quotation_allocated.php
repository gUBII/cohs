...
<html lang='en' data-footer='true'>
    ...
    <body class='fade-in card mb-5'>
        <div><?php
            ...
            $pidz=$_GET["pidz"];
            $rate3=0;
            echo"<meta http-equiv='refresh' content='5;url=workspace_budget_quotation_allocated.php?pidz=$pidz'>";
            
            $wsp11 = "select * from quotes where id='$pidz' order by id desc limit 1";
