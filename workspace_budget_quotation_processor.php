    <?php
        ...
        if(isset($_POST["eid"])){
            ...
            if($_POST["statx"]==1){
                $sql="update quotation_budget_allocation set mon='".$_POST["mon"]."',tue='".$_POST["tue"]."',wed='".$_POST["wed"]."',
            ...
            if($_POST["statx"]==4){
                ...
                $sql="update quotation_budget_allocation set note='$serviceNote' where id='".$_POST["eid"]."'";
                if ($conn->query($sql) === TRUE) $tomtom=0;
            }
            
            if($_POST["statx"]==5){
                $serviceAddress = htmlspecialchars(trim($_POST["address"]));
                $sql="update quotation_budget_allocation set address='$serviceAddress' where id='".$_POST["eid"]."'";
                if ($conn->query($sql) === TRUE) $tomtom=0;
            }
            ...
            if($_POST["statx"]==6){
                ...
                $sql="update quotation_budget_allocation set employeeid='".$_POST["supportworker"]."',rate2='$weekday_rate' where id='".$_POST["eid"]."'";
                if ($conn->query($sql) === TRUE) $tomtom=0;
            }
