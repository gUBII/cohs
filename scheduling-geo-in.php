...
<form name='mygeolocation1' method='POST' action='scheduling-set.php' enctype='multipart/form-data'>
  ...
  <input type='file' id='imageFile' name='clockimage' accept='image/*' capture='environment' style='display:none;' onchange='previewImage(event)'>
  <img id='clockimage' src='#' alt='Clock-In Image' style='display:none; width:100px;'>
