                        ...
                        <div class='sw-lg-100 px-5'>
                            ...
                            <div class='mb-5'>
                                ...
                                <center>
                                    ...
                                    <p class='h6'>If you are a member, please ";
                                    // <a style='cursor: pointer' onclick=\"slogin('0', 'datashiftX')\" target='_self' class=' t-3 e-3'>Login</a>.</p>
                                    echo"<a href='login.php' target='_self' class=' t-3 e-3'>Login</a>.</p>
                                </center>
                            </div>
                            <div>
                                <form method='post' action='security.php' target='processor' enctype='multipart/form-data' class='tooltip-end-bottom'>
                                    <div class='mb-3 filled form-group tooltip-end-top'>
                                        ...
                                        <input class='form-control' placeholder='Email' name='uemail' />
                                    </div>
                                    <div class='mb-3 filled form-group tooltip-end-top'>
                                        <center><button type='submit' class='btn btn-lg btn-primary'>Send Recovery Link to Email</button><br><br><p>OR</p>
