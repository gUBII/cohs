        ...
        <div class='sw-lg-70 d-flex justify-content-center align-items-center shadow-deep ' style='background-color:#000000;border-image: linear-gradient(to bottom, #222222 10%, #3acfd5 100%) 1;border-width: 1px;border-style: solid'>
            <div class='sw-lg-100 px-5'>
                ...
                <table><tr>
                    ...
                    echo"</a></td>
                    <td><iframe name='processor' src='blank-login.php?url=login&d1=ACCOUNT RECOVERY&d2=Type Email To Get Recovery Link!' height='60' width='100%' scrolling='no' border='0' frameborder='0'>&nbsp;</iframe></td>
                </tr><tr>
                    <td colspan=2><hr><div style='text-align:left'>Email Address:</div></td>
                </tr></table>
                
                <form method='post' action='security.php' target='processor' enctype='multipart/form-data' class='tooltip-end-bottom'>
                    <div class='mb-3 filled form-group tooltip-end-top'>
                        <i data-acorn-icon='at-sign'></i><input style='background-color:#cccccc;color:black' class='form-control' type='text' placeholder='Email' required value='' name='femail' />
                    </div>
                    <div style='text-align:left'>Registered Phone Number:</div>
                    <div class='mb-3 filled form-group tooltip-end-top' style='color:orange'>
                        <i data-acorn-icon='lock-off'></i><input style='background-color:#cccccc;color:black' class='form-control pe-7' name='fphone' type='text' value='' placeholder='Phone Number'/>
                        <a href='login.php' target='_self' class='text-small position-absolute t-3 e-3'>Login?</a>
                    </div>
                    <div class='mb-3 filled form-group tooltip-end-top'><br>
                        <table style='width:100%'><tr>
                            <td width='100px'><button type='submit' class='btn btn-lg btn-primary'>Send Reset Link</button></td>
                            <td align='right'><span style='font-size:12pt;color:white'>Don't have account?<br>
                            <a href='register.php' class='btn btn-outline-warning btn-sm' style='cursor: pointer' target='_self'>Register for FREE</a></span></td>
                        </tr></table>
                    </div>";
