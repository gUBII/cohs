<?php
    ...
    echo"<section class='section-padding'>
        <div class='container wow fadeIn animated'>
            <h3 class='section-title mb-20'style='color:$bodytc'><span style='color:$buttonbc'>New</span> Arrivals</h3>
            <div class='carausel-6-columns-cover position-relative'>
                <div class='row product-grid-3'>";
                    ...
                    $ta=0;
                    $s1 = "select * from sms_product_bon where status='2'  order by id desc limit $rowsetz";
                ...
                <input type='hidden' id='rowcount' name='rowcount' value='$rowsetz'><input type='hidden' id='catid' name='catid' value='ALL'>";
