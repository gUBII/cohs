                ...
                <div class='row'>
                    ...
                    <div class='col-lg-12'>
                        <div class='shop-product-fillter'>";
                            $setterm="asc"; 
                            if($_COOKIE["sortset2"]=="H") $setterm="desc"; 
                            if($_COOKIE["sortset2"]=="A") $setterm="asc"; 
                            if($_COOKIE["sortset2"]=="L") $setterm="asc"; 
                            if($_COOKIE["sortset2"]=="Z") $setterm="desc"; 
                            $trec=0;
                            /*
                            if($catid==0) $tr1 = "select * from sms_product_bon where pname LIKE '%$src%' and permission='2' or sku LIKE '%$src%' and permission='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";
                            else $tr1 = "select * from sms_product_bon where pname LIKE '%$src%' and permission='2' or sku LIKE '%$src%' and permission='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";                            
                            */

                            $tr1 = "select * from sms_product_bon where pname LIKE '%$src%' and status='2' or sku LIKE '%$src%' and status='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";
                            $tr11 = $conn->query($tr1);
                            ...
                            <div class='sort-by-product-area'>
                                <div class='sort-by-cover mr-10'>
                                    <form method='post' action='addtocookie.php' target='addtocart' enctype='multipart/form-data' name='rowcounter'>
                                        <div class='sort-by-product-wrap'>
                                            ...
                                            <select name='rowset' onchange=\"this.form.submit(); ChangeUrl('index.php?cPath=9000&src=$src'); shiftdatax('search.php?cPath=9000&src=$src&cm=1', 'datashiftX')\">";
                                                if(isset($_COOKIE["sortset1"])){
                                                    echo"<option value='".$_COOKIE["rowset1"]."'>".$_COOKIE["rowset1"]."</option>";
                                                }
                                ...
                                <div class='sort-by-cover'>
                                    <form method='post' action='addtocookie.php' target='addtocart' enctype='multipart/form-data' name='sortingset'>
                                        <div class='sort-by-product-wrap'>
                                            <div class='sort-by' style='width:100px'><span><i class='fi-rs-apps-sort'></i>Sort by:</span></div>
                                            <select name='sortset' onchange=\"this.form.submit(); ChangeUrl('index.php?cPath=9000&src=$src'); shiftdatax('search.php?cPath=9000&src=$$src&cm=1', 'datashiftX')\">";
                                                if(isset($_COOKIE["sortset1"])){
                        ...
                        <div class='row product-grid-3'>";
                            ...
                            /*
                            if($catid==0) $s1 = "select * from sms_product_bon where pname LIKE '%$src%' and permission='2' or sku LIKE '%$src%' and permission='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";
                            else $s1 = "select * from sms_product_bon where pname LIKE '%$src%' and cid='$catid' and permission='2' or sku LIKE '%$src%' and cid='$catid' and permission='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";
                            */
                            $tr1 = "select * from sms_product_bon where pname LIKE '%$src%' and status='2' or sku LIKE '%$src%' and status='2' order by ".$_COOKIE["sortset1"]." $setterm limit ".$_COOKIE["rowset1"]."";
                            $r1 = $conn->query($tr1);
                        ...
                        <input type='hidden' id='rowcount' name='rowcount' value='8'><input type='hidden' id='src' name='src' value='$src'>";
