<?php
    ...
    echo"<section class='content-main'>
        <div class='content-header'><h2 class='content-title'>Notice Board</h2></div>
        <div class='card'>
            <div class='card-body'>
                <div class='row gx-5'>";
                if($uactype=="ADMIN"){
                    echo"<form method='post' action='dataprocessor.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >
                        <div class='row'>
                            ...
                            <div class='col-md-9'>
                                <div class='mb-3'><label class='form-label'>Notice Detail</label><textarea placeholder='Type here' class='form-control' name='solution'></textarea></div>
                            </div>
                            <div class='col-md-3' style='margin-top:25px'>
                                <div class='d-grid'>
                                    <button class='btn btn-primary' onblur=\"shiftdataV1('pages_notice', 'datashiftX')\">Save</button>
                                    <input type=hidden name=processor value='addnotice'></div>
                            </div>
                        </div>
                    </form>";
                }
