...
var buttonName2 = new Array();
	...
	buttonName2[14] = "outdent";
	buttonName2[15] = "indent";	
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:100%; height:500px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
  ...
  document.getElementById("wysiwyg" + n).style.height = "500px";
