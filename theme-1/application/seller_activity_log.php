<?php
    ...
    echo"<section class='content-main'>
        <div class='content-header'><h2 class='content-title'>Sellers Activity Log</h2></div>
        <div class='card'>
            <div class='card-body'>
                <div class='table-responsive'>
                    <table class='table table-hover'>
                        ...
                        <tbody>";
                            include("auth.php");
                            $s1 = "select * from activity_log where status='1' and actype='VENDOR' order by id desc";
                            $r1 = $conn->query($s1);
