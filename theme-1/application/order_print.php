<?php
    ...
    echo"<section class='content-main'>
        ...
        <div class='content-header'>
            <div class='col-md-7 content-header'><h2 class='content-title'>Print Invoice Detail</h2></div>
            <div class='col-md-1' style='text-align:right'>";
                if(isset($_GET["oid"])) echo"<a style='cursor: pointer' href='#top' onclick=\"shiftdataV2('order_print.php?oid=".$_GET["oid"]."&cid=".$_GET["cid"]."&sheba=".$_GET["sheba"]."&blist=".$_GET["blist"]."', 'datashiftX')\"><i class='icon material-icons md-refresh'></i></a>";
                else echo"<a style='cursor: pointer' href='#top' onclick=\"shiftdataV1('order_print', 'datashiftX')\"><i class='icon material-icons md-refresh'></i></a>";
            echo"</div>
            <div class='col-md-1' style='text-align:right'>";
                if(isset($_GET["cid"])) echo"<a style='cursor: pointer' href='#top' onclick=\"shiftdataV2('order_detail.php?oid=".$_GET["oid"]."&cid=".$_GET["cid"]."&sheba=".$_GET["sheba"]."&blist=".$_GET["blist"]."', 'datashiftX')\">Bact to Detail</a>";
            echo"</div>
        ...
        <div class='card'>";
            if(!isset($_GET["cid"])) {
                echo"<form method='get' name=tracker action='order_printer.php' target='ordertracker' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >
                ...
                echo"<iframe name='ordertracker' src='blank.php' height='1500' width='100%' scrolling='yes' border='0' frameborder='0'>&nbsp;</iframe>";
            }
            if(isset($_GET["oid"])){
                ...
                if ($r1->num_rows > 0) { while($rs1= $r1->fetch_assoc()) {
                    ...
                    <div class='card-body'>
                        <div class='receipt-content'>
                            <div class='container bootstrap snippets bootdey' id='element-to-print'>
                                <div class='row'>
                                    <div class='col-md-12'>
