...
echo"<section class='content-main'>
        <div class='content-header'><h2 class='content-title'>Pending Product List</h2></div>
        <div class='card'>
            <div class=''>        
            ...
            <div class='card-body'>
                <div class='table-responsive' style='min-height:500px'>
                    <table id='example' class='table table-striped display' style='width:100%' onmouseover=\"$('#example').DataTable();\">
                        ...
                        <tbody id='taskset'>";                                
                                $s1 = "select * from sms_product_bon where status='1' order by date desc";
                                $r1 = $conn->query($s1);
                                        ...
                                        <td class='text-end'>
                                            <div class='dropdown'>
                                                ...
                                                <div class='dropdown-menu' onmouseup=\"shiftdataV1('task_pending', 'taskset')\">
                                                    <a class='dropdown-item' style='cursor: pointer' href='#top' onclick=\"shiftdataV2('product_edit.php?pid=".$rs1["id"]."&sheba=product_pending', 'datashiftX')\">Edit</a>
                                                    <a class='dropdown-item' href='product_update.php?processor=approveproduct&status=2&pid=".$rs1["id"]."' target='dataprocessor' onblur=\"shiftdataV1('product_pending', 'datashiftX')\">Approve</a>
                                                    <a class='dropdown-item' href='product_update.php?processor=suspendproduct&status=0&pid=".$rs1["id"]."' target='dataprocessor' onblur=\"shiftdataV1('product_pending', 'datashiftX')\">Suspend</a>
                                                    <a class='dropdown-item' href='dataprocessor.php?processor=deletetask&delid=".$rs1["id"]."&tbl=sms_product_bon' target='dataprocessor' onblur=\"shiftdataV1('product_pending', 'datashiftX')\">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>";
