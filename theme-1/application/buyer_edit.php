<?php
    ...
    echo"<section class='content-main'>
        <div class='row'>
            <div class='col-md-10 content-header'><h2 class='content-title'>Edit Buyer</h2></div>
            <div class='col-md-2'><button class='btn btn-primary' onclick=\"shiftdataV1('buyer_list', 'datashiftX')\">Add New</button></div>
        </div>
                    ...
                    if ($r1->num_rows > 0) { while($rs1x = $r1->fetch_assoc()) {
                        ...
                        echo"<form method='post' action='user_update.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >
                            <div class='row'>";
                                ...
                                <input class='form-control' type='hidden' name='actype' placeholder='Type here' value='BUYER'>
                                ...
                                <div class='col-md-2' style='margin-top:25px'>
                                    <div class='d-grid'><button class='btn btn-primary' onblur=\"shiftdataV1('buyer_lists', 'taskset'); shiftdataV1('buyer_list', 'datashiftX')\">Update</button>
