            ...
            <div class='card-body'>
                <div class='table-responsive' style='min-height:500px'>
                    <table id='example' class='table table-striped display' style='width:100%' onmouseover=\"$('#example').DataTable();\">
                        ...
                        <tbody id='taskset'>";
                            $s1 = "select * from sms_product_bon where status='0' order by date desc";
                            $r1 = $conn->query($s1);
                            if ($r1->num_rows > 0) { while($rs1 = $r1->fetch_assoc()) {
                                ...
                                echo"<tr>
                                    <td>".$rs1["pname"]."</td><td nowrap>1. $cat1<br>2. $cat2</td><td>$vendorname</td><td>$brandname</td><td>".$rs1["price"]."</td><td>".$rs1["qty"]."</td>
                                    <td>";
                                        $t1=0;
                                    ...
                                    <td class='text-end'>
                                        <div class='dropdown'>
                                            ...
                                            <div class='dropdown-menu' onmouseup=\"shiftdataV1('task_pending', 'taskset')\">
                                                <a class='dropdown-item' style='cursor: pointer' href='#top' onclick=\"shiftdataV2('product_edit.php?pid=".$rs1["id"]."&sheba=product_suspended', 'datashiftX')\">Edit</a>
                                                <a class='dropdown-item' href='product_update.php?processor=approveproduct&status=2&pid=".$rs1["id"]."' target='dataprocessor' onblur=\"shiftdataV1('product_suspended', 'datashiftX')\">Un-Suspend</a>
                                                <a class='dropdown-item' href='dataprocessor.php?processor=deletetask&delid=".$rs1["id"]."&tbl=sms_product_bon' target='dataprocessor' onblur=\"shiftdataV1('product_suspended', 'datashiftX')\">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>";
