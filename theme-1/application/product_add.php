    ...
    echo"<section class='content-main'>
        ...
        <div class='card'>
            <div class='card-body'>
                <div class='row gx-5'>";
                if($uactype=="ADMIN"){
                    echo"<form method='post' action='product_update.php' autocomplete='off' target='dataprocessor' enctype='multipart/form-data' id='loginForm' name='addproduct'>
                        <div class='row'>
                            <div class='col-md-6'>
                            ...
                            <div class='col-md-3'><label class='form-label'>Main Category</label>                                    
                                <input type='text' class='form-control' name='cid' placeholder='Main Category' list='list-timezone' id='input-datalist' required=''>
                            ...
                            <div class='col-md-3'><label class='form-label'>Second Category</label>
                                <input type='text' class='form-control' name='cid2' placeholder='Second Category' list='list-timezone' id='input-datalist' required=''>
                                <datalist id='list-timezone'>";
                                    $s1z = "select * from sms_link where des1='TOP CATEGORY' order by sorder asc";
                                    $r1z = $conn->query($s1z);
                                    if ($r1z->num_rows > 0) { while($rs1z = $r1z->fetch_assoc()) {
                            ...
                            <div class='col-md-3'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Offer Start Date</label><input class='form-control' type='date' name='offer_sd' placeholder='Type here' value='0'></div>
                            </div>
                            <div class='col-md-3'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Offer End Date</label><input class='form-control' type='date' name='offer_ed' placeholder='Type here' value='0'></div>
                            </div>
                            ...
                            <div class='col-md-6'><label class='form-label'>Image File (Multi Select)</label>
                                <input type='file' name='images[]' multiple class='form__field__img form-control' accept='.jpg, .png, .gif, .jpeg'>
                            </div>
                            
                            <div class='col-md-6'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Shipping Policy</label><input class='form-control' type='text' name='sp' placeholder='Type here' value='Shipping All over Bangladesh.'></div>
                            </div>
                            <div class='col-md-6'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Return Policy</label><input class='form-control' type='text' name='rp' placeholder='Type here' value='Free 7-day return if eligible, so easy.'></div>
                            </div>
                            <div class='col-md-6'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Vendor Policy</label><input class='form-control' type='text' name='vp' placeholder='Type here' value='Pay online or when receiving goods.'></div>
                            </div>
                            <div class='col-md-6'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Payment Policy</label><input class='form-control' type='text' name='pp' placeholder='Type here' value='Supplier give bills for this product.'></div>
                            </div>
                            ...
                            <div class='col-md-2'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Price</label><input class='form-control' type='number' name='ws1' placeholder='Type here' value='0' readonly></div>
                            </div>
                            <div class='col-md-2'>
                            ...
                            <div class='col-md-2'>
                                <select class='form-select' name='attribute_1' required=''>
                                    ...
                                    if ($a11->num_rows > 0) { while($a111 = $a11->fetch_assoc()) {
                                        echo"<option value='".$a111["id"]."'>".$a111["name"]."</option>";
                                    } }
                                echo"</select>
                            </div>
