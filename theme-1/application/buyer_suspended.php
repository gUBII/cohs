<?php
    ...
    echo"<section class='content-main'>
        <div class='row'>
            <div class='col-md-10 content-header'><h2 class='content-title'>Suspended Buyers</h2></div>
            ...
            <div class='card-body'>
                <div class='table-responsive' style='min-height:500px'>
                    <table class='table table-hover'>
                        ...
                        <tbody>
                            <div style='padding:5px' onmouseover=\"shiftdataV1('buyer_suspended', 'datashiftX')\">";
                                $s1 = "select * from sms_user2 where actype='BUYER' and status='OFF' order by name asc";
                                $r1 = $conn->query($s1);
                                        ...
                                        <td class='text-end'>
                                            <div class='dropdown'>
                                                ...
                                                <div class='dropdown-menu'>
                                                    ...
                                                    <a class='dropdown-item' style='cursor: pointer' href='user_update.php?processor=onoff&bid=".$rs1["id"]."&status=ON' target='dataprocessor' onblur=\"shiftdataV1('buyer_suspended', 'datashiftX')\">Un-Suspend</a>
                                                    <a class='dropdown-item' href='dataprocessor.php?processor=deletetask&delid=".$rs1["id"]."&tbl=sms_user2' target='dataprocessor' onblur=\"shiftdataV1('buyer_suspended', 'datashiftX')\">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>";
