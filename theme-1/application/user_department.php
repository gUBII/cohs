<?php
    ...
    echo"<section class='content-main'>
        <div class='content-header'><h2 class='content-title'>DEPARTMENT</h2></div>
        <div class='card'>
            <div class='card-body'>
                <div class='row gx-5'>";
                if($uactype=="ADMIN"){
                    echo"<form method='post' action='user_update.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >
                        <div class='row'>
                            <div class='col-md-4'><div class='mb-3'><label for='product_name' class='form-label'>Department</label>
                            ...
                            <div class='col-md-2' style='margin-top:25px'><div class='d-grid'>
                                <button class='btn btn-primary' onblur=\"shiftdataV1('user_department_list', 'taskset'); shiftdataV1('user_department', 'datashiftX')\">Save</button>
                                <input type=hidden name=processor value='adddepartment'>
                            </div></div>
                        </div>
                    </form>";
                }
