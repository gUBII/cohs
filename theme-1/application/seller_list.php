<?php
    ...
    echo"<section class='content-main'>
        <div class='row'>
            <div class='col-md-9 content-header'><h2 class='content-title'>SELLERS</h2></div>
            <div class='col-md-3' style='text-align:right'><button class='btn btn-primary' onclick=\"shiftdataV2('seller_list.php?blist=1', 'datashiftX')\">Add New</button></div>
        </div>
        <div class='card'>
            <div class='card-body'>";
                if($_GET["blist"]==1){
                    ...
                    if($uactype=="ADMIN"){
                        ...
                        echo"<form method='post' action='user_update.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' name='loginform' class='tooltip-end-bottom' novalidate >
                            <div class='row'>
                                <div class='col-md-12'>
                                    <div class='mb-3'><label for='product_name' class='form-label'>Shop Name</label>
                                        <input class='form-control' type='text' name='sname' placeholder='Type here' value=''>
                                    </div>
                                </div>
                                ...
                                <div class='col-md-3'>
                                    <div class='mb-3'><label for='product_name' class='form-label'>Phone</label>
                                        <input class='form-control' type='number' name='phone' min='11' value='' onchange='this.form.user_id.value=this.value'>
                                    </div>
                                </div>
                                <div class='col-md-3'>
                                ...
                                <div class='col-md-3'>
                                    <div class='mb-3'><label for='product_name' class='form-label'>Login Userid</label>
                                        <input class='form-control' readonly type='text' name='user_id' placeholder='Type here' value=''>
                                    </div>
                                </div>
                                <div class='col-md-3'>
                                ...
                                <input class='form-control' type='hidden' name='department' value='0'>
                                <input class='form-control' type='hidden' name='designation' value='0'>
                                <input class='form-control' type='hidden' name='actype' value='VENDOR'>
                                ...
                                <div class='col-md-2' style='margin-top:25px'>
                                    <div class='d-grid'><button type=submit class='btn btn-primary' onblur=\"shiftdataV1('seller_lists', 'taskset')\">Save</button>
                                    <input type=hidden name=processor value='adduser'></div>
                                </div>
                                <div class='col-md-2' style='margin-top:25px'>
                                    <div class='d-grid'><button type=button class='btn btn-success' onclick=\"shiftdataV1('seller_list', 'datashiftX')\" style='color:white'>Close</button>
                                </div>
                                <div class='col-md-12'><hr></div>
                            </div>
                        </form>";
