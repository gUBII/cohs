<?php
    ...
    echo"<section class='content-main'>
        <div class='content-header'><h2 class='content-title'>Promo, Coupons & Vouchers List</h2></div>
        <div class='card'>
            <div class='card-body'>
                <div class='row gx-5'>";
                if($uactype=="ADMIN"){
                    echo"<form method='post' action='dataprocessor.php' target='dataprocessor' enctype='multipart/form-data' id='loginForm' class='tooltip-end-bottom' novalidate >
                        <div class='row'>
                            ...
                            <div class='col-md-3'>
                                <div class='mb-3'><label for='product_name' class='form-label'>Value</label>
                                    <input class='form-control' type='text' name='amount' placeholder='Type here' value=''>
                                </div>
                            </div>
                            ...
                            <div class='col-md-2' style='margin-top:25px'>
                                <div class='d-grid'><button class='btn btn-primary' onblur=\"shiftdataV1('pages_promo_lists', 'taskset')\">Save</button><input type=hidden name=processor value='addpromo'></div>
                            </div>
                        </div>
                    </form>";
                }
                ...
                <div class='table-responsive' style='min-height:500px'>
                    <table class='table table-hover'>
                        <thead><tr><th>Valid Until</th><th>Title</th><th>Value</th><th>Status</th><th class='text-end'>Action</th></tr></thead>
                        <tbody id='taskset'>";
