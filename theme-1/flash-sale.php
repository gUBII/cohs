<?php
    echo"<section class='product-tabs section-padding position-relative wow fadeIn animated'>
        <div class='bg-square'></div>
        <div class='container'>
            <div class='tab-header'>
                <ul class='nav nav-tabs' id='myTab' role='tablist'>
                    <li class='nav-item' role='presentation'>
                        <button class='nav-link active blink' id='nav-tab-one' data-bs-toggle='tab' data-bs-target='#tab-one' type='button' role='tab' aria-controls='tab-one' aria-selected='true' style='background-color:$bodybc;color:$bodytc;font-size:16pt'>Flash Sales</button>
                    </li>
                </ul>
                <a class='view-more d-md-flex' href='#top' style='cursor: pointer' onclick=\"ChangeUrl('index.php?cPath=4&catid=1105'); shiftdata('1105', 'datashiftX')\" target='_self'>
                    <span style='color:$bodytc'>View Flash Deals<i class='fi-rs-angle-double-small-right'></i></span>
                </a>
            </div>
            ...
            <div class='tab-content wow fadeIn animated' id='myTabContent'>
                <div class='tab-pane fade show active' id='tab-one' role='tabpanel' aria-labelledby='tab-one'>
                    <div class='row product-grid-4'>";
                        $ta=0;
                        $s1 = "select * from sms_product_bon where cid='1104' and status='2' OR cid2='1104' and status='2' order by id desc limit 8";
                        $r1 = $conn->query($s1);
